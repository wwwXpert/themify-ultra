...
for(let f=0,e=a.length;f<e;++f)a[f].insertBefore(c.cloneNode(!0),a[f].firstChild)}};this.swatchClicked=function(a){a.preventDefault();a=a.target;const b=a.classList;b.contains("tb_gradient_swatch")?this.selectSwatch(a.dataset.id):b.contains("tb_delete_swatch")&&(this.removeSwatch(a.parentNode.dataset.id),themifyColorManager.updateColorSwatches("gradients"))};this.removeSwatch=function(a){const b=ThemifyBuilderCommon.Lightbox.$lightbox[0].querySelectorAll('.tb_gradient_swatch[data-id="'+a+'"]');for(let c=
