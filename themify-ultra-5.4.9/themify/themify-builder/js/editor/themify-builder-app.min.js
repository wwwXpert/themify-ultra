...
"",F.classList.contains("tb_holder")?F.appendChild(q):"top"===M?F.before(q):F.after(q)));A=F}}},ca=function(D){D.stopImmediatePropagation();c.ActionBar.clear();c.ActionBar.disable=!0;c.ActionBar.hoverCid=null;c.toolbar.common.hide(!0);this.classList.add("tb_draggable_item");S();p&&(p.style.top=D.clientY+"px")},U=function(D){D.stopImmediatePropagation()},ea=function(D){D.target&&(D.preventDefault(),D.stopImmediatePropagation());E=c.hasChanged=!0;h.classList.remove("tb_draggable_item");var M=!0,F=D.target?
...
function(p){m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"builder_import_submit",nonce:themifyBuilder.tb_load_nonce,data:c.Forms.serialize("tb_options_import"),importType:"no"===p?"replace":"append",importTo:themifyBuilder.post_ID},beforeSend(l){t.showLoader("show")},success(l){l.custom_css&&(R=l.custom_css);void 0!==l.builder_data?c.Forms.reLoad(l,themifyBuilder.post_ID):t.showLoader("error");t.Lightbox.close()}})},{buttons:{no:{label:ThemifyConstructor.label.replace_builder},
yes:{label:ThemifyConstructor.label.append_builder}}})})})}},unload(){"visual"===c.mode&&v.head.insertAdjacentHTML("afterbegin",'<base target="_parent">');w.onbeforeunload=function(){return c.editing||!c.hasChanged&&!c.undoManager.hasUndo()?null:"Are you sure"}},panelClose(a){a.preventDefault();w.location.reload(!0)},loadLayout(a){a.preventDefault();a.stopPropagation();var b=this,d=w.document.body,f=m(a.currentTarget.closest("ul"));a=b.layoutsList?{loadMethod:"html",data:b.layoutsList}:{data:{action:"tb_load_layout"}};
t.Lightbox.$lightbox[0].style.display="none";f.addClass("tb_current_menu_selected");z.body.off("themify_builder_lightbox_close.loadLayout");t.Lightbox.open(a,function(){d.classList.add("tb_load_layout_active","tb_standalone_lightbox")},function(){function e(){g.on("click.loadLayout",".layout_preview img",function(l){l.preventDefault();l.stopPropagation();const q=m(this).closest(".layout_preview");t.LiteLightbox.confirm(themifyBuilder.i18n.confirm_template_selected,function(n){const r=q.closest("ul").data("group"),
u=function(x){if("no"!==n){var y="visual"!==c.mode?v.getElementById("tb_row_wrapper"):v.getElementsByClassName("themify_builder_content-"+themifyBuilder.post_ID)[0];y=c.Mixins.Builder.toJSON(y);const B=[];for(let A in y)B.push(y[A]);for(let A in x)B.push(x[A]);x=B}!0!==b.is_set&&m.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"set_layout_action",nonce:themifyBuilder.tb_load_nonce,mode:"no"!==n?1:0,id:themifyBuilder.post_ID},success(){b.is_set=!0}});c.Forms.reLoad(x,themifyBuilder.post_ID);
t.Lightbox.close()};if("pre-designed"===r){t.showLoader("show");const x=q.data("slug"),y=themifyBuilder.paths.layout_template.replace("{SLUG}",x);if(!c.layouts_selected)c.layouts_selected={};else if(c.layouts_selected[x]){c.Utils.clearElementId(c.layouts_selected[x]);u(JSON.parse(c.layouts_selected[x]));return}m.get(y,null,null,"text").done(function(B){c.layouts_selected[x]=B;let A=JSON.parse(B);-1!==B.indexOf(c.GS.key)?m.getJSON(themifyBuilder.paths.layout_template.replace("{SLUG}",x+"-gs")).done(function(E){const C=
...
(l.hide(),q=l.filter("[data-category"+(""!==themifyBuilder.paths.layouts_index?"*":"")+'="'+m(this).text()+'"]')),q.show(),m(this).addClass("current").siblings().removeClass("current"),p.parent().find(".tb_ui_dropdown_label").html(m(this).text()));c.Utils.hideOnClick(p)});p.find(".tb_selected_cat").click();g.find("#tb_layout_search").on("keyup",function(){let q=this.value.trim();var n=l;""!==q&&(n=p.find("li.all"),n[0].classList.contains("current")||n.click(),l.hide(),n=l.find(".layout_title").filter(function(){return(new RegExp(q,
"i")).test(m(this).text())}).closest(".layout_preview_list"));n.show()})[0].focus();z.body.one("themify_builder_lightbox_close.loadLayout",function(){g.off("click.loadLayout")[0].classList.remove("tb_predesigned_lightbox");k.find("#tb_layout_search").off("keyup");d.classList.remove("tb_load_layout_active","tb_standalone_lightbox");f.removeClass("tb_current_menu_selected")})}const g=this.$lightbox,k=g.find("#tb_tabs_pre-designed");if(0===k.length)d.classList.remove("tb_load_layout_active","tb_standalone_lightbox"),
f.removeClass("tb_current_menu_selected"),e();else{g[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(w.innerWidth/2,(w.document.documentElement.clientHeight-g.height())/2,!0);var p=k.find(".tb_ui_dropdown_items");b.layoutsList?h():m.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_load_predesigned_layouts",nonce:themifyBuilder.tb_load_nonce,src:themifyBuilder.paths.layouts_index,id:themifyBuilder.post_ID},success(l){const q=JSON.parse(l.data);if(""===themifyBuilder.paths.layouts_index){var n=
Object.keys(q);c.layouts_selected={};for(var r=n.length-1;-1<r;--r)c.layouts_selected[q[n[r]].slug]=q[n[r]].data}l=l.selected;n={};r=v.createDocumentFragment();const u=v.createDocumentFragment();for(let A=0,E=q.length;A<E;++A){var x=v.createElement("li"),y=v.createElement("div");let C=v.createElement("div"),G=v.createElement("img"),K=v.createElement("div");var B=v.createElement("div");x.className="layout_preview_list";x.dataset.category=q[A].category;y.className="layout_preview";y.dataset.id=q[A].id;
y.dataset.slug=q[A].slug;C.className="thumbnail";G.src=q[A].thumbnail;G.alt=q[A].title;G.title=q[A].title;K.className="layout_action";B.className="layout_title";B.textContent=q[A].title;K.appendChild(B);void 0!==q[A].url&&(B=v.createElement("a"),B.className="layout-preview-link",B.href=q[A].url,B.target="_blank",B.title=themifyBuilder.i18n.preview,B.appendChild(c.Utils.getIcon("ti-search")),K.appendChild(B));C.appendChild(G);y.appendChild(C);y.appendChild(K);x.appendChild(y);r.appendChild(x);if(q[A].category){x=
...
d=a.currentTarget;d.classList.add("tb_tooltip_active");t.Lightbox.$lightbox[0].style.display="none";w.document.body.classList.add("tb_standalone_lightbox");t.Lightbox.open(b,null,function(){const f=this.$lightbox,e=f[0].querySelector("#custom_css");e.value=R;"visual"===c.mode&&e.addEventListener("input",function(){let h=v.getElementById("tb_custom_css_tmp");null===h&&(h=v.createElement("style"),h.type="text/css",h.id="tb_custom_css_tmp",v.head.appendChild(h));h.innerHTML=this.value.trim()});f.addClass("tb_custom_css_lightbox").find(".builder_save_button").one("click",
function(h){h.stopImmediatePropagation();h.preventDefault();R=e.value.trim();t.Lightbox.close()});this.setStandAlone(a.clientX,a.clientY);z.body.one("themify_builder_lightbox_close",function(){R||(R="",d.classList.add("tb_tooltip_active"));const h=v.getElementById("tb_custom_css_tmp");h&&(h.innerHTML=R);w.document.body.classList.remove("tb_standalone_lightbox")})})},Revisions:{init(){c.toolbar.$el.find(".tb_toolbar_revision_btn").on("click",this.revision.bind(this))},revision(a){const b=a.target.classList;
...
"rtl"===p?" first":" last"));b.push("col-count-"+r);q["data-basecol"]=r;null!==l&&void 0!==l.row_anchor&&""!==l.row_anchor&&(a.getElementsByClassName("tb_row_anchor")[0].textContent=l.row_anchor);null!==l&&void 0!==l.custom_css_id&&""!==l.custom_css_id&&(a.getElementsByClassName("tb_row_id")[0].textContent=l.custom_css_id);"gutter-default"!==h&&b.push(h);k&&b.push("col_auto_height");b.push(g);"ltr"!==p&&b.push("direction-rtl");for(a=d.length-1;-1<a;--a)h=f.get(d[a]+"_dir"),"ltr"!==h&&""!==h&&(q["data-"+
d[a]+"_dir"]=h),"desktop"!==d[a]&&(h=f.get("col_"+d[a]),"-auto"!==h&&""!==h&&void 0!==h&&(q["data-col_"+d[a]]=h));for(d=b.length-1;-1<d;--d)b[d]&&e.classList.add(b[d]);for(let u in q)e.setAttribute(u,q[u])},clear(a,b){void 0===b&&(b=Array.isArray(a));const d=!0===b?[]:{},f=void 0!==I.tbpDynamic?tbpDynamic.field_name:!1;for(let g in a)if(a.hasOwnProperty(g)&&"null"!==g)if(Array.isArray(a[g])){var e=this.clear(a[g],!0);0<e.length&&(!0===b?d.push(e):d[g]=e)}else if(g===f)if("{}"===a[g]||""===a[g])delete a[g],
delete d[g];else{e=a[g];"string"===typeof e&&(e=JSON.parse(e));for(let k in e)"undefined"===typeof e[k].repeatable&&(void 0===e[k].item?delete e[k]:void 0!==a[k]&&(delete a[k],delete d[k]));a[g]=d[g]=e}else if("object"===typeof a[g]){if("breakpoint_mobile"===g||"breakpoint_tablet"===g||"breakpoint_tablet_landscape"===g){e=a[g];for(let k in e)if(void 0===e[k]||null===e[k]||""===e[k])delete e[k];else if("px"===e[k]&&-1!==k.indexOf("_unit",2)){var h=k.replace("_unit","");if(void 0===e[h]||""===e[h])delete e[k],
""===e[h]&&delete e[h]}}else e=this.clear(a[g],!1);e&&0<Object.keys(e).length&&(d[g]=e)}else if(null!==a[g]&&void 0!==a[g]&&""!==a[g]&&"def"!==a[g]&&""!==g&&"pixels"!==a[g]&&"default"!==a[g]&&"|"!==a[g]&&!("hide_anchor"===g&&!a[g]||"show"===a[g]&&0===g.indexOf("visibility_")||"unstick_when_condition"===g&&"hits"===a[g]||"unstick_when_pos"===g&&"this"===a[g]||"unstick_when_element"===g&&"builder_end"===a[g]||("stick_at_pos_val_unit"===g||"unstick_when_pos_val_unit"===g)&&"px"===a[g]))if("custom_parallax_scroll_speed"!==
g||a[g])if("unstick_when_check"!==a[g]&&("unstick_when_check"===g||"unstick_when_check_tl"===g||"unstick_when_check_t"===g||"unstick_when_check_m"===g)||"builder_end"===a[g]&&("unstick_when_element"===g||"unstick_when_element_tl"===g||"unstick_when_element_t"===g||"unstick_when_element_m"===g)||"stick_at_check"===g&&"stick_at_check"!==a[g]||!("-1"!=a[g]&&a[g]||"stick_at_check_tl"!==g&&"stick_at_check_t"!==g&&"stick_at_check_m"!==g)){e="";if("unstick_when_element_tl"===g||"stick_at_check_tl"===g||
"unstick_when_check_tl"===g)e="_ti";else if("unstick_when_element_t"===g||"stick_at_check_t"===g||"unstick_when_check_t"===g)e="_t";else if("unstick_when_element_m"===g||"stick_at_check_m"===g||"unstick_when_check_m"===g)e="_m";delete d["unstick_when_el_row_id"+e];delete d["unstick_when_el_mod_id"+e];delete d["unstick_when_condition"+e];delete a["unstick_when_el_row_id"+e];delete a["unstick_when_el_mod_id"+e];delete a["unstick_when_condition"+e];delete d["unstick_when_pos"+e];delete d["unstick_when_pos_val"+
e];delete d["unstick_when_element"+e];delete d["unstick_when_pos_val_unit"+e];delete a["unstick_when_pos"+e];delete a["unstick_when_pos_val"+e];delete a["unstick_when_pos_val_unit"+e];delete a["unstick_when_element"+e];if("stick_at_check"===g||"stick_at_check_tl"===g||"stick_at_check_t"===g||"stick_at_check_m"===g){if("stick_at_check"===g||"-1"==a[g])delete a[g],delete d[g];delete a["stick_at_position"+e];delete d["stick_at_position"+e]}}else if(void 0===g||null===g||""===g||!1===g||"stick_at_position"===
g&&"top"===a[g]||g===c.GS.key&&""===a[g].trim()||"background_gradient-css"===g||"cover_gradient-css"===g||"cover_gradient_hover-css"===g||"background_image-type_image"===g||"custom_parallax_scroll_reverse_reverse"===g||"|single"===a[g]||"|multiple"===a[g]||("custom_parallax_scroll_reverse"===g||"custom_parallax_scroll_fade"===g||"visibility_all"===g||"sticky_visibility"===g||"resp_no_bg"===g||"background_zoom"===g||"b_sh_inset"===g||"background_image-circle-radial"===g)&&!a[g])delete a[g],delete d[g];
else{if("builder_content"===g)"string"===typeof a[g]&&(a[g]=JSON.parse(a[g])),a[g]=this.clear(a[g],!0);else{e=[];if(0===g.indexOf("checkbox_")&&-1!==g.indexOf("_apply_all",6)){a[g]?d[g]=a[g]:e.push(g);h=g.replace("_apply_all","").replace("checkbox_","");let k=["top","left","right","bottom"];for(let p=3;-1<p;--p){let l=h+"_"+k[p]+"_unit";"px"===a[l]?e.push(l):void 0!==a[l]&&null!==a[l]&&""!==a[l]&&(d[l]=a[l])}}else-1!==g.indexOf("gradient",3)?("180"==a[g]||"linear"===a[g]||a[g]===m.ThemifyGradient.default||
!1===a[g]&&-1!==g.indexOf("-circle-radial",3))&&e.push(g):("px"===a[g]&&-1!==g.indexOf("_unit",2)||"background_zoom"===g&&""===a[g]||"none"===a[g]&&-1!==g.indexOf("frame_layout")||"solid"===a[g]||!1===a[g]&&(-1!==g.indexOf("_user_role",3)||-1!==g.indexOf("_appearance",3))||!(a[g]&&"false"!==a[g]||"margin-top_opp_top"!==g&&"m_t_h_opp_top"!==g&&0!==g.indexOf("padding_opp_")&&0!==g.indexOf("margin_opp_")))&&e.push(g);if(0<e.length){for(h=e.length-1;-1<h;--h)delete d[e[h]],delete a[e[h]];e.length=0;continue}}!0===
...
q){l=m(".prompt-box .show-error");m(".prompt-box .show-login").hide();l.show();0<l.length&&l.html('<p class="prompt-error">'+q.message+"</p>");m(".overlay, .prompt-box").fadeIn(500)});e.bind("FileUploaded",function(l,q,n){const r=JSON.parse(n.response);l=m("#tb_alert",w.document);n=200!==n.status||r.error?"error":"done";if(r.error)t.showLoader(n),alert(r.error);else if(d){const u=m("#tb_row_wrapper").children().clone(!0);l.promise().done(function(){r.custom_css&&(R=r.custom_css);c.Forms.reLoad(r,
themifyBuilder.post_ID);const x=m("#tb_row_wrapper").children().clone(!0);t.Lightbox.close();c.undoManager.push("","","","import",{before:u,after:x,bid:themifyBuilder.post_ID})})}else t.showLoader(n),l=this.getOption().container.closest(".tb_input"),n=l.getElementsByClassName("tb_uploader_input")[0],l=l.getElementsByClassName("thumb_preview")[0],n.value=r.large_url?r.large_url:r.url,void 0!==l&&ThemifyConstructor.file.setImage(l,r.thumb),z.triggerEvent(n,"change")});e.init();h.classList.remove("plupload-clone")}},
...
cache:!1,data:{action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:e,custom_css:R,data:JSON.stringify(c.Utils.clear(h)),sourceEditor:"visual"===c.mode?"frontend":"backend"},complete:function(g,k){"success"!==k?(t.showLoader("error"),alert(themifyBuilder.i18n.errorSaveBuilder)):(g=g.responseJSON,m.isFunction(a)&&a.call(f,g),t.showLoader("hide"),c.editing=!0,z.body.triggerHandler("themify_builder_save_data",[g]))}})}).fail(function(){t.showLoader("error")})},saveCss(a,b,d){return m.ajax({type:"POST",
url:themifyBuilder.ajaxurl,cache:!1,data:{css:JSON.stringify(c.GS.createCss(a,a[0]&&a[0].mod_name||null,!0)),action:"tb_save_css",custom_css:b,tb_load_nonce:themifyBuilder.tb_load_nonce,id:d}})},runJs(a,b,d){if(!b)if(null!==c.activeModel)b=c.activeModel.get("elType");else if(a){var f=c.Models.Registry.lookup(a.data("cid"));f&&(b=f.get("elType"))}f=[];if("visual"===c.mode&&("module"===b&&z.fontAwesome(a),!0!==d)){d=(a?a[0]:v).querySelectorAll("img[data-w]");for(let e=d.length-1;-1<e;--e){let h=d[e].getAttribute("width"),
g=d[e].getAttribute("height");(h||g)&&f.push(c.Utils.resizeImage(d[e],h,g))}}Promise.allSettled(f).finally(e=>{z.reRun(a,b)})},createClearBtn(a){a.siblings(".tb_clear_btn tf_close").click(function(){m(this).hide();a.val("").trigger("keyup")})},toRGBA(a){return ThemifyStyles.toRGBA(a)},getColor(a){let b=a.value;""!==b&&(null!==a.getAttribute("data-tfminicolors-initialized")?b=m(a).tfminicolors("rgbaString"):(a=a.getAttribute("data-opacity"),""!==a&&null!==a&&"1"!=a&&"0.99"!=a&&(b=this.toRGBA(b+"_"+
a))));return b},getIcon(a,b){if("undefined"!==typeof themifyBuilder.fontello_prefix&&(new RegExp(themifyBuilder.fontello_use_suffix?themifyBuilder.fontello_prefix+"$":"^"+themifyBuilder.fontello_prefix)).test(a))return b=v.createElement("i"),b.setAttribute("class",a),b;a="tf-"+a.trim().replace(" ","-");const d=v.createElementNS("http://www.w3.org/2000/svg","use"),f=v.createElementNS("http://www.w3.org/2000/svg","svg");let e="tf_fa "+a;b&&(e+=" "+b);f.setAttribute("class",e);d.setAttributeNS(null,
"href","#"+a);f.appendChild(d);return f},getBPWidth(a){a=Array.isArray(themifyBuilder.breakpoints[a])?themifyBuilder.breakpoints[a]:themifyBuilder.breakpoints[a].toString().split("-");return a[a.length-1]},generateUniqueID(){return(Math.random().toString(36).substr(2,4)+(new Date).getUTCMilliseconds().toString()).substr(0,7)},scrollTo(a){("desktop"===c.activeBreakPoint?m("html,body"):m("body",w.document)).scrollTop(a)},scrollToDropped(a,b){a||(a=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+
b)[0]);if(a)if("visual"===c.mode)this.scrollTo(m(a).offset().top-120);else if(b=v.getElementsByClassName("edit-post-layout__content")[0],void 0!==b){if(a.classList.contains("module_row"))a=a.offsetTop;else{let d=a.closest(".module_row");null!==d?(d=m(d),a=d.offset().top+200-d.offsetParent().offset().top):a=a.offsetTop}m(b).scrollTop(a)}},addViewPortClass(a){a.style.transition="none";this.removeViewPortClass(a);let b=this.isInViewport(a);if(!1!==b){b=b.split(" ");for(let d=b.length-1;-1<d;--d)""!==
b[d]&&a.classList.add(b[d])}a.style.transition=""},removeViewPortClass(a){const b=["top","left","bottom","right"];for(let d=4;-1<d;--d)a.classList.remove("tb_touch_"+b[d])},isInViewport(a){a=a.getBoundingClientRect();let b="";0>a.left?b="tb_touch_left":a.right-1>=v.documentElement.clientWidth&&(b="tb_touch_right");if(0>a.top)b+=" tb_touch_top";else if(a.bottom+1>=v.documentElement.clientHeight||I.innerHeight+I.scrollY>=v.body.offsetHeight&&a.bottom+20>=v.documentElement.clientHeight)b+=" tb_touch_bottom";
return""===b?!1:b},canvas:null,ctx:null,cache_images:{},resizeImage(a,b,d,f){"0"===b&&(b="");if(!b&&!d)return new Promise((h,g)=>{"string"!==typeof a&&(a.style.visibility=a.style.display="");h([a,b,d,b,d])});null===this.canvas&&(this.canvas=v.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.ctx.imageSmoothingQuality="high",this.ctx.imageSmoothingEnabled=!0);const e=this;return new Promise((h,g)=>{let k=v.createElement("span");const p=function(q){let n=q.getAttribute("data-orig");
const r=function(){b?(q.setAttribute("width",b),q.style.width&&(q.style.width=b+"px")):q.removeAttribute("width");d?(q.setAttribute("height",d),q.style.height&&(q.style.height=d+"px")):q.removeAttribute("height")},u=function(){b&&(b=parseInt(b));d&&(d=parseInt(d));var y=f.naturalWidth,B=f.naturalHeight,A=y/B,E=b,C=d;E||(E=b=parseInt(C*A));C||(C=d=parseInt(E/A));var G=E/y,K=C/B;A=q.currentSrc;G=G>K?G:K;E=E/G+.5>>0;C=C/G+.5>>0;y=(y-E)/2>>0;B=(B-C)/2>>0;G=q.getAttribute("srcset");K=q.getAttribute("data-ext");
K||q.hasAttribute("data-ext")||(K=A.slice((A.lastIndexOf(".")-1>>>0)+2),"jpg"===K&&(K="jpeg"),K="image/"+K,q.setAttribute("data-ext",K));e.canvas.width=E;e.canvas.height=C;e.ctx.drawImage(f,y,B,E,C,0,0,E,C);G&&-1!==G.indexOf(A)?q.setAttribute("srcset",G.replaceAll(A,e.canvas.toDataURL(K,1))):q.setAttribute("src",e.canvas.toDataURL(K,1));r();k&&k.remove();q.style.visibility=q.style.display="";k=n=null;h([q,b,d,E,C])};if(!n){n=q.getAttribute("src").trim();if(0!==n.indexOf(themifyBuilder.upload_url)||
q.closest("[data-hasEditor]")){k&&k.remove();q.style.visibility=q.style.display="";r();k=n=null;h([q,b,d,b,d]);return}var x=q.getAttribute("width");const y=q.getAttribute("height");x&&y&&(x="-"+x+"x"+y,-1!==n.indexOf(x)&&(n=n.replace(x,"")));q.dataset.orig=n}if(f)u();else{const y=z.hash(n+b+d);void 0!==e.cache_images[y]?(f=e.cache_images[y],u(),f=null):(f=new Image,f.src=n,f.crossOrigin="anonymous",f.decode().then(function(){u();e.cache_images[y]=f}).catch(B=>{k&&k.remove();q.style.visibility=q.style.display=
"";g()}))}};if("string"===typeof a){let q=0;const n=setInterval(function(){++q;8<q&&clearInterval(n);const r=c.Instances.Builder[c.builderIndex].el.querySelector(a);if(null!==r){clearInterval(n);k.className="tf_loader tf_loader_center";var u=r.closest(".active_module");if(u){const x=u.getElementsByClassName("tf_loader_center")[0];void 0!==x&&x.parentNode===u||u.prepend(k)}else u=r.nextElementSibling,null!==u&&u.classList.contains("tf_loader_center")||r.after(k);p(r)}},8)}else{if(!f){k.className="tf_loader tf_loader_center";
var l=a.closest(".active_module");if(l){const q=l.getElementsByClassName("tf_loader_center")[0];void 0!==q&&q.parentNode===l||l.prepend(k)}else l=image.nextElementSibling,null!==l&&l.classList.contains("tf_loader_center")||a.after(k)}p(a)}})},hideOnClick(a){void 0!==a[0]&&(a=a[0]);if(a.classList.contains("tb_ui_dropdown_items")||a.classList.contains("tb_down"))a.classList.add("tb_hide_option"),a.previousElementSibling.blur(),setTimeout(function(){a.classList.remove("tb_hide_option");a=null},500)},
calculateHeight(){"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(w.document.body.style.height=v.body.scrollHeight+"px")},changeOptions(a,b){const d="INPUT"===a.tagName&&"hide_anchor"!==b?"keyup":"change",f=this;"keyup"===d&&a.setAttribute("data-prev",a.value);f.custom_css_id=function(e,h,g,k){e=v.getElementById(k);return null===e||g[0].getAttribute("id")===k||null===e.closest(".module_row")?(g[0].setAttribute("id",k),g.find(".tb_row_id").first().text(k),!0):!1};f.row_anchor=function(e,h,g,k){"visual"===
c.mode&&(g.removeClass(c.liveStylingInstance.getRowAnchorClass(e.getAttribute("data-prev"))),""!==k&&g.addClass(c.liveStylingInstance.getRowAnchorClass(k)),g.data("anchor",k).attr("data-anchor",k));c.hasChanged=!0;g.find(".tb_row_anchor").first().text(k.replace("#",""));return!0};f.custom_css=function(e,h,g,k){"visual"===c.mode&&g.removeClass(e.getAttribute("data-prev")).addClass(k);return!0};f.layout=function(e,h,g,k){"visual"===c.mode&&c.liveStylingInstance.bindRowWidthHeight(h,k,g);return!0};f.hide_anchor=
function(e,h,g,k){"visual"===c.mode&&"1"===k&&g.data("hideAnchor",k).attr("data-hide-anchor",k);return c.hasChanged=!0};a.addEventListener(d,function(e){let h;var g=null!==c.activeModel&&c.ActionBar.cid===c.activeModel.cid;let k=!t.Lightbox.$lightbox[0].contains(this),p="hide_anchor"!==b?this.id:"hide_anchor",l="custom_css_id"===p,q=!0!==l||!1!==k&&!0!==g?void 0:t.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0],n;n=!0===k&&!1===g?m(".tb_element_cid_"+c.ActionBar.cid):"visual"===
c.mode?c.liveStylingInstance.$liveStyledElmt:m(".tb_element_cid_"+c.activeModel.cid);const r=!1===g&&!0===k?t.clone(n[0]):null;h=this.value;"keyup"===d&&"custom_css"!==b?((h=h.trim())&&(h=h.replace(/[^a-zA-Z0-9\-_]+/gi,"")),this.value=h):"layout"===b?h=e.detail.val:"hide_anchor"===b&&(h=this.checked?"1":"0");if(f[b].call(f,this,p,n,h)){l&&(m(this).next(".tb_field_error_msg").remove(),void 0!==q&&q.classList.remove("tb_disable_save"));if(!0===k){const u=function(){let x=h;"keyup"===d&&(this.removeEventListener("change",
u,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),x=this.value.trim());let y=n.data("cid"),B=c.Models.Registry.lookup(y),A=m.extend(!0,{},B.get("styling"));A||(A={});const E=m.extend(!0,{},A);A[p]=x;B.set({styling:A},{silent:!0});null!==r&&c.undoManager.push(y,r,n,"save",{bsettings:E,asettings:m.extend(!0,{},A)})};"keyup"===d?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",u,{passive:!0,once:!0})):u()}c.hasChanged=!0}else l&&(0===this.parentNode.getElementsByClassName("tb_field_error_msg").length&&
(e=v.createElement("span"),e.className="tb_field_error_msg",e.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(e,this.nextSibling)),void 0!==q&&q.classList.add("tb_disable_save"));!0===g&&(g=k?t.Lightbox.$lightbox.find("#"+p):m("#"+c.ActionBar.el.id).find("#"+p),"keyup"===d?g.val(h).attr("data-prev",h):"layout"===b?(g.find(".selected").removeClass("selected"),""!==h?g.find("#"+h).addClass("selected"):g.children().first().addClass("selected")):"hide_anchor"===b&&(g.find("INPUT")[0].checked=
this.checked));"keyup"===d&&this.setAttribute("data-prev",h)},{passive:!0})},visibilityLabel(a,b){var d=b.cid;d=null!==c.activeModel&&d===c.activeModel.cid&&"visibility"===ThemifyConstructor.clicked?c.Forms.serialize("tb_options_visibility"):void 0;void 0===d&&(d="module"!==b.get("elType")?b.get("styling"):b.get("mod_settings"));if(d){b="";a=a.classList.contains("tb_visibility_hint")?a:a.getElementsByClassName("tb_visibility_hint")[0];const e={visibility_desktop:themifyBuilder.i18n.de,visibility_mobile:themifyBuilder.i18n.mo,
visibility_tablet:themifyBuilder.i18n.ta,visibility_tablet_landscape:themifyBuilder.i18n.ta_l,sticky_visibility:themifyBuilder.i18n.s_v};if(void 0!==a){if("hide_all"===d.visibility_all)b=themifyBuilder.i18n.h_a;else{let h;for(var f in e)h=""===b?"":", ",b+="hide"===d[f]?h+e[f]:""}""!==b?(f=a.getElementsByTagName("span")[0],void 0===f&&(f=v.createElement("span"),a.appendChild(f)),f.textContent=b,a.classList.add("tb_has_visiblity")):a.classList.remove("tb_has_visiblity")}}}};c.ActionBar={cid:null,topH:null,
type:null,disable:null,prevExpand:null,needClear:!0,el:null,breadCrumbs:null,breadCrumbsPath:{lightbox:null,rightClick:null},disablePosition:null,isInit:null,isHoverMode:!0,darkMode:null,inlineEditor:!0,hoverCid:null,contextMenu:null,contextMenuAnimate:null,init(){if(null===this.isInit&&!0!==c.GS.isGSPage){this.isInit=!0;this.el=v.createElement("div");this.breadCrumbs=v.createElement("ul");this.el.id="tb_component_bar";this.breadCrumbs.className="tb_action_breadcrumb";this.el.addEventListener("mousedown",
this.mouseDown.bind(this));this.topH=c.toolbar.$el.height();"visual"===c.mode?v.body.appendChild(this.el):c.Instances.Builder[c.builderIndex].el.parentNode.appendChild(this.el);v.addEventListener("click",this.click.bind(this));v.addEventListener("dblclick",this.click.bind(this));c.Instances.Builder[0].el.addEventListener("mouseover",this.enter);"visual"===c.mode&&w.document.addEventListener("click",this.click.bind(this));var a="visual"===c.mode?null:v.getElementById("tb_canvas_block");null===a?(v.addEventListener("keydown",
this.actions.bind(this),{passive:!0}),w.document.addEventListener("keydown",this.actions.bind(this),{passive:!0})):a.addEventListener("keydown",this.actions.bind(this),{passive:!0});this.changeMode();this.initRightClick(!0)}},changeMode(){this.hoverCid=null;const a=v.body.classList;!0===this.isHoverMode?(a.remove("tb_click_mode"),a.add("tb_hover_mode"),this.el.removeEventListener("click",this.actions)):(a.remove("tb_hover_mode"),a.add("tb_click_mode"),this.el.addEventListener("click",this.actions))},
changeDarkMode(){var a=v.getElementById("darkmode-ui"),b="visual"===c.mode?w.document.getElementById("darkmode-ui"):null;!0===this.darkMode?a?(a.disabled=!1,b&&(b.disabled=!1)):(a=w.document.createElement("link"),b=v.getElementById("visual"!==c.mode?"themify-builder-admin-ui-css":"themify-builder-inline-editor-css"),a.rel="stylesheet",a.href=themifyBuilder.builder_url+"/css/editor/darkmode-ui.css",a.id="darkmode-ui",b.parentNode.insertBefore(a,b.nextSibling),"visual"===c.mode&&w.document.head.appendChild(a.cloneNode())):
(a.disabled=!0,b&&(b.disabled=!0))},initRightClick(a){localStorage.getItem("tb_right_click")?!0===a?c.toolbar.el.getElementsByClassName("tb_right_click_mode")[0].checked=!1:(c.Instances.Builder[0].el.removeEventListener("contextmenu",this.rightClick),this.contextMenu=this.contextMenuAnimate=null):(c.Instances.Builder[0].el.addEventListener("contextmenu",this.rightClick),c.ActionBar.el.removeEventListener("contextmenu",this.rightClick),!0!==this.isHoverMode&&c.ActionBar.el.addEventListener("contextmenu",
this.rightClick))},enter(a){const b=c.ActionBar;if(null===b.disable&&(c.Mixins.Builder.columnHover(a.target),!0===b.isHoverMode&&null===b.disablePosition)){"click"===a.type&&a.preventDefault();a.stopPropagation();var d=a.target;let g=null;var f=d.classList;if(null!==b.prevExpand&&void 0!==b.prevExpand)if(b.prevExpand.contains(d)){if(f.contains("tb_inner_action_more")||f.contains("tb_action_more")){var e=d.getElementsByTagName("ul")[0];void 0!==e&&c.Utils.addViewPortClass(e)}e=b.prevExpand.getElementsByClassName("tb_row_settings")[0];
if(void 0!==e){var h=v.getElementById(e.getAttribute("data-href"));if(h.contains(d))return;h.classList.remove("selected");e.classList.remove("selected")}if("module"===b.type||"column"===b.type){"column"===b.type&&(b.hoverCid=d.parentNode.getAttribute("data-cid"));return}}else{e="module"!==b.type;if(!1===e)"visual"!==c.mode?(e=d.closest(".active_module"),e=null!==e?e.getAttribute("data-cid")!==b.hoverCid:!0):(h=d.closest(".tb_dragger_top"),null!==h&&h.classList.contains("tb_dragger_padding")&&c.EdgeDrag.setModulePosition(h));
else if(f.contains("tb_clicked"))return;!0===e&&b.clear()}if(null===d.closest(".tb_dragger_lightbox")){if(f.contains("tb_action_wrap"))g=!f.contains("tb_clicked");else{if("LI"===d.nodeName&&f.contains("tb_row_settings")&&!f.contains("selected")){b.actions(a);return}if(!f.contains("tb_grid_drag")){d=d.closest("[data-cid]");if(!d)return;f=d.getAttribute("data-cid");if(b.hoverCid===f)return;b.hoverCid=f;e=c.Models.Registry.lookup(f);f=e.get("elType");if("module"===f)g=!0;else if("visual"===c.mode){b.clear();
c.EdgeDrag.addEdges(f,e,d);return}}}!0===g&&b.click(a)}}},rightClickGS(a,b,d){this.disable=!0;null!==c.activeModel&&m(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click();const f=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),e=c.GS.key;b=b.split(" ");for(let g=f.length-1,k=b.length;-1<g;--g){let p=c.Models.Registry.lookup(f[g].getAttribute("data-cid")),l=t.clone(f[g]),q="module"===p.get("elType")?"mod_settings":"styling",n=m.extend(!0,{},p.get(q)),
...
if(!(null!==d.contextMenuAnimate||"visual"===c.mode&&v.activeElement.contentEditable&&c.liveStylingInstance.$liveStyledElmt&&c.liveStylingInstance.$liveStyledElmt[0].contains(v.activeElement))){d.contextMenuAnimate=!0;if(null===d.contextMenu){const l=function(n){n.stopPropagation();"click"===n.type&&null===n.target.closest(".tb_visibility_wrap")&&n.preventDefault();if("LI"===n.target.nodeName||n.target.classList.contains("toggle_switch")){var r="LI"===n.target.nodeName?n.target.getAttribute("data-action"):
"visibility";if(r){d.disable=!0;d.hoverCid=null;if("undo"===r||"redo"===r)if(n="undo"===r?c.undoManager.btnUndo:c.undoManager.btnRedo,"undo"===r&&c.undoManager.hasUndo()||"redo"===r&&c.undoManager.hasRedo())m(n).triggerHandler("click"),d.disable=null;else{d.disable=null;return}else{var u=this.classList.contains("tb_multiply_selected");let E,C,G,K,O,J,L,N=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked"),S=void 0;"gs_in"!==r&&"move"!==r&&(!0!==u||"delete"!==r&&"paste"!==
r||(S=!0),m(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click());if("reset"===r)E=c.activeModel,C=m.extend(!0,{},ThemifyConstructor.values),G=ThemifyConstructor.component,K=ThemifyConstructor.beforeData,O=!0===c.hasChanged,J="visual"===c.mode?c.liveStylingInstance.prefix:null,L="visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:null;else{if("move"===r){d.disable=null;return}if("gs_in"===r){if(!1===u){r=c.Models.Registry.lookup(N[0].dataset.cid);var x=m.extend(!0,{},ThemifyConstructor.values);
ThemifyConstructor.values="module"===r.get("elType")?r.get("mod_settings"):r.get("styling")}if(r=c.GS.globalStylesHTML())n=d.contextMenu.querySelector("#tb_inline_gs"),n.innerHTML="",n.appendChild(r),n.getElementsByClassName("tb_gs_icon")[0].click(),n.querySelector('[data-action="insert"]').click(),n.classList.add("tb_inline_gs_show"),c.Utils.addViewPortClass(d.contextMenu);!1===u&&(ThemifyConstructor.values=x);d.disable=null;return}}for(u=N.length-1;-1<u;--u){x=N[u].getAttribute("data-cid");let P=
c.Models.Registry.lookup(x);var y=P.get("elType"),B="module"===y?P.get("mod_settings"):P.get("styling");if("reset"===r||"gs_r"===r){if("gs_r"===r&&void 0===B[c.GS.key])continue;if(null!==c.activeModel&&c.activeModel.cid===x){var A=ThemifyBuilderCommon.Lightbox.$lightbox.find(".reset-styling")[0];if(void 0!==A){A.click();continue}}A=t.clone(N[u]);let Z;c.activeModel=P;"reset"===r&&(ThemifyConstructor.component=y,ThemifyConstructor.values=B);let ca="module"===y?"mod_setting":"styling";"visual"===c.mode&&
(c.liveStylingInstance.$liveStyledElmt?c.liveStylingInstance.prefix=ThemifyStyles.getBaseSelector("module"===y?c.activeModel.get("mod_name"):y,c.activeModel.get("element_id")):c.liveStylingInstance.init(!0),c.liveStylingInstance.$liveStyledElmt=m(N[u]));y=m.extend(!0,{},B);"reset"===r?(B=ThemifyConstructor.resetStyling(n,null!==E&&E.cid!==x),"visual"===c.mode&&(Z=m.extend(!0,{},B)),B=m.extend(!0,{},ThemifyConstructor.values)):(delete B[c.GS.key],c.GS.generateValues(null,[],!0));let U={};U[ca]=B;P.set(U,
{silent:!0});c.hasChanged=!0;c.undoManager.push(x,A,m(N[u]),"save",{bsettings:y,asettings:B,styles:Z});Z=null}else("delete"!==r&&"visibility"!==r||"column"!==y)&&P.trigger(r,n,n.target,S)}"reset"===r?(c.hasChanged=O,c.activeModel=E,ThemifyConstructor.values=C,ThemifyConstructor.component=G,ThemifyConstructor.beforeData=K,"visual"===c.mode&&(c.liveStylingInstance.$liveStyledElmt=L,c.liveStylingInstance.prefix=J)):"edit"!==r&&(c.activeModel=null);d.disable=null}"visibility"!==r&&d.hideContextMenu()}}},
q=function(n){n.stopPropagation();n.target.classList.contains("tb_inner_action_more")&&(n=n.target.getElementsByTagName("ul")[0])&&c.Utils.addViewPortClass(n)};d.contextMenu=v.getElementById("tb_right_click");null===d.contextMenu&&(d.contextMenu=v.getElementById("tmpl-builder_right_click").content,v.body.appendChild(d.contextMenu),d.contextMenu=v.getElementById("tb_right_click"),d.contextMenu.addEventListener("click",l),d.contextMenu.addEventListener("mouseover",q,{passive:!0}),d.contextMenu.getElementsByClassName("tb_r_name")[0].addEventListener("mousedown",
function(n){1===n.which&&!d.contextMenu.classList.contains("tb_multiply_selected")&&!d.contextMenu.classList.contains("tb_component_column")&&(n.preventDefault(),n.stopPropagation(),n=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_clicked")[0])&&(d.hideContextMenu(),d.cid=n.dataset.cid,d.moveComponent())}))}var f=!0;!0!==d.isHoverMode&&null!==d.cid?b=c.Instances.Builder[c.builderIndex].el.querySelector('[data-cid="'+d.cid+'"]'):b?f=!1:b=m(a.target).closest("[data-cid]")[0];
if(void 0===b)d.contextMenuAnimate=null;else{a.preventDefault();d.hideContextMenu(a.target.classList.contains("tb_bread"));d.disablePosition=!0;v.body.classList.add("tb_right_click_open");d.contextMenu.className="tb_show_context";var e=a.pageX,h=a.pageY,g=c.Models.Registry.lookup(b.dataset.cid),k=g.get("elType"),p=function(l){if("transform"===l.propertyName){var q=c.Instances.Builder[c.builderIndex].el,n=this.getElementsByClassName("tb_r_name")[0],r=this.getElementsByClassName("tb_action_breadcrumb")[0],
u=function(y){y.preventDefault();y.stopPropagation();var B=y.target.getAttribute("data-id");B&&(this.removeEventListener("click",u),d.hideContextMenu(!0),B=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+B)[0],void 0!==B&&d.rightClick(y,B))};this.removeEventListener("transitionend",p,{passive:!0});this.className="tb_component_"+k;"module"===k&&(this.className+=" tb_module_"+g.get("mod_name"));r.innerHTML="";if(!0===a.ctrlKey||!0===a.metaKey)b.classList.add("tb_element_clicked");
else if(!b.classList.contains("tb_element_clicked")){l=q.getElementsByClassName("tb_element_clicked");for(let y=l.length-1;-1<y;--y)l[y].classList.remove("tb_element_clicked");b.classList.add("tb_element_clicked")}l=q.getElementsByClassName("tb_element_clicked").length;1<l?(this.className+=" tb_multiply_selected",n.textContent=themifyBuilder.i18n.multiSelected):(d.breadCrumbsPath.rightClick=d.getBreadCrumbPath(c.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+(null===d.breadCrumbsPath.rightClick?
g.cid:d.breadCrumbsPath.rightClick[d.breadCrumbsPath.rightClick.length-1]))[0],"rightClick"),r.appendChild(d.getBreadCrumbs(b,"rightClick")),n.textContent="module"===k?themifyBuilder.modules[g.get("mod_name")].name:k);r.addEventListener("click",u);var x=function(y){"transform"===y.propertyName?(this.removeEventListener("transitionend",x,{passive:!0}),c.Utils.addViewPortClass(this),d.contextMenuAnimate=null):(this.style.top=h+"px",!0===f&&(this.style.left=e+"px"))};this.addEventListener("transitionend",
...
v.body.classList.remove("tb_right_click_open"),this.disablePosition=this.hoverCid=null,!0!==a&&(c.ActionBar.breadCrumbsPath.rightClick=null))},mouseDown(a){1!==a.which||"row"!==this.type&&"subrow"!==this.type||!a.target.classList.contains("tb_move")||(a.preventDefault(),a.stopPropagation(),this.moveComponent())},moveComponent(){var a=c.Instances.Builder[c.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.cid)[0];if(void 0!==a){let b=a.classList.contains("module_row")?a.getElementsByClassName("tb_row_action")[0]:
a;a=m(a).offset();let d;this.clear();"function"===typeof Event?d=new Event("mousedown",{bubbles:!0,cancelable:!1}):(d=v.createEvent("Event"),d.initEvent("mousedown",!0,!1));d.pageX=a.left;d.pageY=a.top;d.which=1;b.dispatchEvent(d)}},click(a){if(c.isPreview||!0===this.disable)return!0;var b=a.target,d=b.tagName,f=null,e=c.Instances.Builder[c.builderIndex].lastRow,h="visual"===c.mode&&b.ownerDocument===w.document?void 0:m(b).closest("[data-cid]")[0],g=a.type;if("click"===g){var k=t.Lightbox.$lightbox[0];
this.hideContextMenu();f=!0===a.ctrlKey||!0===a.metaKey;if(w.document.body.classList.contains("tb_standalone_lightbox")&&!w.document.body.classList.contains("modal-open")){c.toolbar.el.contains(b)||k.contains(b)||k.classList.contains("tb_predesigned_lightbox")||k.classList.contains("tb_custom_css_lightbox")||t.Lightbox.close();var p=w.document.getElementsByClassName("tb_current_menu_selected")[0];void 0!==p&&p.classList.remove("tb_current_menu_selected")}e&&!e.contains(b)&&e.classList.remove("expanded");
if(!k.contains(b)&&(!1===f&&this.clearClicked(),void 0!==h)){if(!0===f&&h.classList.contains("tb_element_clicked")){h.classList.remove("tb_element_clicked");return}h.classList.add("tb_element_clicked")}}else if("dblclick"===g&&null!==c.Forms.LayoutPart.id&&b.classList.contains("tb_overlay")){c.Forms.LayoutPart.save(a,!0);return}e=("click"===g||"dblclick"===g)&&"visual"===c.mode&&t.Lightbox.dockMode.get();if(void 0===h||h.classList.contains("tb_active_layout_part"))"LI"===d&&b.classList.contains("tb_bread")?
(a=c.Models.Registry.lookup(b.getAttribute("data-id")),"setting"!==ThemifyConstructor.clicked&&"module"===ThemifyConstructor.component&&(b=t.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector(".current a").getAttribute("href"),t.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs").on("themify_opened_lightbox.tb_breadCrumbs",function(){"row"===ThemifyConstructor.component?t.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector('a[href="'+
this+'"]').click():null===c.activeModel&&t.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")}.bind(b))),this.breadCrumbsPath.lightbox=this.getBreadCrumbPath(c.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+(null===this.breadCrumbsPath.lightbox?c.activeModel.cid:this.breadCrumbsPath.lightbox[this.breadCrumbsPath.lightbox.length-1]))[0]),a.trigger("edit","breadcrumb")):this.el.contains(b)||"click"===a.type&&b.classList.contains("tb_dragger")||this.clear();else{"visual"!==
c.mode||"A"!==d&&null===b.closest("a")||a.preventDefault();var l=h.getAttribute("data-cid");k=c.Models.Registry.lookup(l);p=k.get("elType");const q="row"===p&&h.classList.contains("tb-page-break");if(k){if("dblclick"===g){if((!0===e||"INPUT"===d||!0===q||b.classList.contains("tb_dragger_lightbox")||null!==b.closest(".tb_clicked"))&&"tb_row_options"!==b.id)return;a.preventDefault();a.stopPropagation();!1===e&&!0!==this.isHoverMode?(h.classList.add("tb_element_clicked"),z.body[0].classList.add("tb_action_active"),
"visual"===c.mode&&c.EdgeDrag.addEdges("module"===p?k.get("mod_name"):p,k,h)):h.classList.remove("tb_element_clicked");if(!b.classList.contains("tb_row_settings")){this.hoverCid=null;k.trigger("edit",a,b);return}}else if("click"===g&&!1===e&&(b.classList.contains("tb_dragger")||null!==b.closest(".tb_dragger_options")))return;d=!0===this.isHoverMode;const n=!0!==d&&null!==this.cid,r="module"!==p?b.classList.contains("tb_action_wrap"):!0===d;this.cid=l;this.type=p;if(!0===q&&"row"===p)this.clear(),
b.classList.contains("tb_row_anchor")&&(a.preventDefault(),a.stopPropagation(),k.trigger("delete",a,b));else if((!1===r||"module"===p&&!0===d)&&null!==b.closest(".tb_action_wrap"))"click"===g&&this.actions(a);else if(!0===d&&"click"===g&&!0===this.needClear)!0===e&&!1===f&&k.trigger("edit",a,b);else if(this.clear(),!0===n&&"click"===g&&!1===f&&!1===e&&!0===this.needClear){z.body[0].classList.add("tb_action_active");const u=this,x=function(){this.removeEventListener("mousemove",x,{passive:!0,once:!0});
null===u.cid&&(z.body[0].classList.remove("tb_action_active"),u.clearClicked())};v.addEventListener("mousemove",x,{passive:!0,once:!0})}else{this.cid=l;this.type=p;g=v.getElementById("tmpl-builder_"+p+"_action").content.cloneNode(!0);if(!0===r){this.prevExpand="module"===p?h.getElementsByClassName("tb_module_action")[0]:b;if(void 0===this.prevExpand){this.clear();return}this.prevExpand.appendChild(g);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");
!0===d&&"module"===p&&(f=h.getBoundingClientRect(),g=this.prevExpand.classList,70>f.height||200>f.width?(g.add("tb_small_action_bar"),g.remove("tb_small_action_bar_top","tb_small_action_bar_bottom"),l=this.prevExpand.getBoundingClientRect().top,40>l||40>l-c.Instances.Builder[c.builderIndex].el.getBoundingClientRect().top?g.add("tb_small_action_bar_top"):g.add("tb_small_action_bar_bottom"),g.toggle("tb_small_action_bar_height",70>f.height),g.toggle("tb_small_action_bar_width",200>f.width)):g.remove("tb_small_action_bar"),
"visual"===c.mode&&c.EdgeDrag.addEdges(k.get("mod_name"),k,h),"visual"===c.mode&&"module"===p&&(this.prevExpand.dataset.module=k.get("mod_name")))}else("row"!==p||"row"===p&&null!==this.breadCrumbsPath.lightbox)&&this.setBreadCrumbs(h),this.el.className="tb_show_toolbar tb_"+p+"_action",f=v.createElement("div"),f.className="tb_action_label_wrap",f.appendChild(g),"visual"===c.mode&&("module"===p?(g=k.get("mod_name"),this.el.className+=" tb_"+g+"_action",g=themifyBuilder.modules[g].name):(g=p,"row"===
p&&(l=k.get("styling").row_anchor,void 0!==l&&(l=l.trim(),""!==l&&(g+=" #"+l)))),l=v.createElement("div"),l.className="tb_data_mod_name",l.textContent=g.charAt(0).toUpperCase()+g.slice(1),f.appendChild(l)),this.el.appendChild(f);!0!==d&&(h.classList.add("tb_element_clicked"),z.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===p?k.get("mod_name"):p,k,h));if(!0===e&&(k.trigger("edit",a,b),!0===d||null!==this.disablePosition&&!1!==r&&!0===d))return;null===this.disablePosition&&
(!1===r&&!0!==d?(b=a.pageX,h=a.pageY,"visual"!==c.mode&&(h=c.Instances.Builder[0].el.getBoundingClientRect(),b=a.clientX-h.left,h=a.clientY-h.top+30),this.setPosition(this.el,{left:b,top:h})):c.Utils.addViewPortClass(this.prevExpand))}}else!0!==isHoverMode&&this.clear()}},setBreadCrumbs(a){for(;null!==this.breadCrumbs.firstChild;)this.breadCrumbs.removeChild(this.breadCrumbs.lastChild);this.breadCrumbs.appendChild(this.getBreadCrumbs(a));null===this.el.firstChild?this.el.appendChild(this.breadCrumbs):
this.el.insertBefore(this.breadCrumbs,this.el.firstChild)},getBreadCrumbPath(a,b){b="rightClick"!==b?"lightbox":b;b=null!==this.breadCrumbsPath[b]?this.breadCrumbsPath[b]:[];if(0<b.length)return b;if(void 0!==a){var d=a.getAttribute("data-cid");for(d&&b.push(d);!a.classList.contains("module_row");)a=a.parentNode,(d=a.getAttribute("data-cid"))&&b.push(d)}return b},getBreadCrumbs(a,b){const d=this.getBreadCrumbPath(a,b),f=v.createDocumentFragment();if(void 0!==a)for(a="rightClick"===b?a.dataset.cid:
c.activeModel?c.activeModel.cid:c.ActionBar.cid,b=d.length-1;-1<b;--b){let e=v.createElement("li"),h=c.Models.Registry.lookup(d[b]),g=h.get("elType");e.textContent="column"===g?h.get("component_name"):"module"===g?h.get("mod_name"):g;e.className="tb_bread tb_bread_"+g;a===d[b]&&(e.className+=" tb_active_bc");e.setAttribute("data-id",d[b]);f.appendChild(e)}return f},actions(a){var b=c.ActionBar,d=a.target,f=d.tagName;if("keydown"===a.type){if("INPUT"!==f&&"TEXTAREA"!==f&&!themifyBuilder.disableShortcuts&&
!t.Lightbox.$lightbox[0].contains(d)&&("visual"!==c.mode||!v.activeElement.contentEditable&&c.liveStylingInstance.$liveStyledElmt[0].contains(v.activeElement))){d=a.keyCode;var e=v.getElementsByClassName("tb_element_clicked");f=e.length;if(0<f){"keydown"!==a.type&&(a.preventDefault(),a.stopPropagation());var h=null,g=null,k=void 0,p=!0===a.ctrlKey||!0===a.metaKey;46===d||8===d?h="delete":!0===p&&(67===d?(h="copy",f=1):68===d?h="duplicate":86===d&&(h="paste",!0===a.shiftKey&&(g="style")));1<f&&("delete"===
h||"paste"===h)&&(k=!0,null!==c.activeModel&&t.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(let q=f-1;-1<q;--q){let n=e[q];if(null===h){if(!0===p&&1===f&&(38===d||40===d)){let r=38===a.which?"up":"down";var l="up"===r?n.previousElementSibling:n.nextElementSibling;if(null!==l){if(n.classList.contains("module_row")){if(!l.classList.contains("module_row"))continue}else if(n.classList.contains("active_module")){if(!l.classList.contains("active_module"))continue;m(n.parentNode.closest(".tb_holder"))}else continue;
l&&(l=m(n),"up"===r?l.prev().before(l):l.next().after(l),!0!==b.isHoverMode&&n.classList.add("tb_element_clicked"))}}}else"delete"===h&&n.classList.contains("module_column")||c.Models.Registry.lookup(m(n).closest("[data-cid]")[0].getAttribute("data-cid")).trigger(h,a,g,k)}"delete"!==h&&!0===b.isHoverMode||b.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==d.closest(".switch-wrapper"))d.classList.contains("toggle_switch")&&c.Models.Registry.lookup(m(d).closest("[data-cid]")[0].getAttribute("data-cid")).trigger("visibility",
