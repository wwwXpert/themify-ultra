...
if (!class_exists('Themify_Customizer')) :
	...
	class Themify_Customizer {
		...
		function customize_control_scripts() {
			...
			// Minicolors
			themify_enque_style('themify-colorpicker', THEMIFY_METABOX_URI . 'css/themify.minicolors.css', null, THEMIFY_VERSION);
			...
			// Minicolors JS
			themify_enque_script('themify-colorpicker-js', THEMIFY_METABOX_URI . 'js/themify.minicolors.js', array('jquery'), THEMIFY_VERSION,true);
