...
(function(Themify, $,document){
	...
	const _init = function(pr_wrap,wrap){
			const container = document.createElement('div'),
				...
				pr_price = pr_wrap.querySelector('.price'),
				pr_image = pr_wrap.getElementsByClassName('woocommerce-product-gallery__image'),
			...
			if(pr_image[0]){
				...
				gallery.appendChild(pr_image[0].cloneNode(true));
