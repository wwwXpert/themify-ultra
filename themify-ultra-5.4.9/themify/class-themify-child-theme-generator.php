...
class Themify_Child_Theme_Generator {
	 ...
	 */
	static function maybe_generate_theme() {
		if ( is_child_theme() ) {
...
MARKER;
	...
	static function form() {
		...
		<div class="tf_generate_child_theme">
			...
			<p class="success"><?php echo themify_get_icon( 'ti-check' ); ?> <?php _e( 'Child theme has been generated and activated.', 'themify' ); ?></p>
			<p>
			...
			<a href="#" class="themify_button big-button generate-child-theme" data-confirm="<?php echo $exists ? esc_attr__( 'Would you like to activate the child theme?', 'themify' ) : esc_attr__( 'Would you like to create and activate a child theme?', 'themify' ) ?>">
