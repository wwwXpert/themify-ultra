...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'scheme_link_color' => array(
			...
			'selector' => '.transparent-header #headerwrap a,#headerwrap a,#footerwrap a,input[type=reset], input[type=submit], button, button[type=submit], .woocommerce #content input.button, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #content input.button.alt, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt,.module-buttons .module-buttons-item .ui.builder_button,.transparent-header #headerwrap.fixed-header a, #headerwrap.fixed-header a, #main-nav .current_page_item > a, #main-nav .current-menu-item > a',
			'prop' => 'color',
		),
		...
		'scheme_background' => array(
			...
			'selector' => '.transparent-header #headerwrap.fixed-header,#headerwrap.fixed-header,#headerwrap,#footerwrap,input[type=reset], input[type=submit], button, button[type=submit], .woocommerce #content input.button, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #content input.button.alt, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt,.module-buttons .module-buttons-item .builder_button',
			'prop' => 'background',
		),
		...
		'main_nav_dropdown_link_background' => array(
			...
			'selector' => '#main-nav ul a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, #main-nav .has-mega-column > .sub-menu a, #main-nav .has-mega-sub-menu > .sub-menu a',
			'prop' => 'background',
		),
		...
		'main_nav_dropdown_link_color' => array(
			...
			'selector' => '#main-nav ul a, #main-nav .current_page_item ul a, #main-nav ul .current_page_item a, #main-nav .current-menu-item ul a, #main-nav ul .current-menu-item a, .fixed-header #main-nav ul a, #main-nav .has-mega-column > .sub-menu a, #main-nav .has-mega-sub-menu > .sub-menu a',
			'prop' => 'color',
		),
		...
		'main_nav_link_dropdown_active_background' => array(
			...
			'selector' => '#main-nav ul .current_page_item a, #main-nav ul .current-menu-item a, #main-nav .has-sub-menu > .sub-menu .current-menu-item a, #main-nav .has-mega-column > .sub-menu .current-menu-item > a, #main-nav .has-mega-column > .sub-menu .current-menu-item a',
			'prop' => 'background',
		),
