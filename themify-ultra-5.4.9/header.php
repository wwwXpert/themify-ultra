...
<?php if ( $search_form !== 'search_form' && $search_form!==false ){
    get_template_part( 'themify/includes/search-box' );
}
?>
<div id="pagewrap" class="tf_box hfeed site">
    <a class="screen-reader-text skip-to-content" href="#content"><?php _e('Skip to content','themify'); ?></a>
						...
						<div class="navbar-wrapper tf_clearfix">
							...
							<?php if ($search_form!==false ){
									if ($search_form  === 'search_form') {
										...
										echo '<a class="search-button tf_vmiddle tf_inline_b" href="#">'.themify_get_icon('search','fa',false,false,array('aria-label'=>__('Search','themify'))).'<span class="screen-reader-text">'.__('Search','themify').'</span></a>';
									}
							}?>
