...
function themify_enqueue_framework_assets() {
	// Skin stylesheet
	if ( $skin = themify_get_skin() ) {
		wp_enqueue_style( 'themify-skin', themify_enque( trailingslashit( get_template_directory_uri() ) . 'skins/' . $skin . '/style.css' ), array( 'theme-style' ), THEMIFY_VERSION );
		if ( is_rtl() && file_exists( trailingslashit( get_template_directory() ) . 'skins/' . $skin . '/rtl.css' ) ) {
			wp_enqueue_style( 'themify-skin-rtl', themify_enque( trailingslashit( get_template_directory_uri() ) . 'skins/' . $skin . '/rtl.css' ), array( 'theme-style', 'themify-skin' ), THEMIFY_VERSION );
		}
	}
