...
(function(a,d){"function"===typeof define&&define.amd?define([],d):"object"===typeof module&&module.exports?module.exports=d():a.Rellax=d()})(this,function(){var a={};return Rellax=function(d,f){var e=Object.create(Rellax.prototype),g=0,k=0,t=!1,h=!0,n,u,y=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.msRequestAnimationFrame||window.oRequestAnimationFrame||function(b){setTimeout(b,1E3/60)},p=window.transformProp||function(){var b=document.createElement("div");
...
Math.max(d,-(k-c.data.height)),d=Math.min(d,k/4));c=d;d="translate3d(0,"+c+"px,0)";b.el.dataset.currentPos=c;if(b.data.fade){var f=b.el.getBoundingClientRect(),m=f.bottom-.15*k;b.el.style.opacity=0<=f.bottom&&m<=b.data.height?m/b.data.height:0<f.top?1:""}b.data.runningAnimation&&"absolute"!==b.el.style.position?(b.el.style.position="relative",b.el.style.top=c+"px",b.el.style[p]=""):(b.el.style.top&&(b.el.style.position=b.el.style.top=""),b.el.style[p]=d)}};Rellax.destroy=function(b){function d(b,
d){var c=b.el;c.style.cssText=b.data.style;c.removeAttribute("data-parallax-element-speed");c.removeAttribute("data-parallax-fade");c.removeAttribute("data-parallax-element-reverse");c.removeAttribute("data-current-pos");c.removeAttribute("data-rellax-index");delete c.dataset.rellaxIndex;delete c.dataset.currentPos;delete c.dataset.parallaxFade;delete c.dataset.parallaxElementSpeed;delete c.dataset.parallaxElementReverse;c.style.opacity=c.style[p]="";delete a[d]}if(b&&void 0!==a[b])d(a[b],b);else for(var c in a)d(a[c],
c);0===Object.keys(a).length&&(t=!0,jQuery(window).off("tfsmartresize.tb_parallax"));n&&cancelAnimationFrame(n)};Rellax.disableCheckPosition=function(){h=!1};Rellax.enableCheckPosition=function(){h=!0};(function(){k=window.innerHeight;w();for(var b=0,d=l.length;b<d;++b){var c=void 0!==l[b].dataset.rellaxIndex?l[b].dataset.rellaxIndex:Object.keys(a).length;l[b].dataset.rellaxIndex=c;a[c]={};a[c].el=l[b];a[c].data=z(l[b])}jQuery(window).off("tfsmartresize.tb_parallax").on("tfsmartresize.tb_parallax",
