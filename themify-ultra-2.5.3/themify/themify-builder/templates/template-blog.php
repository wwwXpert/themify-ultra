...
$container_class = apply_filters('themify_builder_module_classes', array(
    'module', 'module-' . $mod_name, $args['module_ID'], $fields_args['css_' . $mod_name]
...
?>
<?php
if ($fields_args['orderby_' . $mod_name] === 'rand' || TFCache::start_cache($mod_name, self::$post_id, array('page' => $paged, 'ID' => $args['module_ID']))):
...
<?php endif; ?>
<?php $ThemifyBuilder->in_the_loop = $isLoop; ?>
