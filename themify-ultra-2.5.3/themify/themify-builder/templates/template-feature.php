        ...
        <div class="module-feature-content">
			<?php
				if ( ''!== $fields_args['title_feature']  ) {
                                    ...
                                    ?>
                                        <h3 class="module-feature-title"<?php if (Themify_Builder::$frontedit_active && '' === $fields_args['link_feature']):?> contenteditable="false" data-name="title_feature"<?php endif;?>>
                                            <?php if ('' !== $fields_args['link_feature']):?>
                                            ...
                                            ?>
                                                <a<?php if(Themify_Builder::$frontedit_active):?> contenteditable="false" data-name="title_feature"<?php endif;?> href="<?php echo esc_url( $fields_args['link_feature'] )?>"<?php echo $link_attr?>><?php echo $fields_args['title_feature'] ?></a>
                                            <?php else:?>
			...
			?>
	    <div class="tb_text_wrap<?php if(Themify_Builder::$frontedit_active):?> tb_editor_enable<?php endif;?>"<?php if(Themify_Builder::$frontedit_active):?> contenteditable="false" data-name="content_feature"<?php endif;?>>
