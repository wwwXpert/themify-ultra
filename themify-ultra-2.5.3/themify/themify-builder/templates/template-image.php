	...
	<?php $container_props=$container_class=null; ?>
        ...
        <?php if ($image_title !== '' || $fields_args['caption_image'] !== ''): ?>
            <div class="image-content">
                <?php if ($image_title !== ''): ?>
                    <h3 class="image-title"<?php if(Themify_Builder::$frontedit_active && $fields_args['link_image'] === ''):?> contenteditable="false" data-name="title_image"<?php endif;?>>
                        <?php if ($fields_args['link_image'] !== ''): ?>
                            <a<?php if(Themify_Builder::$frontedit_active):?> contenteditable="false" data-name="title_image"<?php endif; ?> href="<?php echo esc_url($fields_args['link_image']); ?>" 
                               <?php if ($lightbox) : ?> class="lightbox-builder themify_lightbox"<?php echo $lightbox_data; ?><?php endif; ?>
                               <?php if ($newtab): ?> rel="noopener" target="_blank"<?php endif; ?>>
		...
		<?php if ($fields_args['caption_image'] !== ''): ?>
                    <div class="image-caption tb_text_wrap"<?php if(Themify_Builder::$frontedit_active):?> contenteditable="false" data-name="caption_image"<?php endif; ?>>
