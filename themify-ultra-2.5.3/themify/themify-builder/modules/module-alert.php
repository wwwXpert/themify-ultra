...
class TB_alert_Module extends Themify_Builder_Component_Module {
	...
	$alert_title = array(
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_font_family(' .alert-heading', 'f_f_a_t'),
			    self::get_color('.module .alert-heading', 'f_c_a_t'),
			    self::get_font_size(' .alert-heading', 'f_s_a_t'),
			    self::get_line_height(' .alert-heading', 'l_h_a_t'),
			    self::get_letter_spacing(' .alert-heading', 'l_s_a_t'),
			    self::get_text_transform(' .alert-heading', 't_t_a_t'),
			    self::get_font_style(' .alert-heading', 'f_st_a_t', 'f_s_a_b'),
			    self::get_text_shadow(' .alert-heading', 't_sh_a_t')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_font_family(' .alert-heading', 'f_f_a_t', 'h'),
			    self::get_color('.module .alert-heading', 'f_c_a_t', null, null, 'h'),
			    self::get_font_size(' .alert-heading', 'f_s_a_t', '', 'h'),
			    self::get_line_height(' .alert-heading', 'l_h_a_t', 'h'),
			    self::get_letter_spacing(' .alert-heading', 'l_s_a_t', 'h'),
			    self::get_text_transform(' .alert-heading', 't_t_a_t', 'h'),
			    self::get_font_style(' .alert-heading', 'f_st_a_t', 'f_s_a_b', 'h'),
			    self::get_text_shadow(' .alert-heading', 't_sh_a_t', 'h')
			)
		    )
		))
	    )),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_margin(' .alert-heading', 'm_a_t')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_margin(' .alert-heading', 'm_a_t', 'h')
			)
		    )
		))
	    ))
