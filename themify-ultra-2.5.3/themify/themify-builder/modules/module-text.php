	...
	$general = array(
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_font_style(),
			    self::get_text_decoration(array(' p', ' blockquote', ' h1', ' h2', ' h3', ' h4', ' h5', ' h6', ' li', ' span'), 'text_decoration_regular'),
			...
			'options' => array(
			    ...
			    self::get_text_decoration(array(' p', ' blockquote', ' h1', ' h2', ' h3', ' h4', ' h5', ' h6', ' li', ' span'), 't_d_r', 'h'),
