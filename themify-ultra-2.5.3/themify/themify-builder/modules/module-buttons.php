		...
		$button_link = array(
			...
			self::get_expand( 'l', array(
				self::get_tab( array(
					...
					'h' => array(
						'options' => array(
							self::get_color( array( ' .module-buttons-item a', ' .module-buttons-item a i' ), 'link_color', null, null, 'hover' ),
			...
			self::get_expand( 'b', array(
				self::get_tab( array(
					'n' => array(
						'options' => array(
							self::get_border( ' .module-buttons-item a', 'link_border' )
						)
					),
					'h' => array(
						'options' => array(
							self::get_border( ' .module-buttons-item a', 'l_b', 'h' )
						)
					)
				) )
			) ),
