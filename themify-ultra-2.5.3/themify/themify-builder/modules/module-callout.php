...
class TB_Callout_Module extends Themify_Builder_Component_Module {
	...
	$general = array(
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_letter_spacing(' .callout-content'),
			    self::get_text_align(' .callout-content'),
			    self::get_text_transform(' .callout-content'),
			    self::get_font_style(' .callout-content'),
			...
			'options' => array(
			    ...
			    self::get_letter_spacing(' .callout-content', 'l_s', 'h'),
			    self::get_text_align(' .callout-content', 't_a', 'h'),
			    self::get_text_transform(' .callout-content', 't_t', 'h'),
			    self::get_font_style(' .callout-content', 'f_st', 'f_w', 'h'),
	...
	$callout_title = array(
		...
		'n' => array(
		    'options' => array(
			self::get_font_family(' .callout-heading', 'font_family_alert_title'),
			self::get_color('.module .callout-heading', 'font_color_alert_title'),
			self::get_font_size(' .callout-heading', 'font_size_alert_title'),
			self::get_line_height(' .callout-heading', 'line_height_alert_title'),
			self::get_letter_spacing(' .callout-heading', 'letter_spacing_alert_title'),
			self::get_text_transform(' .callout-heading', 'text_transform_title'),
			self::get_font_style(' .callout-heading', 'font_style_title', 'font_title_bold'),
			self::get_text_shadow(' .callout-heading', 't_sh_c_t')
		    )
		),
		'h' => array(
		    'options' => array(
			...
			self::get_font_size(' .callout-heading', 'f_s_a_t','', 'h'),
			self::get_line_height(' .callout-heading', 'l_h_a_t','h'),
			self::get_letter_spacing(' .callout-heading', 'l_s_a_t','h'),
			self::get_text_transform(' .callout-heading', 't_t_t','h'),
			self::get_font_style(' .callout-heading', 'f_s_t', 'f_t_b','h'),
            self::get_text_shadow(' .callout-heading', 't_sh_c_t','h')
		    )
		)
	    ))
	);
