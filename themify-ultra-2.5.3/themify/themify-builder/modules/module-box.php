...
class TB_Box_Module extends Themify_Builder_Component_Module {
                ...
                self::get_tab(array(
                    'n' => array(
                        'options' => array(
                            ...
                            self::get_text_shadow(' ' . $h, 't_sh_' . $h),
                            // Heading  Margin
                    ...
                    'h' => array(
                        'options' => array(
                            ...
                            self::get_font_size(':hover ' . $h, 'f_s_' . $h.'_h'),
                            self::get_line_height(':hover ' . $h, 'l_h_' . $h.'_h'),
                            self::get_letter_spacing(':hover ' . $h, 'l_s_' . $h.'_h'),
                            self::get_text_transform(':hover ' . $h, 't_t_' . $h.'_h'),
                            self::get_font_style(':hover ' . $h, 'f_st_' . $h.'_h', 'f_w_' . $h.'_h'),
                            self::get_text_shadow(':hover ' . $h, 't_sh_' . $h.'_h','h'),
                            // Heading  Margin
    ...
    protected function _visual_template() {
        ...
        <div class="module module-<?php echo $this->slug; ?>">
            ...
            <# } #>
            <div class="ui module-<?php echo $this->slug; ?>-content {{ data.color_box }} {{ data.add_css_box }} <# data.appearance_box ? print( data.appearance_box.split('|').join(' ') ) : ''; #>">
