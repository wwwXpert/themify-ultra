    ...
    public function get_styling() {
        ...
        $feature_title = array(
            ...
            self::get_tab(array(
                'n' => array(        
                    'options' => array(
                        self::get_font_family(array('.module h3.module-feature-title', '.module h3.module-feature-title a'), 'font_family_title'),
                        self::get_color(array('.module .module-feature-content .module-feature-title', '.module .module-feature-content .module-feature-title a'), 'font_color_title'),
                        self::get_font_size(' .module-feature-title', 'font_size_title'),
                        self::get_line_height(' .module-feature-title', 'line_height_title'),
                        self::get_letter_spacing(' .module-feature-title', 'l_s_t'),
                        self::get_text_transform(' .module-feature-title', 't_t_t'),
                        self::get_font_style(' .module-feature-title', 'f_s_t', 'f_t_b'),
			...
			self::get_color(array('.module .module-feature-content .module-feature-title', '.module .module-feature-content .module-feature-title a'), 'font_color_title',  null, null, 'hover'),
                        self::get_font_size(' .module-feature-title', 'f_s_t', '', 'h'),
                        self::get_line_height(' .module-feature-title', 'l_h_t', 'h'),
                        self::get_letter_spacing(' .module-feature-title', 'l_s_t', 'h'),
                        self::get_text_transform(' .module-feature-title', 't_t_t', 'h'),
                        self::get_font_style(' .module-feature-title', 'f_st_t', 'f_t_b', 'h'),
        ...
        $feature_content = array(
            ...
            self::get_tab(array(
                'n' => array(
                    'options' => array(
                        self::get_font_family(array(' .module-feature-content', ' .module-feature-content a'), 'font_family_content'),
                        self::get_color(array('.module .tb_text_wrap','.module h3.module-feature-title',  '.module .module-feature-content a'), 'f_c_c'),
                        self::get_font_size(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 'f_s_c'),
                        self::get_line_height(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 'l_h_c'),
                        self::get_letter_spacing(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 'l_s_c'),
                        self::get_text_shadow(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 't_sh_c')
                    )
                ),
                'h' => array(
                    'options' => array(
                        self::get_font_family(array(' .module-feature-content', ' .module-feature-content a'), 'f_f_c', 'h'),
                        self::get_color(array('.module .tb_text_wrap','.module h3.module-feature-title', '.module .module-feature-content a'), 'f_c_c', null, null, 'h'),
                        self::get_font_size(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 'f_s_c', '', 'h'),
                        self::get_line_height(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 'l_h_c', 'h'),
                        self::get_letter_spacing(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 'l_s_c', 'h'),
			self::get_text_shadow(array(' .module-feature-content', ' .module-feature-content a',' .module-feature-content p'), 't_sh_c','h')
                    )
                )
            ))
		)),
