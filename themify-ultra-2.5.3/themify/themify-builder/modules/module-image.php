	...
	$general = array(
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_letter_spacing(' .image-content'),
			...
			'options' => array(
			    ...
			    self::get_letter_spacing(' .image-content', 'l_s', 'h'),
	...
	$image_title = array(
		...
		self::get_tab(array(
			...
			'options' => array(
			    ...
			    self::get_font_style(' .image-title', 'font_style_title'),
			...
			'options' => array(
			    ...
			    self::get_font_style(' .image-title', 'f_st_t', 'f_w_t', 'h'),
		...
		self::get_tab(array(
		    'n' => array(
			'options' => array(
			    self::get_margin(' .image-title', 'title_margin')
			)
		    ),
		    'h' => array(
			'options' => array(
			    self::get_margin(' .image-title', 't_m', 'h')
			)
		    )
		))
	    ))
