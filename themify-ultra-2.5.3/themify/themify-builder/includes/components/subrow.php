...
class Themify_Builder_Component_Subrow extends Themify_Builder_Component_Base {
	...
	$subrow_tag_attrs = Themify_Global_Styles::add_class_to_components($subrow_tag_attrs , $is_styling===true ? $mod['styling'] : array(), parent::$used_gs);
	$subrow_tag_attrs = apply_filters('themify_builder_subrow_attributes',$subrow_tag_attrs , $is_styling===true ? $mod['styling'] : array(), $builder_id,parent::$used_gs);
	...
	<div <?php echo self::get_element_attributes($subrow_tag_attrs); ?> <?php echo $video_data ?>>
	    ...
	    ?>
	    <div class="subrow_inner<?php if (!Themify_Builder::$frontedit_active): ?> <?php echo $row_content_classes ?><?php $row_content_classes=null;endif; ?>" <?php if (!empty($row_content_attr)): ?> <?php echo self::get_element_attributes($row_content_attr) ?><?php $row_content_attr=null;endif; ?>>
		<?php
		if ($count > 0) {
