...
class Themify_Builder_Component_Row extends Themify_Builder_Component_Base {
	...
	if(!Themify_Builder::$frontedit_active || $ThemifyBuilder->in_the_loop===true){
	...
	$row_classes=null;
	$row_attributes = Themify_Global_Styles::add_class_to_components( $row_attributes, $is_styling===true ? $row['styling'] : array(), parent::$used_gs);
	$row_attributes = apply_filters('themify_builder_row_attributes', $row_attributes, $is_styling===true ? $row['styling'] : array(), $builder_id,parent::$used_gs);
	...
	<div <?php echo $video_data, self::get_element_attributes($row_attributes); ?>>
	    ...
	    ?>
	    <div class="row_inner<?php if (!Themify_Builder::$frontedit_active): ?> <?php echo $row_content_classes ?><?php $row_content_classes=null;endif; ?>" <?php if (!empty($row_content_attr)): ?> <?php echo self::get_element_attributes($row_content_attr); ?><?php $row_content_classes=null;endif; ?>>
		<?php
		if ($count > 0) {
