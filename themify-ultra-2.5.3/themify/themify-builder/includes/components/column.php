...
class Themify_Builder_Component_Column extends Themify_Builder_Component_Base {
	...
	$column_tag_attrs = Themify_Global_Styles::add_class_to_components( $column_tag_attrs, $is_styling===true ? $col['styling'] : array(),parent::$used_gs);
	...
	// background video
	$video_data = $is_styling===true ? self::get_video_background($col['styling']) : '';
	...
	<div <?php echo self::get_element_attributes($column_tag_attrs); ?> <?php echo $video_data; ?>>
		...
		self::background_styling($col, 'column');
	...
	$print_sub_col_classes = Themify_Global_Styles::add_class_to_components( array('class'=>$print_sub_col_classes), $is_styling===true ? $sub_col['styling'] : array(),parent::$used_gs);
	$print_sub_col_classes = $print_sub_col_classes['class'];
	// background video
	$video_data = $is_styling===true  ? ' ' . self::get_video_background($sub_col['styling']) : '';
	...
	<div <?php echo!empty($sub_col['grid_width']) && !Themify_Builder::$frontedit_active ? 'style="width:' . $sub_col['grid_width'] . '%;"' : '' ?> class="<?php echo esc_attr($print_sub_col_classes) ?>"<?php echo $video_data ?>> 
		...
		self::background_styling($sub_col, 'sub_column');
