...
(function ( $ ) {
    ...
    window.themifyColorManager = {
        ...
        initColorPicker : function () {
            ...
            fr.appendChild(newSwatchesContainer);
            ...
            var swatches = fr.querySelectorAll('.minicolors-swatch');
            // Add delete Icon
            var keys = Object.keys(this.colorSwatches);
            keys = keys.reverse();
            for(var i = swatches.length-1;i>=0;--i){
                if(!keys.length){
            ...
            fr = container = newSwatchesContainer = swatches = null;
        },
        ...
        makeImportExportDropdown:function(){
            ...
            var exportCM = document.createElement('li');
