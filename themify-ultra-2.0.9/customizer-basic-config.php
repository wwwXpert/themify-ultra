...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'scheme_font_color' => array(
			...
			'selector' => '.transparent-header #headerwrap,#headerwrap,#footerwrap',
			'prop' => 'color',
		),
		...
		'scheme_background' => array(
			...
			'selector' => '.transparent-header #headerwrap,#headerwrap,#footerwrap,input[type=reset], input[type=submit], button, .woocommerce #content input.button, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #content input.button.alt, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt,.module-buttons .module-buttons-item .builder_button',
			'prop' => 'background',
		),
