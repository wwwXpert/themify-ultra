...
if(Themify_Builder::$frontedit_active || !isset($bids[$builder_id])){
    ...
    if ( $styles ) {
        ...
        ?>
        <link class="themify-builder-generated-css" rel="stylesheet" href="<?php echo $styles['url']?>" />
        <?php if ( ! empty( $fonts ) ) : ?>
                <link class="themify-builder-generated-css" rel="stylesheet" href="//fonts.googleapis.com/css?family=<?php echo implode( '|', $fonts ); ?>" />
        <?php endif;
    }
    if ( isset( $saved_post )  ) {
        $post = $saved_post;
