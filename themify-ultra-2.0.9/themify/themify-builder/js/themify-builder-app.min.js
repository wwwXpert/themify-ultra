var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(e,A,t){e instanceof String&&(e=String(e));for(var x=e.length,b=0;b<x;b++){var D=e[b];if(A.call(t,D,b,e))return{i:b,v:D}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(e,A,t){e!=Array.prototype&&e!=Object.prototype&&(e[A]=t.value)};$jscomp.getGlobal=function(e){return"undefined"!=typeof window&&window===e?e:"undefined"!=typeof global&&null!=global?global:e};
...
cache:{repeaterElements:{}}},D=[];b.mode="default";b.autoSaveCid=null;b.hasChanged=null;b.editing=!1;b.init=!1;b.scrollTo=!1;b.eventName=!1;b.beforeEvent=!1;b.saving=!1;b.activeBreakPoint="desktop";b.zoomMeta={isActive:!1,size:100};b.isPreview=!1;b.Models.Module=Backbone.Model.extend({defaults:{element_id:null,elType:"module",mod_name:"",mod_settings:{}},initialize:function(){b.Models.Registry.register(this.cid,this);this.get("element_id")||this.set({element_id:b.Utils.generateUniqueID()},{silent:!0})},
...
b.Views.init_module(a);a.model.trigger("custom:change",a)},backendLivePreview:function(){e(".tb_element_cid_"+this.cid).find(".module_excerpt").text(this.getExcerpt(D))},getPreviewSettings:function(){return _.extend({cid:this.cid},themifyBuilder.modules[this.get("mod_name")].defaults,D)},getIDattr:function(){return this.get("element_id")?this.get("element_id"):b.Utils.generateUniqueID()}});b.Models.SubRow=Backbone.Model.extend({defaults:{element_id:null,elType:"subrow",row_order:0,gutter:"gutter-default",
...
arguments);_.isFunction(a.initialize)&&a.initialize.apply(this,arguments)};return d};b.Views.Modules["default"]=b.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"tb_module module-"+this.model.get("mod_name")+" active_module tb_element_cid_"+this.model.cid,"data-cid":this.model.cid}},template:"visual"===b.mode?null:wp.template("builder_module_item"),events:{dblclick:"edit","click .themify_module_options":"edit","click .tb_module_styling":"edit","click .tb_visibility_component ":"edit",
"click .tb_swap":"edit"},initialize:function(){this.listenTo(this,"edit",this.edit);this.listenTo(this.model,"dom:module:unsaved",this.removeUnsaved);this.listenTo(this.model,"change:view",this.setView)},removeUnsaved:function(){this.model.destroy()},render:function(){"visual"!==b.mode&&(this.el.innerHTML=this.template(this.model.toRenderData()));return this},setView:function(a){this.setElement(a)},edit:function(a){if(b.isPreview)return!0;if(null!==a){a.preventDefault();a.stopPropagation();var c=
a.currentTarget.classList;if("visual"===b.mode&&!b.Forms.LayoutPart.id&&"layout-part"===this.model.get("mod_name")&&!c.contains("tb_swap")&&("dblclick"===a.type||c.contains("themify_module_options"))){b.Forms.LayoutPart.edit(a.currentTarget);return}c.contains("tb_module_styling")?this.model.set({styleClicked:!0},{silent:!0}):c.contains("tb_visibility_component")&&this.model.set({visibileClicked:!0},{silent:!0})}this.model.cid!==b.autoSaveCid&&null!==b.autoSaveCid&&b.Forms.saveComponent(null);b.activeModel=
this.model;this.editComponent()}});b.Views.Columns["default"]=b.Views.BaseElement.extend({tagName:"div",attributes:function(){var a="column"===this.model.get("component_name")?"":" sub_column",a={"class":"module_column tb-column tb_element_cid_"+this.model.cid+" "+this.model.get("grid_class")+a,"data-cid":this.model.cid,"data-id":this.model.get("element_id")};this.model.get("grid_width")&&(a.style="width:"+this.model.get("grid_width")+"%");return a},template:wp.template("builder_column_item"),events:{"click .tb_option_column":"edit",
dblclick:"edit"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},render:function(a,c){var d=this.model.get("component_name");this.el.innerHTML=this.template({component_name:d});var f=this.model.get("modules");if(f){var g=document.createDocumentFragment(),e;for(e in f)if(void 0!==f[e]&&null!==f[e]){var k=f[e],l=void 0===k.cols?b.Views.init_module(k):b.Views.init_subrow(k);if(l){var m=void 0===k.cols&&c?c+"-"+e:a?a+"-"+e:!1;b.id&&k.mod_name&&!1!==m&&(b.VisualCache[l.model.cid]=
k.mod_name+"-"+b.id+"-"+m);g.appendChild(l.view.render(m).el)}}f=this.el.getElementsByClassName("tb_holder")[0];f.appendChild(g);"sub-column"===d&&f.classList.add("tb_subrow_holder")}return this},edit:function(a){a.preventDefault();a.stopPropagation();this.model.cid!==b.autoSaveCid&&null!==b.autoSaveCid&&b.Forms.saveComponent(null);b.activeModel=this.model;this.editComponent()},setView:function(a){this.setElement(a)}});b.Views.SubRows["default"]=b.Views.BaseElement.extend({tagName:"div",attributes:function(){return{"class":"themify_builder_sub_row module_subrow active_module clearfix tb_element_cid_"+
this.model.cid,"data-cid":this.model.cid,"data-id":this.model.get("element_id")}},events:{dblclick:"edit","click .tb_style_subrow":"edit","click .tb_visibility_subrow":"edit","mousedown select":"openSelectBox"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},openSelectBox:function(a){a.stopPropagation()},render:function(a){var c=this.model.get("cols"),d=Object.keys(c).length;this.el.innerHTML=ThemifyBuilderCommon.templateCache.get("tmpl-builder_subrow_item");b.id&&(b.VisualCache[this.model.cid]=
"sub_row_"+a);if(0<d){for(var f=document.createDocumentFragment(),g=!1,e=0;e<=d;++e)if(void 0!==c[e]){c[e].component_name="sub-column";var k=a+"-"+e,l=b.Views.init_column(c[e]);b.id&&(b.VisualCache[l.model.cid]="sub_column_post_"+b.id+" sub_column_"+k);f.appendChild(l.view.render("sub_row_"+k).el);!1===g&&void 0!==c[e].modules&&0<c[e].modules.length&&(g=!0)}!1===g&&this.el.classList.add("tb_row_empty");this.el.getElementsByClassName("subrow_inner")[0].appendChild(f)}b.init&&!b.id&&b.Utils.selectedGridMenu(this.el);
return this},setView:function(a){this.setElement(a)},edit:function(a){a.stopPropagation();a.preventDefault();a.currentTarget.classList.contains("tb_style_subrow")?this.model.set({styleClicked:!0},{silent:!0}):a.currentTarget.classList.contains("tb_visibility_subrow")&&this.model.set({visibileClicked:!0},{silent:!0});this.model.cid!==b.autoSaveCid&&null!==b.autoSaveCid&&b.Forms.saveComponent(null);b.activeModel=this.model;this.editComponent()}});b.Views.Rows["default"]=b.Views.BaseElement.extend({tagName:"div",
attributes:function(){var a=this.model.attributes.styling&&"custom_css_row"in this.model.attributes.styling&&-1!==this.model.attributes.styling.custom_css_row.indexOf("tb-page-break")?"tb-page-break":"";return{"class":"themify_builder_row module_row clearfix tb_element_cid_"+this.model.cid+" "+a,"data-cid":this.model.cid}},events:{"click .tb_option_row":"edit",dblclick:"edit","click .tb_style_row":"edit","click .tb_visibility_component ":"edit","click .tb_grid_list li a":"_gridClicked","click .grid_tabs li a":"_switchGridTabs",
"click .tb_column_alignment li a":"_columnAlignmentClicked","click .tb_column_direction li a":"_columnDirectionClicked","change .gutter_select":"_gutterChange","dblclick .tb_options_row_hover":"_stopLightbox","hover .tb_option_row":"_updatePreviewOptions","click .tb_row_hover__expand":"_expandOptions","blur .tb_options_row_hover .tb_row_hover__input":"_setPreviewOption","click .tb_row_hover__icon":"_setPreviewOption"},initialize:function(){this.listenTo(this.model,"change:view",this.setView)},render:function(a,
c){var d=this.model.get("cols"),f=Object.keys(d).length;this.el.innerHTML=ThemifyBuilderCommon.templateCache.get("tmpl-builder_row_item");if(0<f){for(var g=document.createDocumentFragment(),e,k=!1,l=!1,m=!1,n=0;n<=f;++n)if(void 0!==d[n]){d[n].component_name="column";var p=b.Views.init_column(d[n]);b.id&&(e=p.model.get("column_order"),void 0===e&&(e=n),k=a+"-"+e,l=c+"-"+e);b.id&&(b.VisualCache[p.model.cid]="module_column_"+e+" tb_"+b.id+"_column");g.appendChild(p.view.render(k,l).el);!1===m&&void 0!==
d[n].modules&&0<d[n].modules.length&&(m=!0)}!1===m&&this.el.classList.add("tb_row_empty");this.el.getElementsByClassName("row_inner")[0].appendChild(g)}else this.el.classList.add("tb_row_empty"),b.Utils._addNewColumn({newclass:"col-full",component:"column"},this.el.getElementsByClassName("row_inner")[0]);b.Utils.selectedGridMenu(this.el);return this},edit:function(a){a.stopPropagation();a.preventDefault();b.activeModel&&b.activeModel.cid===this.model.get("cid")||(a.currentTarget.classList.contains("tb_style_row")?
this.model.set({styleClicked:!0},{silent:!0}):a.currentTarget.classList.contains("tb_visibility_component")&&this.model.set({visibileClicked:!0},{silent:!0}),this.model.cid!==b.autoSaveCid&&null!==b.autoSaveCid&&b.Forms.saveComponent(null),b.activeModel=this.model,this.editComponent())},_switchGridTabs:function(a){b.scrollTo=e(a.currentTarget).closest("[data-cid]");b.Forms.lightbox_switcher(a)},_gridClicked:function(a){a.preventDefault();a=e(a.currentTarget);var c=a.data("grid"),d=a.data("handle"),
f=!1,g=a.data("type"),h=a.parent(),k="desktop"===g;if(!h.hasClass("selected")){var l=ThemifyBuilderCommon.clone(a.closest(".module_row"));h.addClass("selected").siblings().removeClass("selected");if("module"===d){if("-full"!==c[0]){f=!0;var m=b.Views.init_subrow({cols:[{grid_class:"col-full"}]});var h=a.closest(".active_module"),n=h.clone();n.insertAfter(h);var p=m.view.render().$el.find(".tb_holder").prepend(h).end().insertAfter(n).find("."+a.prop("class").replace(" ",".")).closest("li").addClass("selected").siblings().removeClass("selected").end().end().end().find(".subrow_inner");
n.remove();m=p.closest(".module_subrow")}}else f="subrow"===d,m=a.closest(".module_"+d),p=m.find("."+d+"_inner").first();if(0!==p.length){if(k||"module"===d){g=p;var u=a.data("col");g=g.add(m);void 0===u&&(u=1,a.data("col",u));g.removeClass("col-count-1 col-count-"+p.attr("data-basecol")).addClass("col-count-"+u);p.attr("data-basecol",u);k&&a.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=e(this).find(".selected"),b=a.find("a"),c=b.data("type"),b=b.data("col");
void 0!==b&&(b>u||4===u&&3===b||4<=u&&4<=b&&u!=b)&&(a.removeClass("selected"),p.removeClass("tb_grid_classes col-count-"+p.attr("data-basecol")+" "+p.attr("data-col_"+c)).attr("data-col_"+c,""),e(this).closest(".tb_grid_list").find("."+c+"-auto").parent().addClass("selected"))})}else return"-auto"!==c[0]?(l="column"+c.join("-"),u=a.data("col"),3===u&&p.attr("data-basecol")>u&&(l+=" tb_3col"),p.removeClass(p.attr("data-col_tablet")+" "+p.attr("data-col_tablet_landscape")+" "+p.attr("data-col_mobile")).addClass(l+
" tb_grid_classes col-count-"+p.attr("data-basecol")).attr("data-col_"+g,l)):p.removeClass("tb_grid_classes tb_3col col-count-"+p.attr("data-basecol")+" "+p.attr("data-col_"+g)).attr("data-col_"+g,""),"visual"===b.mode&&e("body",top_iframe).height(document.body.scrollHeight),b.Utils.setCompactMode(p.children(".module_column")),!1;g=p.children(".module_column");k=c.length;d="module_column"+(f?" sub_column":"")+" col";for(m=0;m<k;++m)h=g.eq(m),0<h.length?h.removeClass(b.Utils.gridClass.join(" ")).addClass(d+
c[m]):b.Utils._addNewColumn({newclass:d+c[m],component:f?"sub-column":"column"},p[0]);k<p.children().length&&p.children(".module_column").eq(k-1).nextAll().each(function(){e(this).find(".tb_holder").first().children().appendTo(e(this).prev().find(".tb_holder").first());e(this).remove()});g=p.children();g.removeClass("first last");p.hasClass("direction-rtl")?(g.last().addClass("first"),g.first().addClass("last")):(g.first().addClass("first"),g.last().addClass("last"));f&&"-full"===c[0]&&(c=p.closest(".module_subrow"),
f=p.find(".active_module"),f.insertAfter(c),c.remove(),f.find(".tb_grid_list .grid-layout--full").parent().addClass("selected").siblings().removeClass("selected"));b.Utils.columnDrag(p,!0);m=a.closest(".module_row");b.hasChanged=!0;b.Mixins.Builder.updateModuleSort(m);b.undoManager.push(m.data("cid"),l,m,"row");Themify.body.trigger("tb_grid_changed",[m])}}},_columnAlignmentClicked:function(a){a.preventDefault();a=e(a.currentTarget);var c=a.data("handle");if("module"!==c&&!a.closest("li").hasClass("selected")){a.closest("li").addClass("selected").siblings("li").removeClass("selected");
var d=a.closest(".module_"+c);var f=a.data("alignment"),g=b.Models.Registry.lookup(d.data("cid")),h=ThemifyBuilderCommon.clone(d);d.find("."+c+"_inner").first().removeClass(g.get("column_alignment")).addClass(f);g.set({column_alignment:f},{silent:!0});b.undoManager.push(h.data("cid"),h,a.closest(".module_"+c),"row")}},_columnDirectionClicked:function(a){a.preventDefault();var c=e(a.currentTarget),d=c.data("handle");a=c.data("dir");if("module"!==d&&!c.closest("li").hasClass("selected")){c.closest("li").addClass("selected").siblings("li").removeClass("selected");
var c=c.closest(".module_"+d),d=c.find("."+d+"_inner").first(),f=d.children(".module_column"),c=f.first(),f=f.last();"rtl"===a?(c.removeClass("first").addClass("last"),f.removeClass("last").addClass("first"),d.addClass("direction-rtl")):(c.removeClass("last").addClass("first"),f.removeClass("first").addClass("last"),d.removeClass("direction-rtl"));d.attr("data-"+b.activeBreakPoint+"_dir",a)}},_gutterChange:function(a){a=e(a.currentTarget);var c=a.data("handle");if("module"!==c){var d=a.val();a.find("option").removeAttr("selected").filter('[value="'+
d+'"]').attr("selected","selected");var f=a.closest(".module_"+c),g=ThemifyBuilderCommon.clone(f),h=f.find("."+c+"_inner").first(),k=b.Models.Registry.lookup(f.data("cid"));g.find(".tb_action_wrap .gutter_select").val(f.data("gutter"));b.Utils.columnDrag(h,!1,k.get("gutter"),d);h.removeClass(k.get("gutter")).addClass(d);k.set({gutter:d},{silent:!0});b.undoManager.push(g.data("cid"),g,a.closest(".module_"+c),"row")}},setView:function(a){this.setElement(a)},_stopLightbox:function(a){a.stopPropagation()},
_updatePreviewOptions:function(){var a=e(".tb_options_row_hover .tb_row_hover__input"),c=b.Models.Registry.lookup(this.$el.data("cid")).get("styling");a.each(function(){var a=e(this),b=a.data("option"),b=c[b]||"";a.hasClass("tb_row_hover__icon")?(a.find(".selected").removeClass("selected"),a.find('[data-value="'+b+'"]').addClass("selected")):a.val(b)})},_expandOptions:function(a){a.preventDefault();a=e(a.currentTarget).parent().parent().find(".tb_option_row");a.length&&a.trigger("click")},_setPreviewOption:function(a){var c=
e(a.currentTarget),d=c.hasClass("tb_row_hover__icon")?"":c.val(),f=c.data("option"),g=this.model,h=g.get("styling"),k={};"click"===a.type&&(a=e(a.target),c.find(".selected").removeClass("selected"),a.addClass("selected"),d=a.data("value")||"");f&&h&&(k[f]=d,g.set({styling:e.extend({},h,k)},{silent:!0}),"row_anchor"===f?this.$el.find(".tb_row_anchor").text(d.replace("#","")):c.hasClass("tb_row_hover__icon")&&"visual"===b.mode&&(b.activeModel=g,b.liveStylingInstance.init(g.get("styling")),Themify.body.trigger("tb_row_"+
f.replace("row_",""),d)))}});b.Views.Builder=Backbone.View.extend({type:"default",events:{"click .tb_import_layout_button":"importLayoutButton"},initialize:function(a){_.extend(this,_.pick(a,"type"));b.vent.on("dom:builder:change",this.newRowAvailable.bind(this));b.vent.on("dom:builder:init",this.init.bind(this))},init:function(a){b.init=a;this.rowSort();"visual"===b.mode?(b.Mixins.Builder.updateModuleSort(this.$el),a&&(this.initModuleVisualDrag(".tb_module"),this.initRowGridVisualDrag()),setTimeout(function(){b.Utils._onResize(!0)},
1500)):(b.Mixins.Builder.updateModuleSort(this.$el),a&&(b.Mixins.Builder.initModuleDraggable(b.toolbar.$el,".tb_module"),b.Mixins.Builder.initModuleDraggable(b.toolbar.$el,".tb_row_grid")));var c=this;setTimeout(function(){b.Utils.setCompactMode(c.el.getElementsByClassName("module_column"))},1E3);b.vent.trigger("dom:builder:change");setTimeout(c.insertLayoutButton.bind(c),200);b.init=!0},render:function(){for(var a=document.createDocumentFragment(),c=this.collection,d=!1,f=0,g=c.length;f<g;++f){var e=
b.Views.init_row(c.models[f]);!1!==e&&(b.id&&(d=e.model.get("row_order"),void 0===d&&(d=f)),b.id&&(b.VisualCache[e.model.cid]="themify_builder_"+b.id+"_row module_row_"+d),a.appendChild(e.view.render(d,f).el))}this.el.appendChild(a);b.Utils.columnDrag(!1,!1);return this},newRowAvailable:function(){var a=this.$el.children(".module_row:last");if(0===a.length||0<a.find(".active_module").length)a=b.Views.init_row({cols:[{grid_class:"col-full"}]}).view.render().$el,this.el.appendChild(a[0]),b.Mixins.Builder.updateModuleSort(a),
"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&e("body",top_iframe).height(document.body.scrollHeight)},insertLayoutButton:function(){this.$el.find(".tb_import_layout_button").remove();2>this.$(".module_row").length&&this.el.insertAdjacentHTML("beforeend",'<a href="#" class="tb_import_layout_button'+(themifyBuilder.is_premium?"":" tb_lite")+'">'+themifyBuilder.i18n.text_import_layout_button+"</a>")},importLayoutButton:function(a){a.preventDefault();b.Views.Toolbar.prototype.loadLayout(a)}});b.Mixins.Common=
{styleData:{},doTheBinding:function(a,c,d){var f=!1,g=a.data("binding"),h="desktop"!==b.activeBreakPoint;c||void 0===g.empty?c&&void 0!==g[c]?f="radio"===a.attr("type")?a.is(":checked")?g[c]:!1:g[c]:c&&void 0!==g.not_empty?f=g.not_empty:void 0!==g.select&&c!==g.select.value?f=g.select:void 0!==g.checked&&a.is(":checked")?f=g.checked:void 0===g.not_checked||a.is(":checked")||(f=g.not_checked):f=g.empty;void 0!==g.responsive&&a.is("select")&&(c=g.responsive,h&&void 0!==c.disabled&&void 0!==this.styleData.breakpoint_desktop[a.prop("id")]&&
_.contains(c.disabled,this.styleData.breakpoint_desktop[a.prop("id")])&&(f=g[this.styleData.breakpoint_desktop[a.prop("id")]]));if(f){g=[];void 0!==f.show&&(g=f.show);void 0!==f.hide&&(g=g.concat(f.hide));if(void 0===d||0===d.length)d=e("#tb_lightbox_container",top_iframe);a=0;for(g=g.length;a<g;++a)void 0!==f.hide&&void 0!==f.hide[a]&&e("."+f.hide[a],d).addClass("_tb_hide").hide(),void 0!==f.show&&void 0!==f.show[a]&&e("."+f.show[a],d).removeClass("_tb_hide").show();if(void 0!==f.responsive)for(g=
[],void 0!==f.responsive.disabled&&(g=g.concat(f.responsive.disabled)),a=0,g=g.length;a<g;++a)void 0!==f.responsive.disabled&&void 0!==f.responsive.disabled[a]&&(h?e("."+f.responsive.disabled[a],d).addClass("reponive_disable"):e("."+f.responsive.disabled[a],d).removeClass("reponive_disable"))}},moduleOptionsBinding:function(){var a=this;e(top_iframe).on("change","#tb_lightbox_container [data-binding]",function(){a.doTheBinding(e(this),e.trim(e(this).val()),e(this).closest(".tb_repeatable_field_content"))}).on("click",
".themify-layout-icon[data-binding] a",function(){a.doTheBinding(e(this).parent(),e(this).prop("id"),e(this).closest(".tb_repeatable_field_content"))})},mode_change:function(a){function c(a){null===h&&(h=ThemifyBuilderCommon.Lightbox.$lightbox.find("#tb_options_styling")[0]);g.styleData["breakpoint_"+a]=b.Forms.serialize("tb_options_styling",g.styleData,a,!1)}function d(b,d,f){c(d);g.editComponentCallback(h,a,g.styleData,!0)}var f="module"===a&&void 0!==b.activeModel.get("is_new")?e(".tb_element_cid_"+
b.activeModel.cid).closest(".module_row"):e(".tb_element_cid_"+b.activeModel.cid);b.beforeEvent=ThemifyBuilderCommon.clone(f);var g=this,h=null;g.styleData={};g.styleData.breakpoint_desktop=e.extend(!0,{},b.activeModel.get("module"===a?"mod_settings":"styling"));for(var k in themifyBuilder.breakpoints)void 0!==g.styleData.breakpoint_desktop["breakpoint_"+k]&&(g.styleData["breakpoint_"+k]=g.styleData.breakpoint_desktop["breakpoint_"+k],g.styleData.breakpoint_desktop["breakpoint_"+k]=null);Themify.body.off("themify_builder_change_mode",
d).on("themify_builder_change_mode",d).one("themify_builder_lightbox_before_close",function(){D=[];b.saving&&c(b.activeBreakPoint);Themify.body.off("themify_builder_change_mode",d)})},editComponentCallback:function(a,c,d,f){function g(a){b.hasChanged=!0;a=0;for(var c=F.length;a<c;++a)F[a].removeEventListener("change",g);F=null}function h(a){a=e(this).val();""!=a?ThemifyBuilderCommon.isImageUrl(a)?e(this).removeClass("tb_image_field_error"):(e(this).addClass("tb_image_field_error"),alert(themifyBuilder.i18n.incorrectImageURL)):
e(this).removeClass("tb_image_field_error")}var k="styling",l=b.Mixins.Common,m=c,n=[],p=[],u=[],y=[],B=[],r=[],q=[],v=!1,t="desktop"!==b.activeBreakPoint?Object.keys(themifyBuilder.breakpoints).reverse():!1;"module"===c&&(m=b.activeModel.get("mod_name"),k="mod_settings",v=void 0!==b.activeModel.get("is_new"));if(!1!==t){for(var x=t.indexOf(b.activeBreakPoint),w=0;w<=x;++w)t.shift();t.push("desktop")}var A=function(a,c,d,g){var h="";g?h=a.getAttribute("data-input-id"):(h=a.getAttribute("name"))||
(h=a.getAttribute("id"));var k=c&&void 0!==c[h]?c[h]:!1;if(f||("px"!==k||a.classList.contains("tb_frame_unit"))&&"pixels"!==k&&"n"!==k&&"|"!==k&&"default"!==k&&"solid"!==k||a.classList.contains("themify-layout-icon")){var z=e(a),C=a.classList;if(!v&&!1!==t&&!g&&!k)if(C.contains("themify-checkbox"))void 0!==d[h]&&0===z.closest("#tb_options_styling").length&&(k=d[h]);else{g=0;for(var w=t.length;g<w;++g)if(void 0!==d["breakpoint_"+t[g]]&&void 0!==d["breakpoint_"+t[g]][h]){k=d["breakpoint_"+t[g]][h];
break}else if("desktop"===t[g]&&void 0!==d[h]){k=d[h];break}}if(C.contains("themify-gradient"))y.push({k:z,v:k}),k&&z.val(k);else if(C.contains("tb_range"))k&&z.val(k),B.push(z);else if(C.contains("tb_uploader_input"))k?(d=e("<img/>",{src:k,width:50,height:50}),z.val(k).parent().find(".img-placeholder").html(d)):f&&z.val("").parent().find(".img-placeholder").empty();else if(C.contains("themify-option-query-cat"))k&&(d=z.parent(),g=k.split("|")[0],d.find("#"+h+"_dropdown").children("option[value='"+
g+"']").prop("selected",!0),d.find(".query_category_multiple").val(g));else if(C.contains("tb_radio_input_container"))d=null,g=k?k:void 0!==z.data("default")?z.data("default"):!1,!1!==g&&""!==g?(d=z.find("input[value='"+g+"']"),d.is(":disabled")?d=null:d.prop("checked",!0)):f&&C.contains("tb_icon_radio")&&z.find("input").prop("checked",!1),null===d&&(d=z.find("input:checked")),0<d.length&&C.contains("tb_option_radio_enable")&&p.push(d);else if(C.contains("themify-checkbox")){d=z.find(".tb-checkbox");
!k&&_.isEmpty(c)&&(k=d.map(function(){return e(this).is(":checked")?e(this).val():null}).get().join("|"));if(k){var x=k.constructor===Array?k:k.split("|");d.each(function(){-1!==x.indexOf(e(this).val())&&e(this).prop("checked",!0)})}else if(!v||f)if(g=d.closest(".tb_input").find(".tb_seperate_items input"),g.length){var E=!1;g.each(function(){if(e(this).val().length)return E=!0,!1});d.prop("checked",!E)}else d.prop("checked",!1);C.contains("tb_option_checkbox_enable")&&u.push(d)}else if(C.contains("themify-layout-icon"))if(k){d=
a.getElementsByClassName("tfl-icon");g=0;for(h=d.length;g<h;++g)k===d[g].getAttribute("id")?d[g].classList.add("selected"):d[g].classList.remove("selected");d=null}else d=themifyBuilder.modules[m],void 0!==d&&void 0!==d.defaults&&d.defaults[h]?z.find("#"+d.defaults[h]).addClass("selected"):z.find("a").first().addClass("selected");else if("SELECT"===a.tagName)if(f||!C.contains("unstick_el_row_select_input")&&!C.contains("unstick_el_module_select_input"))k?("maps-pro"===m&&"w_map_unit"===h?k=c.unit_w?
c.unit_w:"px":C.contains("font-family-select")?z.data("selected",k):C.contains("font-weight-select")&&z.attr("data_value",k),z.val(k)):f&&z.find("option").prop("selected",!1),f&&C.contains("font-family-select")&&(-1===z.prop("tabindex")?z.trigger("change.select"):k&&(d=z.find("optgroup"),void 0!==ThemifyBuilderCommon.safe_fonts[k]?d.first().html('<option selected="selected" data-type="webfont" value="'+k+'">'+ThemifyBuilderCommon.safe_fonts[k]+"</option>"):d.last().html('<option selected="selected" value="'+
k+'">'+ThemifyBuilderCommon.google_fonts[k]+"</option>")));else{g=C.contains("unstick_el_module_select_input")?"module":"row";var F=[];d=b.activeModel.get("element_id");g=b.Utils.getUIDList(g);h=0;for(c=g.length;h<c;++h)g[h].element_id!==d&&(a="row"===g[h].elType?"Row #"+g[h].element_id:g[h].mod_name+" #"+g[h].element_id,"row"===g[h].elType&&g[h].styling&&g[h].styling.custom_css_id?a="#"+g[h].styling.custom_css_id:"module"===g[h].elType&&g[h].mod_settings&&g[h].mod_settings.custom_css_id&&(a="#"+
g[h].mod_settings.custom_css_id),F.push("<option "+(g[h].element_id===k?'selected="selected" ':"")+'value="'+g[h].element_id+'">'+a+"</option>"));g=null;setTimeout(function(){z[0].innerHTML=F.join("");F=null},1500)}else if("TEXTAREA"===a.tagName||"INPUT"===a.tagName){d="TEXTAREA"===a.tagName;if(k||f)f&&!k&&(k=""),z.val(k),C.contains("minicolors-input")?(g=k,h="",-1!==k.indexOf("_")?(g=b.Utils.toRGBA(k),k=k.split("_"),(h=k[1])?0>=parseFloat(h)&&(h=0):h=1,z.val(k[0])):k&&(-1===k.indexOf("#")&&(g="#"+
k),h=1),z.attr("data-opacity",h).next(".minicolors-swatch").find("span").css({background:g,opacity:h}).closest(".minicolors").next(".color_opacity").val(h)):d&&!v&&(C.contains("tb_shortcode_input")||C.contains("tb_thumbs_preview"))&&l.getShortcodePreview(z,k);d&&C.contains("tb_lb_wp_editor")&&n.push(z)}else if(C.contains("tb_row_js_wrapper")){var w=k?k.length-1:0,D=e.Event("click",{isTrigger:!0,currentTarget:z.next(".add_new").find("a").first()});void 0===b.cache.repeaterElements[h]&&(c=a.getElementsByClassName("tb_repeatable_field"),
b.cache.repeaterElements[h]=e(c[0]).clone());for(g=0;g<w;++g)b.Forms.moduleOptAddRow(D,null);c=a.getElementsByClassName("tb_repeatable_field");g=0;for(a=c.length;g<a;++g)for(var w=c[g].getElementsByClassName("tb_lb_option_child"),D=void 0!==k[g]?k[g]:!1,h=0,G=w.length;h<G;++h)A(w[h],D,d,!0);r.push({el:z,binding_type:z.data("control-binding")})}z.data("binding")?q.push({el:z,v:k}):C.contains("themify-checkbox")&&z.find(".tb-checkbox").data("binding")&&q.push({el:z.find(".tb-checkbox"),v:k});f||!z.data("control-binding")||
C.contains("tb_lb_wp_editor")||C.contains("minicolors-input")||C.contains("themify-gradient")||"repeater"===z.data("control-type")||b.Views.init_control(z.data("control-type"),{el:z,binding_type:z.data("control-binding"),selector:z.data("live-selector")})}};d=f?d:b.activeModel.get(k);var E=e.extend(!0,{},d);if("desktop"!==b.activeBreakPoint||f)if(void 0!==E["breakpoint_"+b.activeBreakPoint])E=E["breakpoint_"+b.activeBreakPoint];else for(w=0,k=t.length;w<k;++w)if(void 0!==E["breakpoint_"+t[w]]){E=
E["breakpoint_"+t[w]];break}e(a.querySelectorAll('.tb_uploader_input:not(#background_video):not([data-control-type="audio"])')).on("focus",function(a){if(void 0!==a.originalEvent)e(this).one("blur",h)}).on("change paste keyup",function(){e(this).removeClass("tb_image_field_error")});for(var F=a.getElementsByClassName("tb_lb_option"),w=0,k=F.length;w<k;++w)A(F[w],E,d,!1),f||F[w].addEventListener("change",g,{once:!0});f&&(F=null);setTimeout(function(){for(var a=0,b=p.length;a<b;++a)ThemifyBuilderCommon.Lightbox.clickRadioOption(null,
p[a]);p=null;a=0;for(b=u.length;a<b;++a)ThemifyBuilderCommon.Lightbox.clickCheckboxOption(null,u[a]);u=null},1);f||(0<r.length&&setTimeout(function(){for(var a=0,c=r.length;a<c;++a)b.Views.init_control("repeater",r[a]);r=null},200),setTimeout(function(){q=q.reverse();for(var a=0,b=q.length;a<b;++a)l.doTheBinding(q[a].el,q[a].v);q=null},1),setTimeout(function(){for(var a=0,c=B.length;a<c;++a)b.Utils.createRange(B[a]);B=null},100));setTimeout(function(){l.applyAll_init(f);for(var b=a.getElementsByClassName("border_style"),
c=0,d=b.length;c<d;++c)ThemifyBuilderCommon.Lightbox.hideShowBorder(null,e(b[c]))},10);void 0!==e.fn.ThemifyGradient&&setTimeout(function(){for(var a=0,c=y.length;a<c;++a)b.Utils.createGradientPicker(y[a].k,y[a].v,f);y=null},400);f||(setTimeout(function(){ThemifyBuilderCommon.fontPreview(ThemifyBuilderCommon.Lightbox.$lightbox.find("#tb_lightbox_container"))},300),v&&"gallery"===m&&setTimeout(function(){e(".tb_gallery_btn",a).trigger("click")},1),setTimeout(function(){b.Utils.builderPlupload("normal")},
120),setTimeout(function(){b.Utils.setColorPicker(a)},1),"module"!==c?setTimeout(function(){b.Utils.setImageSelect(a)},800):setTimeout(function(){b.Utils.datePicker(a)},100),"visual"===b.mode&&(setTimeout(function(){D="module"===c?b.Forms.serialize("tb_options_setting"):E;b.liveStylingInstance.init(D)},1),v||ThemifyBuilderCommon.Lightbox.rememberRow()),setTimeout(function(){if(0<n.length){var a=function(){for(var a=0,c=n.length;a<c;++a)b.Views.init_control("wp_editor",{el:n[a],binding_type:n[a].data("control-binding"),
selector:n[a].data("live-selector")});n=null};if(b.activeModel.get("styleClicked")||b.activeModel.get("visibileClicked"))Themify.body.on("themify_builder_tabsactive",function H(b,c,d){"#tb_options_setting"===c&&(a(),Themify.body.off("themify_builder_tabsactive",H))});else a()}l.mode_change(c)},1),Themify.body.trigger("editing_"+c+"_option",[m,E,a]),"visual"===b.mode&&window.top.jQuery("body").trigger("editing_"+c+"_option",[m,E,a]))},applyAll_init:function(a){var b=e(".style_apply_all",top_iframe);
b.off("change.tb_apply_all").on("change.tb_apply_all",function(a){var b;e(this).parent().css("display","inline-block");var c=e(this).closest(".tb_input").find(".tb_seperate_items"),d=c.find("li");a=!a.isTrigger;var k=e(this).hasClass("tb_has_radio_options")?!0:!1;k&&(b=e(this).siblings("input:radio"));e(this).is(":checked")?(k&&b.addClass("_tb_disable"),d.not(":first-child").hide(),d.first().find("span.tb_tooltip_up").hide(),d.first().find("span.tb_range_after").hide(),c.attr("data-checked",1)):(k&&
b.removeClass("_tb_disable"),d.show(),d.first().find("span.tb_range_after").show(),d.first().find("span.tb_tooltip_up").show(),c.removeAttr("data-checked"),k&&d.first().find("select").trigger("change"));a&&d.first().find("select").trigger("change")});b.each(function(){e(this).parent().css("display","inline-block");if(e(this).hasClass("tb_has_radio_options")){var a=this;e(this).siblings("input:radio").on("click",function(b){e(a).trigger("change.tb_apply_all")})}});a||(b=b.filter(":checked"));b.trigger("change.tb_apply_all")},
getShortcodePreview:function(a,b){function c(b){a.next(".tb_shortcode_preview").remove();b&&a.after(b)}var f=this;void 0===f.galerry_cache&&(f.galerry_cache={});void 0!==f.galerry_cache[b]?c(f.galerry_cache[b]):e.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_load_shortcode_preview",tb_load_nonce:themifyBuilder.tb_load_nonce,shortcode:b},success:function(a){c(a);f.galerry_cache[b]=a}})}};b.Mixins.Builder={before:null,zindex:null,r:null,w:null,h:null,type:null,moduleHolderArgs:null,
subrows:null,update:function(a){var c=null!==b.activeModel?b.activeModel.get("elType"):b.Models.Registry.lookup(a.data("cid")).get("elType");"visual"===b.mode&&b.Utils.loadContentJs(a,c);a=a.closest(".module_row");b.Utils.columnDrag(a.find(".row_inner"),!1);b.Utils.columnDrag(a.find(".subrow_inner"),!1);b.Mixins.Builder.updateModuleSort(a)},dragScroll:function(a,c){function d(a){a=e(this).prop("id");a=("tb_toolbar"===a||"wpadminbar"===a?"-":"+")+("="+m+"px");g.stop().animate({scrollTop:a},800)}var f=
e("body",top_iframe);"visual"===b.mode&&(f=f.add(Themify.body));void 0===this.top&&(this.top=b.toolbar.$el,this.top=this.top.add(e("#tb_fixed_bottom_scroll",top_iframe)),"visual"!==b.mode&&(this.top=this.top.add("#wpadminbar")));if(!0===c)this.top.off("mouseenter"),"row"===a&&"visual"===b.mode&&b.toolbar.$el.find('.tb_zoom[data-zoom="100"]').trigger("click"),f.removeClass("tb_drag_start tb_drag_"+a);else{var g="desktop"===b.activeBreakPoint?e("body,html"):e("body,html",top_iframe),h=0;if("visual"===
b.mode){var k=g.height();h=e(window.top).height()}else k=e("#page-builder").height();var l=k-h,m=(k-h)*(1E4<l?2:5E3<l?5:10)/100;f.addClass("tb_drag_start tb_drag_"+a);"row"===a&&"visual"===b.mode&&b.toolbar.$el.find('.tb_zoom[data-zoom="50"]').trigger("click");if(0<m)this.top.off("mouseenter").on("mouseenter",d)}},rowSort:function(){var a=this,c,d={items:">.module_row",handle:".tb_row_actions>.tb_grid_icon",axis:"y",placeholder:"tb_state_highlight",containment:"parent",tolerance:"pointer",forceHelperSize:!0,
forcePlaceholderSize:!0,scroll:!1,beforeStart:function(b,d,e){a.before||(c=!0,a.before=e.item.next(".module_row"),0===a.before.length&&(a.before=e.item.prev(".module_row"),c=!1),a.before=a.before.data("cid"),a.dragScroll("row"))},stop:function(b,d){a.before=c=null;a.dragScroll("row",!0)},update:function(d,g){if("visual"===b.mode&&!g.item.hasClass("tb_row_grid")){var f="desktop"===b.activeBreakPoint?e("html,body"):e("body",top_iframe);f.scrollTop(g.item.offset().top);f=null}if("sortupdate"===d.type&&
a.before){b.hasChanged=!0;var f=g.item.next(".module_row"),k=!0;0===f.length&&(f=g.item.prev(".module_row"),c=k=!1);f=f.data("cid");b.undoManager.push(g.item.data("cid"),null,null,"row_sort",{bnext:c,before:a.before,anext:k,after:f})}else g.item.hasClass("predesigned_row")||g.item.hasClass("tb_page_break_module")||"row"===g.item.data("type")?"row"===g.item.data("type")?b.toolbar.libraryItems.get(g.item.data("id"),"row",function(b){Array.isArray(b)||(b=Array(b));a.rowDrop(b,g.item)}):g.item.hasClass("tb_page_break_module")?
b.toolbar.pageBreakModule.get(function(b){a.rowDrop(b,g.item)}):b.toolbar.preDesignedRows.get(g.item.data("slug"),function(b){a.rowDrop(b,g.item)}):g.item.hasClass("tb_row_grid")&&a.subRowDrop(g.item.data("slug"),g.item);b.toolbar.pageBreakModule.countModules()}};"visual"===b.mode&&(d.helper=function(){return e('<div class="tb_sortable_helper"/>')});this.$el.sortable(d)},columnSort:function(a){var c,d;a.find(".row_inner, .subrow_inner").sortable({items:"> .module_column",handle:"> .tb_column_action .tb_column_dragger",
axis:"x",placeholder:"tb_state_highlight",tolerance:"pointer",cursorAt:{top:20,left:20},beforeStart:function(a,b,e){Themify.body.addClass("tb_drag_start");c=ThemifyBuilderCommon.clone(e.item.closest(".module_row"));d=e.item.siblings();d.css("marginLeft",0)},start:function(a,b){e(".tb_state_highlight").width(b.item.width())},stop:function(a,b){Themify.body.removeClass("tb_drag_start");d.css("marginLeft","")},update:function(a,d){var f=d.item.closest(".ui-sortable"),g=f.children(".module_column");g.removeClass("first last");
f.hasClass("direction-rtl")?(g.last().addClass("first"),g.first().addClass("last")):(g.first().addClass("first"),g.last().addClass("last"));b.Utils.columnDrag(f,!1);b.Utils.setCompactMode(g);f=f.closest(".module_row");b.undoManager.push(f.data("cid"),c,f,"row")}})},updateModuleSort:function(a,c){var d=e(".tb_holder",a);if(c)return d.sortable(c),!1;d.each(function(){e(this).data({uiSortable:null,sortable:null})});var f=this,g=null,h,k;this.moduleHolderArgs={placeholder:"tb_state_highlight",items:".active_module,>div>.active_module",
connectWith:".module_row:not(.tb-page-break) .tb_holder",revert:100,scroll:!1,cancel:".tb_disable_sorting",cursorAt:{top:10,left:90},sort:function(a,b){null===g&&(g=this.classList.contains("active_module")?this.children:e(this).find(e(this).sortable("option").items).get(),k=e(this).children(".tb_state_highlight:first"),h=b.helper.outerHeight());for(var c=b.position.top,d=c+h,m=0,l=g.length;m<l;++m)if(!g[m].classList.contains("tb_sortable_helper")&&!g[m].classList.contains("tb_state_highlight")){var B=
e(g[m]);var r=B.outerHeight();var q=B.position().top;var v=q+r;if(c>q&&c<v){if(r=Math.min(f.helpHeight,r)/2,v=c-q,v<r){k.insertBefore(B);e(this).sortable("refreshPositions");break}}else if(d<v&&d>q&&(r=Math.min(f.helpHeight,r)/2,v-=d,v<r)){k.insertAfter(B);e(this).sortable("refreshPositions");break}}},beforeStart:function(a,b,c){if(!f.before&&(f.r=c.item.closest(".module_row"),0<f.r.length?(f.before=ThemifyBuilderCommon.clone(f.r),f.zindex=f.r.css("zIndex"),"auto"===f.zindex&&(f.zindex=""),f.r.css("zIndex",
2)):f.r=null,f.w=c.item[0].style.width,f.h=c.item[0].style.height,c.item.css({width:180,height:30}),f.type="module",f.subrows=null,c.item[0].classList.contains("module_subrow")?(f.type+=" tb_drag_subrow",f.subrows=!0):c.item[0].classList.contains("tb_row_grid")&&(f.type="column",f.subrows=!0),f.dragScroll(f.type),!0===f.subrows)){f.subrows=[];a=[];c=0;for(var d=b.items.length;c<d;++c)b.items[c].instance.element[0].classList.contains("tb_subrow_holder")?(f.subrows.push(b.items[c].instance.element),
b.items[c].instance.destroy()):a.push(b.items[c]);b.items=a;a=[];c=0;for(d=b.containers.length;c<d;++c)b.containers[c].element[0].classList.contains("tb_subrow_holder")?(f.subrows.push(b.containers[c].element),b.containers[c].destroy()):a.push(b.containers[c]);b.containers=a}},stop:function(a,c){"visual"===b.mode&&c.helper&&e(c.helper).remove();c.item.css({width:f.w,height:f.h});f.dragScroll(f.type,!0);f.r&&f.r.css("zIndex",f.zindex);f.before=f.w=f.h=g=k=f.r=f.zindex=h=f.type=null;if(f.subrows)for(var d=
0,m=f.subrows.length;d<m;++d)f.subrows[d][0].classList.contains("ui-sortable")||f.subrows[d].sortable(f.moduleHolderArgs);f.subrows=null},update:function(a,c){c.item.css({width:f.w,height:f.h});if(c.item.hasClass("tb_module_dragging_helper")){D=[];var g=e(c.item.clone(!1));if(c.item.data("id")){var h=c.item.closest(".module_row");0<h.length&&(f.before=ThemifyBuilderCommon.clone(h),f.before.find(".tb_module_dragging_helper").remove())}c.item.after(g);f.moduleDrop(g,null,f.before)}else{if(c.sender&&
(g=c.sender.closest(".module_row"),c.sender.closest(".module_row").toggleClass("tb_row_empty",0===g.find(".active_module").length),g=c.sender.closest(".module_subrow"),0<g.length&&g.toggleClass("tb_row_empty",0===g.find(".active_module").length),c.item.hasClass("module_subrow")&&0<c.item.parent().closest(".module_subrow").length)){d.sortable("cancel");return}f.before&&(b.hasChanged=!0,c.item.hasClass("module_subrow")||c.item.closest(".module_subrow").removeClass("tb_row_empty"),g=c.item.closest(".module_row"),
g.removeClass("tb_row_empty"),b.undoManager.push(c.item.data("cid"),f.before,g,"sort",{before:f.before.data("cid"),after:g.data("cid")}),f.before=null,b.vent.trigger("dom:builder:change"),Themify.body.trigger("tb_"+f.type+"_sort",[c.item]))}}};"visual"===b.mode&&(this.moduleHolderArgs.helper=function(){return e('<div class="tb_sortable_helper"/>')});d.sortable(this.moduleHolderArgs)},initModuleDraggable:function(a,c){var d=this,f=e.extend(!0,{},this.moduleHolderArgs);f.update=!1;f.appendTo=document.body;
f.items=c;".tb_row_grid"===c&&(f.connectWith=[f.connectWith,"visual"===b.mode?"#themify_builder_content-"+themifyBuilder.post_ID:"#tb_row_wrapper"]);f.stop=function(a,b){e(this).sortable("cancel");b.item.removeClass("tb_sortable_helper tb_module_dragging_helper");d.moduleHolderArgs.stop(a,b)};f.start=function(a,b){b.item.addClass("tb_sortable_helper tb_module_dragging_helper")};f.helper=function(a,b){return e('<div class="tb_sortable_helper tb_module_dragging_helper">'+b.text()+"</div>")};a.sortable(f)},
initRowDraggable:function(a,c){var d=this;a.find(c).draggable({appendTo:Themify.body,helper:"clone",revert:"invalid",connectToSortable:"visual"===b.mode?"#themify_builder_content-"+themifyBuilder.post_ID:"#tb_row_wrapper",cursorAt:{top:10,left:40},start:function(a,b){d.dragScroll("row");b.helper.addClass("tb_module_dragging_helper tb_sortable_helper").find(".tb_predesigned_rows_list_image").remove()},stop:function(a,b){d.dragScroll("row",!0)}})},initModuleVisualDrag:function(a){var c=this;b.toolbar.$el.find(a).ThemifyDraggable({iframe:"#tb_iframe",
dropitems:".tb_holder",elements:".active_module",type:"module",onDrop:function(a,b,g){c.moduleDrop(b,!1,ThemifyBuilderCommon.clone(g.closest(".module_row")))}})},initRowGridVisualDrag:function(){var a=this;b.toolbar.$el.find(".tb_row_grid").ThemifyDraggable({iframe:"#tb_iframe",dropitems:".tb_holder:not('.tb_subrow_holder'),.themify_builder_content:not('.not_editable_builder')>.module_row",elements:".active_module",cancel:".tb_subrow_holder",append:!1,type:"column",onDrop:function(b,d,f){a.subRowDrop(d.data("slug"),
d)}})},initRowVisualDrag:function(a){var c=this;b.toolbar.$el.find(a).ThemifyDraggable({iframe:"#tb_iframe",dropitems:".themify_builder_content:not('.not_editable_builder')>.module_row",append:!1,type:"row",onDrop:function(a,f,g){f.addClass("tb_state_highlight").find(".tb_predesigned_rows_list_image").remove();f.show();a="desktop"===b.activeBreakPoint?e("html,body"):e("body",top_iframe);a.scrollTop(f.offset().top-e("#headerwrap.fixed-header").outerHeight());a=null;"row"===f.data("type")?b.toolbar.libraryItems.get(f.data("id"),
"row",function(a){Array.isArray(a)||(a=Array(a));c.rowDrop(a,f)}):f.hasClass("tb_page_break_module")?b.toolbar.pageBreakModule.get(function(a){c.rowDrop(a,f)}):b.toolbar.preDesignedRows.get(f.data("slug"),function(a){c.rowDrop(a,f)})}})},subRowDrop:function(a,c){var d=0<c.parent(".themify_builder_content,#tb_row_wrapper").length;if(d||0===c.closest(".sub_column").length){a=b.Utils.grid(a);if(!d){var f=ThemifyBuilderCommon.clone(c.closest(".module_row"));f.find(".tb_row_grid").remove();var g="row"}var e=
(d?b.Views.init_row({cols:a[0].cols}):b.Views.init_subrow({cols:a[0].cols})).view.render().$el;if(d||0<c.parent(".tb_holder").length)c[0].parentNode.replaceChild(e[0],c[0]);else{var k=c.next(".tb_holder");0<k.length?k.prepend(e):(k=c.prev(".tb_holder"),k.append(e))}if(d){f=e.next(".module_row");var l=!0;0===f.length&&(l=!1,f=e.prev(".module_row"));f=f.data("cid");g="grid_sort"}e.find(".tb_grid_"+b.activeBreakPoint+' .tb_grid_list [data-col="'+a[0].cols.length+'"]').first().parent().addClass("selected");
b.Utils.setCompactMode(e[0].getElementsByClassName("module_column"));b.Mixins.Builder.update(e);c.remove();b.hasChanged=!0;e=e.closest(".module_row");d||e.removeClass("tb_row_empty");e.find(".tb_row_grid").remove();b.undoManager.push(e.data("cid"),f,e,g,{next:l})}else c.remove()},rowDrop:function(a,c){function d(){var a=c.prev(".module_row");if(0===a.length){var d="visual"===b.mode?c.closest(".themify_builder_content").data("postid"):null;a=!1}else a=a.data("cid");c[0].innerHTML="";c[0].parentNode.replaceChild(g,
c[0]);b.hasChanged=!0;b.undoManager.push("","","","predesign",{prev:a,rows:e,bid:d});a=0;for(d=e.length;a<d;++a){var f=e[a].find(".module_column");e[a].find('ul.tb_grid_list li a[data-col="'+f.length+'"]').first().parent().addClass("selected");b.Utils.setCompactMode(f);b.Mixins.Builder.update(e[a])}ThemifyBuilderCommon.showLoader("hide")}for(var f=function(a){for(var b in a)if(a[b].styling&&0<Object.keys(a[b].styling).length||a[b].modules&&0<Object.keys(a[b].modules).length)return!0;return!1},g=document.createDocumentFragment(),
e=[],k=[],l=0,m=a.length;l<m;++l)if(a[l].styling&&0<Object.keys(a[l].styling).length||a[l].cols&&f(a[l].cols)){var n=b.Views.init_row(a[l]);if(!1!==n){n=n.view.render();g.appendChild(n.el);if("visual"===b.mode){var p=n.el.querySelectorAll("[data-cid]");k[n.el.dataset.cid]=1;l=0;for(m=p.length;l<m;++l)k[p[l].dataset.cid]=1}e.push(n.$el)}}"visual"===b.mode?(b.bootstrap(k,d),k=null):d()},moduleDrop:function(a,c,d){function f(f){function g(f){k||l.model.set({is_new:1},{silent:!0});f=!0===f?l.model.getPreviewSettings():
l.model.get("mod_settings");c?c.append(p.el):a.replaceWith(p.el);k?b.activeModel=l.model:l.view.trigger("edit",null);b.hasChanged=!0;if("visual"===b.mode&&1<Object.keys(f).length)if("part"===h||"ajax"===a.data("type")){var g=!0;l.model.trigger("custom:preview:refresh",f)}else"module"!==h&&l.model.trigger("custom:preview:live",f);if(k){if(g){var m=l.view.$el.find(".tb_preview_component").detach();setTimeout(function(){l.view.$el.prepend(m)},50)}d&&(g=p.$el.closest(".module_row"),g.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),
p.$el.closest(".module_subrow").removeClass("tb_row_empty"),b.undoManager.push(g.data("cid"),d,g,"row"),b.vent.trigger("dom:builder:change"),e(".tb_import_layout_button").remove())}}var l=b.Views.init_module(f),p=l.view.render();"visual"===b.mode&&k?(f=[],f[l.model.cid]=1,b.bootstrap(f,g)):g(!0)}if(a[0].classList.contains("tb_row_grid"))this.subRowDrop(a.data("slug"),a);else{var g={mod_name:a.data("module-slug")},h=a.data("type"),k="part"===h||"module"===h;k?b.toolbar.libraryItems.get(a.data("id"),
h,f):f(g);"visual"!==b.mode&&e(".themify-wp-editor-holder:not(.themify-active-holder)").length&&e(".themify-wp-editor-holder").addClass("themify-active-holder")}},toJSON:function(){for(var a={},c=this.el.getElementsByClassName("module_row"),d=0,f=0,g=c.length;f<g;++f){var e=b.Utils._getRowSettings(c[f],f);0<Object.keys(e).length&&(a[d]=e,++d)}return a}};b.Forms={Data:{},Validators:{},bindEvents:function(){var a="true"===themifyBuilder.isTouch?"touchend":"click";e("body",top_iframe).on(a,".builder_save_button",
this.saveComponent).on(a,"#tb_lightbox_parent .add_new a",this.moduleOptAddRow).on(a,"#tb_submit_import_form",this.builderImportSubmit).on(a,".tb_lightbox_switcher a",this.lightbox_switcher).on(a,".layout_preview img",this.templateSelected).on(a,"#builder_submit_layout_form",this.saveAsLayout).on(a,"#builder_submit_library_item_form",this.saveAsLibraryItem).on("keypress","#tb_library_item_form input",this.saveAsLibraryItem).on("keyup","#row_anchor",this.rowAnchor);Themify.body.on("themify_builder_lightbox_close",
this.clear).on(a,".tb_module_front a",this.disable_links);b.Mixins.Common.moduleOptionsBinding()},parseSettings:function(a,b,d,f){var c=!1,h=e(a),k=a.classList,l="",m=!0;f?l=h.data("input-id"):(l=a.getAttribute("name"))||(l=a.getAttribute("id"));if(k.contains("tb_lb_wp_editor"))void 0!==tinyMCE?(c=a.getAttribute("id"),a=tinyMCE.get(c),c=null!==a?!1===a.hidden?a.getContent():switchEditors.wpautop(tinymce.DOM.get(c).value):h.val()):c=h.val();else if(k.contains("themify-checkbox")){var n=[];h.find(".tb-checkbox:checked").each(function(a){n.push(e(this).val())});
c=0<n.length?n.join("|"):!1;n=null;m=!1}else if(k.contains("themify-layout-icon"))c=h.find(".selected").prop("id"),m=!k.contains("tb_frame");else if(k.contains("themify-option-query-cat"))a=h.parent(),c=a.find(".query_category_single"),a=a.find(".query_category_multiple"),c=a.val()?a.val()+"|multiple":c.val()+"|single";else if(k.contains("tb_row_js_wrapper")){c=[];a=a.getElementsByClassName("tb_repeatable_field_content");f=0;for(var p=a.length;f<p;++f){var u=a[f].getElementsByClassName("tb_lb_option_child");
c[f]={};for(var y=0,B=u.length;y<B;++y){var r=this.parseSettings(u[y],b,d,!0);r&&"px"!==r.v&&"n"!==r.v&&"pixels"!==r.v&&"solid"!==r.v&&"default"!==r.v&&"|"!==r.v&&(c[f][r.id]=r.v)}}}else k.contains("tb_radio_input_container")?(m=h.find("input:checked"),"desktop"!==d&&m.hasClass("reponive_disable")||(c=m.val()),m=!1):k.contains("module-widget-form-container")?c=h.find(":input").themifySerializeObject():k.contains("tb_widget_select")?c=h.find(".selected").data("value"):(c=h.val(),""!==c?(m=h.attr("data-opacity"),
void 0!==m&&""!==m&&1!=m&&"0.99"!=m&&(c+="_"+m),m=!k.contains("tb_frame")&&!k.contains("border_color")&&!k.contains("border_width")):c=!1);if(c||!b)if(!b||"px"!==c&&"pixels"!==c&&"n"!==c&&"solid"!==c&&"linear"!==c&&"default"!==c&&"|"!==c&&("desktop"===d||0===h.closest(".reponive_disable").length)||"%"!==c&&k.contains("tb_frame_unit")){if(!b&&!1===c)c="";else if("%"===c&&k.contains("tb_frame_unit"))return!1;return{id:l,v:c,checked:m}}return!1},serialize:function(a,c,d){d=d||b.activeBreakPoint;var f=
void 0!==c;void 0===this.breakpoints&&"desktop"!==d&&f&&(this.breakpoints=Object.keys(themifyBuilder.breakpoints).reverse());var g={};a=top_iframe.getElementById(a).getElementsByClassName("tb_lb_option");var e="desktop"!==d&&f&&void 0!==this.breakpoints?this.breakpoints:!1;if(!1!==e){for(var k=e.indexOf(d),l=0;l<=k;++l)e.shift();e.push("desktop")}l=0;for(k=a.length;l<k;++l){var m=this.parseSettings(a[l],f,d,!1);if(!1!==m){if(!1!==e&&!0===m.checked&&"SELECT"!==a[l].tagName){for(var n=!1,p=0,u=e.length;p<
u;++p)if(void 0!==c["breakpoint_"+e[p]]&&void 0!==c["breakpoint_"+e[p]][m.id]&&c["breakpoint_"+e[p]][m.id]===m.v){n=!0;break}else if("desktop"===e[p]&&void 0!==c[m.id]&&c[m.id]===m.v){n=!0;break}if(n)continue}g[m.id]=m.v}}return g},saveComponent:function(a){var c=null===a;c||a.preventDefault();if(b.hasChanged){var d=b.Forms,f=b.activeModel.get("elType");a="module"===f;if(!a||d.isValidate(e("#tb_module_settings",top_iframe))){Themify.body.trigger("themify_builder_save_component");"visual"===b.mode&&
window.top.jQuery("body").trigger("themify_builder_save_component");b.saving=!0;var g={},h=null,k=!1,l=!1,m=null,n=null,p="styling",u=e(".tb_element_cid_"+b.activeModel.cid);if(a||"row"===f||"subrow"===f)a&&(p="mod_settings",k=b.activeModel.get("is_new"),b.activeModel.unset("is_new",{silent:!0})),"subrow"!==f&&(n=d.serialize("tb_options_setting")),h=d.serialize("tb_options_animation");if(a||"row"===f||"subrow"===f)m=d.serialize("tb_options_visibility"),"visual"===b.mode&&("hide_all"===m.visibility_all||
"hide"===m.visibility_desktop||"hide"===m.visibility_tablet||"hide"===m.visibility_mobile?u.addClass("tb_visibility_hidden"):u.removeClass("tb_visibility_hidden"));"visual"===b.mode&&b.liveStylingInstance.remember(b.activeModel.cid);c?Themify.body.trigger("themify_builder_lightbox_before_close"):ThemifyBuilderCommon.Lightbox.close(c);d=e.extend(!0,{},b.Mixins.Common.styleData);f=d.breakpoint_desktop;d.breakpoint_desktop=null;for(var y in d)f[y]=d[y];g[p]=e.extend(!0,f,n,h,m);g[p]=b.Utils.clear(g[p]);
y=b.activeModel.get(p);b.activeModel.set(g,{silent:!0});a&&(k&&(l=u.closest(".module_column"),l.closest(".module_row").removeClass("tb_row_empty"),l.closest(".module_subrow").removeClass("tb_row_empty"),l=ThemifyBuilderCommon.clone(l)),b.vent.trigger("dom:builder:change"),e(".tb_import_layout_button").remove());if("visual"===b.mode){var B=b.liveStylingInstance.undoData;var r=e.extend(!0,{},b.liveStylingInstance.getRememberedStyles())}b.undoManager.push(b.activeModel.cid,b.beforeEvent,u,"save",{bsettings:y,
asettings:g[p],bstyles:B,astyles:r,column:l});b.beforeEvent=!1;b.saving=!1;c&&ThemifyBuilderCommon.Lightbox.close(c)}}else ThemifyBuilderCommon.Lightbox.close(c)},moduleOptAddRow:function(a,c){function d(a){a=e(this).val();""!=a?ThemifyBuilderCommon.isImageUrl(a)?e(this).removeClass("tb_image_field_error"):(e(this).addClass("tb_image_field_error"),alert(themifyBuilder.i18n.incorrectImageURL)):e(this).removeClass("tb_image_field_error")}a.preventDefault();var f=e(a.currentTarget).parent().prev(),g=
b.cache.repeaterElements[f.prop("id")].clone(),h=Math.random().toString(36).substr(2,7),k=[],l=!1,m=!1,n=[],p=!a.isTrigger||c;g.removeClass("collapsed").find(".row_inner").show();var u=g[0].getElementsByClassName("tb_lb_option_child");c=c?e(c):!1;for(var y=0,B=u.length;y<B;++y){var r=e(u[y]);var q=c?c.find('[data-input-id="'+r.data("input-id")+'"]'):!1;var v=u[y].classList;if(v.contains("tb_lb_wp_editor")){var t=r.data("input-id");var x=r.data("control-repeater");var w=r.closest(".wp-editor-wrap");
r=t+"_"+y+"_"+Math.random().toString(36).substr(2,7);!1===l&&(l=w[0].innerHTML);w[0].innerHTML=l.replace(new RegExp(t,"g"),r);r=w.find(".tb_lb_wp_editor");r.attr({name:t,"data-input-id":t,"data-control-repeater":x}).data({"input-id":t,"control-repeater":x});q?(q=q.prop("id"),q=(w=tinyMCE.get(q))&&!1===w.hidden?w.getContent():switchEditors.wpautop(tinymce.DOM.get(q).value),r.val(q)):r.val("");k.push(r)}else if(v.contains("themify-layout-icon"))w=r.find("a"),w.removeClass("selected"),q?w.filter("#"+
q.find(".selected").prop("id")).addClass("selected"):(q=themifyBuilder.modules[b.activeModel.get("mod_name")],void 0!==q&&void 0!==q.defaults&&q.defaults[t]?w.filter("#"+q.defaults[t]).addClass("selected"):w.first().addClass("selected"));else if(v.contains("tb_uploader_input"))p&&(m=!0,q=!1!==q?q.val():"",w=r.val(q).parent(),x=w.find(".thumb_preview").find(".img-placeholder"),w.find(".tb_upload_btn").prop("id","pluploader_"+h+"_"+y+"tb_plupload_upload_ui").addClass("plupload-clone").find(".builder_button").prop("id",
"pluploader_"+h+"_"+y+"tb_plupload_browse_button"),""!==q&&(q=e("<img/>",{src:q,width:50,height:50}),x.html(q)));else if(v.contains("tb_radio_input_container")){w=u[y].getElementsByClassName("tb_radio_dnd");x=r.data("input-id");var A=q?q.find(":checked").val():!1;q=0;for(var E=w.length;q<E;++q){var F=e(w[q]);F.prop({name:x+"_"+h,id:x+"_"+h+"_"+q,checked:!1}).next("label").prop("for",x+"_"+h+"_"+q);(A===F.val()||!A&&F.data("checked"))&&F.prop("checked",!0)}v.contains("tb_option_radio_enable")&&ThemifyBuilderCommon.Lightbox.clickRadioOption(null,
r.find(":checked"))}else A=q?q.val():"",void 0===A&&(A=""),r.val(A),p&&(v.contains("tb_range")?n.push(r):q&&v.contains("minicolors-input")&&(w=q.closest(".minicolors_wrapper"),x=w.find(".minicolors-swatch-color"),E=r.closest(".minicolors_wrapper"),q=q.data("opacity"),E.find(".minicolors-swatch-color").css({"background-color":x.css("background-color"),opacity:q}),E.find(".color_opacity").val(w.find(".color_opacity").val()),r.data("opacity",q).attr("data-opacity",q),x=E=q=w=null));p&&(r.data("binding")&&
b.Mixins.Common.doTheBinding(r,A,g),!r.data("control-binding")||v.contains("tb_lb_wp_editor")||v.contains("minicolors-input")||v.contains("themify-gradient")||b.Views.init_control(r.data("control-type"),{el:r,binding_type:r.data("control-binding"),selector:r.data("live-selector")}))}e(g[0].querySelectorAll('.tb_uploader_input:not([data-control-type="audio"])')).on("focus",function(a){e(this).removeClass("tb_image_field_error");if(void 0!==a.originalEvent)e(this).one("blur",d)});p&&setTimeout(function(){b.Utils.setColorPicker(g)},
1);f[0].appendChild(g[0]);p&&(0<k.length&&setTimeout(function(){for(var a=0,c=k.length;a<c;++a)b.Views.init_control("wp_editor",{el:k[a],binding_type:k[a].data("control-binding"),selector:k[a].data("live-selector")});k=null},1),0<n.length&&setTimeout(function(){for(var a=0,c=n.length;a<c;++a)b.Utils.createRange(n[a]);n=null},200),m&&b.Utils.builderPlupload("new_elemn"))},builderImportSubmit:function(a){a.preventDefault();var c=e(this);ThemifyBuilderCommon.LiteLightbox.confirm(themifyBuilder.i18n.dialog_import_page_post,
function(a){e.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"builder_import_submit",nonce:themifyBuilder.tb_load_nonce,data:c.closest("form").serialize(),importType:"no"===a?"replace":"append",importTo:themifyBuilder.post_ID},beforeSend:function(a){ThemifyBuilderCommon.showLoader("show")},success:function(a){b.Forms.reLoad(a,themifyBuilder.post_ID);ThemifyBuilderCommon.Lightbox.close()}})},{buttons:{no:{label:"Replace Existing Builder"},yes:{label:"Append Existing Builder"}}})},
lightbox_switcher:function(a){a.preventDefault();a=e(a.currentTarget).attr("href").replace("#","");a!==b.activeBreakPoint&&(b.activeModel&&"visual"===b.mode&&(b.scrollTo=b.liveStylingInstance.$liveStyledElmt),e(".tb_breakpoint_switcher.breakpoint-"+a,top_iframe).trigger("click"))},disable_links:function(a){a.preventDefault()},rowAnchor:function(){if("visual"===b.mode){var a=b.liveStylingInstance;var c=a.getStylingVal("row_anchor");a.$liveStyledElmt.removeClass(a.getRowAnchorClass(c))}c=e.trim(e(this).val());
"visual"===b.mode?(a.setStylingVal("row_anchor",c),""!==c&&a.$liveStyledElmt.addClass(a.getRowAnchorClass(c)),a=a.$liveStyledElmt,a.data("anchor",c).attr("data-anchor",c)):a=e(".tb_element_cid_"+b.activeModel.cid);a.children(".tb_row_actions").find(".tb_row_anchor").text(c.replace("#",""))},LayoutPart:{cache:[],undo:null,old_id:null,isReload:null,id:null,init:!1,html:null,el:null,options:null,scrollTo:function(a,c){b.scrollTo=b.Forms.LayoutPart.el},insertSwap:function(a){a.getElementsByClassName("tb_dropdown")[0].insertAdjacentHTML("afterbegin",
'<li><div class="tb_swap ti-reload themify-tooltip-bottom"><div class="themify_tooltip">Swap</div></div></li>')},edit:function(a){function c(a){document.getElementById("themify_builder_content-"+themifyBuilder.post_ID).insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>');f.addClass("tb_active_layout_part").closest(".row_inner").find(".active_module").each(function(){this.classList.contains("tb_active_layout_part")||this.insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>')});
var c="themify_builder_content-"+d.id;d.html=f[0].innerHTML;themifyBuilder.post_ID=d.id;f[0].insertAdjacentHTML("afterbegin",h.replace("#postID#",d.id));f.removeClass("active_module module").closest(".tb_holder").removeClass("tb_holder").addClass("tb_layout_part_parent").closest(".module_row").addClass("tb_active_layout_part_row");g.attr("id",c).removeClass("not_editable_builder").empty();d.el=f;b.id=d.id;var k=[],n=e("."+c+".not_editable_builder").closest(".active_module");n.each(function(){e(this).find(".themify-builder-generated-css").prop("disabled",
!0)});n=null;b.Instances.Builder[1]=new b.Views.Builder({el:"#"+c,collection:new b.Collections.Rows(a),type:b.mode});a=b.Instances.Builder[1].render().el.querySelectorAll("[data-cid]");c=0;for(n=a.length;c<n;++c)k[a[c].dataset.cid]=1;a=null;b.bootstrap(k,function(){k=null;b.Utils.loadContentJs(g);b.id=!1;Themify.body.on("themify_builder_change_mode",d.scrollTo);b.hasChanged=!0;b.vent.trigger("dom:builder:init");f.find(".tb_toolbar_save").click(d.save.bind(d));f.find(".tb_toolbar_close_btn").click(d.close.bind(d));
f.find(".tb_load_layout").click(b.Views.Toolbar.prototype.loadLayout);f.find(".tb_toolbar_import ul a").click(b.Views.Toolbar.prototype["import"]);ThemifyBuilderCommon.showLoader("hide");d.init=!1;d.undo=b.undoManager.stack;b.undoManager.btnUndo=f[0].getElementsByClassName("tb_undo_btn")[0];b.undoManager.btnRedo=f[0].getElementsByClassName("tb_redo_btn")[0];b.undoManager.reset();f.find(".tb_undo_redo").click(function(a){b.undoManager.do_change(a)});"desktop"!==b.activeBreakPoint&&b.Mixins.Builder.updateModuleSort(null,
"disable")})}ThemifyBuilderCommon.showLoader("show");document.body.classList.add("tb_layout_part_edit");b.activeModel&&e(".builder_save_button",top_iframe).trigger("click");top_iframe.body.classList.add("tb_layout_part_edit");var d=this,f=e(a).closest(".active_module"),g=f.find(".themify_builder_content"),h=ThemifyBuilderCommon.templateCache.get("tmpl-small_toolbar");this.id=g.data("postid");this.old_id=themifyBuilder.post_ID;this.init=!0;void 0!==this.cache[this.id]?c(this.cache[this.id]):e.ajax({type:"POST",
dataType:"json",url:themifyBuilder.ajaxurl,data:{action:"tb_layout_part_swap",nonce:themifyBuilder.tb_load_nonce,id:d.id},success:function(a){a&&(d.cache[d.id]=a,c(a))}})},close:function(a){function c(){d.el.removeClass("tb_active_layout_part").addClass("active_module module").closest(".tb_layout_part_parent").addClass("tb_holder").removeClass("tb_layout_part_parent").closest(".module_row").removeClass("tb_active_layout_part_row");e("#tb_small_toolbar",d.el).remove();for(var a=f[0].querySelectorAll("[data-cid]"),
c=0,g=a.length;c<g;++c){var m=a[c].dataset.cid,n=b.Models.Registry.lookup(m);n&&(n.destroy(),b.Models.Registry.remove(m),b.liveStylingInstance.revertRules(m),delete b.VisualCache[m])}f.removeAttr("id").addClass("not_editable_builder");document.body.classList.remove("tb_layout_part_edit");top_iframe.body.classList.remove("tb_layout_part_edit");e(".tb_overlay").remove();b.undoManager.stack=d.undo;b.undoManager.index=d.undo.length-1;b.undoManager.btnUndo=b.toolbar.el.getElementsByClassName("tb_undo_btn")[0];
b.undoManager.btnRedo=b.toolbar.el.getElementsByClassName("tb_redo_btn")[0];themifyBuilder.post_ID=d.old_id;d.old_id=null;d.html=null;d.id=null;d.el=null;d.options=null;d.isReload=null;b.Instances.Builder[1]=null;delete b.Instances.Builder[1];d.undo=null;Themify.body.off("themify_builder_change_mode",d.scrollTo);b.Mixins.Builder.updateModuleSort();b.undoManager.updateUndoBtns();"desktop"!==b.activeBreakPoint&&b.Mixins.Builder.updateModuleSort(null,"disable")}a.preventDefault();a.stopPropagation();
var d=this,f=this.el.find(".themify_builder_content");if(null!==this.options){ThemifyBuilderCommon.showLoader("show");a=b.Models.Registry.lookup(this.el.data("cid"));this.cache[this.id]=this.options;e(document).ajaxComplete(function k(a,g,n){if(-1!==n.data.indexOf("tb_load_module_partial",3))if(e(this).off("ajaxComplete",k),200===g.status){d.el=b.liveStylingInstance.$liveStyledElmt;f=d.el.children(".themify_builder_content");var m=f[0].innerHTML,l="";d.el.children(".themify-builder-generated-css").each(function(){l+=
this.outerHTML});e(".themify_builder_content-"+d.id).each(function(){if(e(this).hasClass("not_editable_builder")){var a=e(this).closest(".module");a.children("link.themify-builder-generated-css").remove();""!==l&&a[0].insertAdjacentHTML("afterbegin",l);this.innerHTML=m;b.Utils.loadContentJs(e(this))}});l=m=null;ThemifyBuilderCommon.showLoader("hide");c()}else ThemifyBuilderCommon.showLoader("error")});var g=e.extend(!0,{},a.get("mod_settings"));g.unsetKey=!0;a.trigger("custom:preview:refresh",g);
g=null}else a=e(".themify_builder_content-"+d.id+".not_editable_builder").closest(".active_module"),a.each(function(){e(this).find(".themify-builder-generated-css").removeAttr("disabled")}),a=null,this.el[0].innerHTML=d.html,c(),b.Utils.loadContentJs(f)},save:function(a){a.preventDefault();a.stopPropagation();if(b.undoManager.hasUndo()||null!==this.isReload){var c=this;this.old_settings=this.html=null;ThemifyBuilderCommon.showLoader("show");b.activeModel&&e(".builder_save_button",top_iframe).trigger("click");
b.Utils.saveBuilder(function(a){a.success&&(c.options=a.data.builder_data)},"main",1)}else ThemifyBuilderCommon.showLoader("show"),setTimeout(function(){ThemifyBuilderCommon.showLoader("hide")},100)}},reLoad:function(a,c,d){function f(){"visual"===b.mode&&(b.Utils.loadContentJs(e(l)),b.id=!1);b.vent.trigger("dom:builder:init");ThemifyBuilderCommon.showLoader("hide");"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(e("body",top_iframe).height(document.body.scrollHeight),setTimeout(function(){e("body",
top_iframe).height(document.body.scrollHeight)},2E3));d&&d()}var g=null!==b.Forms.LayoutPart.id,h=g?1:0,k=null,l="";b.Mixins.Builder.updateModuleSort(null,"destroy");g||(b.Models.Registry.destroy(),b.Instances.Builder={});if("visual"===b.mode){var m="themify-builder-"+c+"-generated-css",n=e("link#"+m),l="#themify_builder_content-"+c;b.id=c;if(g){var p=b.Instances.Builder[h].$el.closest(".module-layout-part");n=n.add(p.children(".themify-builder-generated-css"))}n.remove();void 0!==a.css&&void 0!==
a.css.css_file&&(m='<link id="'+m+'" type="text/css" rel="stylesheet" href="'+a.css.css_file+"?tmp="+Date.now()+'" />',a.css.fonts&&(m+='<link id="themify-builder-'+c+'-font" type="text/css" rel="stylesheet" href="//fonts.googleapis.com/css?family='+a.css.fonts.join("|")+'" />'),g?(p[0].insertAdjacentHTML("afterbegin",m),p.children("link").removeAttr("id").addClass("themify-builder-generated-css"),p=null):document.getElementById("themify-builder-admin-ui-css").insertAdjacentHTML("afterend",m),m=null);
g||(b.VisualCache=[],b.editing=!1,setTimeout(function(){b.liveStylingInstance.reset()},1),Themify.body.addClass("sidebar-none full_width"),e("#sidebar,.page-title").remove())}else l="#tb_row_wrapper";if(g){c=b.Instances.Builder[h].el.querySelectorAll("[data-cid]");b.Forms.LayoutPart.isReload=!0;p=0;for(m=c.length;p<m;++p){var n=c[p].dataset.cid,u=b.Models.Registry.lookup(n);u&&(u.destroy(),b.Models.Registry.remove(n),b.liveStylingInstance.revertRules(n))}c=null;b.Instances.Builder[h].$el.empty()}b.Instances.Builder[h]=
...
start:function(b,e){d=c.children(".module_column");f=a.closest(".module_column");D=c.hasClass("direction-rtl");"w"===r?(q=D?f.prev(".module_column"):f.next(".module_column"),h=a.outerWidth(),E=f.outerWidth()):(q=D?f.next(".module_column"):f.prev(".module_column"),E=h=f.outerWidth());h=parseInt(h);t=parseInt(q.outerWidth())-2;w=c.outerWidth()},stop:function(a,h){e(".tb_grid_drag_tooltip").remove();c.removeClass("tb_drag_column_start");var n=Math.ceil(100*(f.outerWidth()/w));f.css("width",n+"%");var p=
