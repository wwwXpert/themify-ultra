					...
					if('' != $link_val){
						echo sprintf('
							<li class="social-link-item %s %s %s">
								<a aria-label="Social Network Link" aria-label="social link" href="%s" %s>%s %s %s</a>
							</li>
							<!-- /themify-link-item -->',
...
class Themify_Feature_Posts extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		/* Strip tags (if needed) and update the widget settings. */
		$opt = array('title','category','show_count','show_date','show_thumb','display','hide_title','thumb_width','thumb_height','excerpt_length','orderby','order');
		foreach($opt as $v){
