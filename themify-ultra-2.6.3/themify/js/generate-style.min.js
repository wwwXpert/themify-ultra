...
a[c].indexOf(".tb_text_wrap")){var e=a[c].trimRight();if(e.endsWith(".tb_text_wrap"))for(var f=0;f<d;++f)a.push(e+" "+b[f])}}return a},toRGBA:function(a){if(a!==k&&""!==a&&"#"!==a){var b=a.split("_"),d=/^([\da-fA-F]{2})([\da-fA-F]{2})([\da-fA-F]{2})$/;if(b[0]!==k)return d=d.exec(b[0].replace("#","")),b=b[1]!==k&&"0.99"!=b[1]?b[1]:1,d?"rgba("+parseInt(d[1],16)+", "+parseInt(d[2],16)+", "+parseInt(d[3],16)+", "+b+")":"#"!==a[0]?"#"+a:a;"#"!==a[0]&&(a="#"+a)}else a="";return a},getStyleVal:function(a,
b){if("desktop"===this.breakpoint)return""!==b[a]?b[a]:k;for(var d=this.breakpointsReverse,c=d.indexOf(this.breakpoint),e=d.length;c<e;++c)if("desktop"!==d[c]){if(b["breakpoint_"+d[c]]!==k&&b["breakpoint_"+d[c]][a]!==k&&""!==b["breakpoint_"+d[c]][a])return b["breakpoint_"+d[c]][a]}else if(""!==b[a])return b[a];return k},generateGSstyles:function(a,b,d){v[b]===k&&(v[b]={});for(var c=this.getStyleOptions(b),e=this.breakpointsReverse,f={},u=function(a,d,e){if(v[b][d]!==k)return v[b][d];if(a.is_overlay===
k&&"frame"!==a.type&&"video"!==a.type&&("radio"!==a.type||a.prop!==k)){var f=a.p,u=a.type,q=a.is_responsive,m=null,h=a.is_hover,g=a.prop;if("select"===u||"icon_radio"===u||"radio"===u||"checkbox"===u||"icon_checkbox"===u)for(var y in a)if(!0===a[y]&&"option_js"!==y){m=y;break}a=function(){for(var a in c)if(f===c[a].p&&g===c[a].prop&&u===c[a].type&&h===c[a].is_hover&&(null===m||!0===c[a][m])&&q===c[a].is_responsive)return v[b][d]=a,!0;return!1};if(!0===a())return v[b][d];if("background-image"===g&&
("image"===u||"imageGradient"===u)){if(u="imageGradient",!0===a())return v[b][d]}else if("margin-top"===g||"margin-bottom"===g)if("row"===b||"column"===b){if("margin"===u&&"row"!==e&&"column"!==e&&(u="range",!0===a()))return v[b][d]}else if("range"===u&&("row"===e||"column"===e)&&(u="margin",!0===a()))return v[b][d]}return v[b][d]=!1},q=e.length,m=0,h=a.length;m<h;++m){var g=a[m].trim();if(""!==g&&d[g]!==k){var w=d[g].data[0];var n=d[g].type;"row"!==n&&"subrow"!==n&&(w=w.cols[0]);"column"===n||"row"===
n||"subrow"===n?w=w.styling:(w=w.modules[0],n=w.mod_name,w=w.mod_settings);if(w!==k){g=b===n?c:this.getStyleOptions(n);for(var p=q-1;-1<p;--p)if("desktop"===e[p])for(var r in w){if(g[r]!==k&&(f[r]===k||""===f[r]||!1===f[r])){var l=c[r]!==k?r:u(g[r],r,n);if(l===r||!1!==l&&!f[l]&&"0"!=f[l])f[l]=w[r]}}else if(w["breakpoint_"+e[p]]!==k){var B=!0,z="breakpoint_"+e[p];f[z]===k&&(f[z]={},B=!1);for(r in w[z])g[r]===k||g[r].is_responsive!==k||f[z][r]!==k&&""!==f[z][r]&&!1!==f[z][r]||(l=c[r]!==k?r:u(g[r],r,
n),l!==r&&(!1===l||f[z][l]||"0"==f[z][l]))||(f[z][l]=w[z][r],B=!0);!1===B&&delete f[z]}}}}return f},createCss:function(a,b,d,c,e){b||(b="row");this.saving=d;var f=this.breakpointsReverse,u=f.length,q=this,m={},g=this.builder_id;d=function(a,b){var d=function(a,b,d){if(c!==k&&d.global_styles!==k&&""!==d.global_styles){var h=q.generateGSstyles(d.global_styles.split(" "),a,c);q.GS=q.extend(!0,{},q.GS,q.createCss([{styling:h,element_id:b}],a,q.saving,k,!0))}d!==k&&null!==d&&d.builder_content!==k&&(q.builder_id=
b,"string"===typeof d.builder_content&&(d.builder_content=JSON.parse(d.builder_content)),e(d.builder_content,"row"),q.builder_id=g);if(d!==k)for(d=q.extend(!0,{},d),h=u-1;-1<h;--h){var y=null;q.breakpoint=f[h];"desktop"===f[h]?y=q.getFieldCss(b,a,d):d["breakpoint_"+f[h]]!==k&&0<Object.keys(d["breakpoint_"+f[h]]).length&&(y=q.getFieldCss(b,a,d["breakpoint_"+f[h]]));if(y&&0<Object.keys(y).length){m[f[h]]===k&&(m[f[h]]={});for(var n in y)if(m[f[h]][n]===k)m[f[h]][n]=y[n];else for(var l=y[n].length-1;-1<
l;--l)m[f[h]][n].push(y[n][l])}}},e=function(a,b){for(var c in a){var f=a[c],u=f.styling?f.styling:f.mod_settings;u!==k&&d(b,f.element_id,u);if(f.cols!==k)for(var h in f.cols)if(u=f.cols[h],u.styling!==k&&d("column",u.element_id,u.styling),u.modules!==k)for(var q in u.modules){var m=u.modules[q];m.mod_name!==k?m.mod_settings!==k&&d(m.mod_name,m.element_id,m.mod_settings):e([m],"subrow")}}};e(a,b)};d(a,b);e===k&&(0<Object.keys(this.fonts).length&&(m.fonts=this.fonts),0<Object.keys(this.cf_fonts).length&&
(m.cf_fonts=this.cf_fonts),0<Object.keys(this.GS).length&&(m.gs=this.GS),this.fonts={},this.GS={},this.cf_fonts={},this.saving=null);f=u=q=g=d=null;return m},getStyleOptions:function(a){if(h[a]===k){var b=A;if(b[a]!==k){h[a]={};var d=this,c=function(b,f){var e;for(e in b)if(null!==b[e]){var q=b[e].type;if("expand"===q||"multi"===q||"group"===q){var m=f;"expand"===q&&b[e].label!==k&&(m=f+"_"+b[e].label.replace(/\s/g,""));c(b[e].options,m)}else if("tabs"===q)for(var g in b[e].options)m=f===k?g:f+"_"+
g,c(b[e].options[g].options,m);else if(b[e].id!==k)if(m=b[e].id,b[e].prop!==k){h[a][m]=d.getStyleData(b[e],f);var n=b[e].prop;if("font-size"===n||"line-height"===n||"letter-spacing"===n)h[a][m+"_unit"]={type:"select",p:f};if("box_shadow"===q||"text_shadow"===q){var l="box_shadow"===q?["hOffset","vOffset","blur","spread","color"]:["hShadow","vShadow","blur","color"];for(g=l.length-1;-1<g;--g){var p=m+"_"+l[g];h[a][p]=d.getStyleData(b[e],f);"color"!==l[g]&&(h[a][p+"_unit"]={type:"select",p:f})}"box_shadow"===
q&&(h[a][m+"_inset"]={type:"checkbox",p:f})}else if("fontColor"===q)h[a][b[e].s]===k&&(h[a][b[e].s]={type:"color",prop:"color",isFontColor:!0,selector:b[e].selector,origId:m,p:f}),h[a][b[e].g]===k&&(h[a][b[e].g]={type:"gradient",p:f},h[a][b[e].g]=h[a][b[e].g+"-gradient-angle"]=h[a][b[e].g+"-circle-radial"]=h[a][b[e].g+"-gradient-type"]={type:"gradient",p:f});else if("padding"===q||"margin"===q||"border"===q||"border_radius"===q){l=["top","right","bottom","left"];var t="border"===q;q=!1===t&&"border_radius"===
q;!0===t?h[a][m+"-type"]={type:"radio",p:f}:(h[a]["checkbox_"+m+"_apply_all"]={type:"checkbox",p:f},!1===q&&(h[a][m+"_opp_top"]={type:"checkbox",p:f},h[a][m+"_opp_left"]={type:"checkbox",p:f}));for(g=3;-1<g;--g)if(p=m+"_"+l[g],!0===t&&(h[a][p+"_style"]=d.getStyleData(b[e],f),h[a][p+"_color"]=d.getStyleData(b[e],f),h[a][p+"_style"].prop=n+"-"+l[g]+"-style",h[a][p+"_color"].prop=n+"-"+l[g]+"-color",p+="_width"),h[a][p]=d.getStyleData(b[e],f),h[a][p+"_unit"]={type:"select",p:f},!0===q){var r="border-";
"top"===l[g]?r+="top-left-radius":"right"===l[g]?r+="top-right-radius":"left"===l[g]?r+="bottom-left-radius":"bottom"===l[g]&&(r+="bottom-right-radius");h[a][p].prop=r}else h[a][p].prop=n+"-"+l[g]}else if("gradient"===q||"imageGradient"===q)h[a][m+"-gradient"]=d.getStyleData(b[e],f),h[a][m+"-gradient-angle"]=h[a][m+"-circle-radial"]=h[a][m+"-gradient-type"]={type:"gradient",p:f},"imageGradient"===q&&(h[a][m+"-type"]={type:"radio",p:f},h[a][b[e].colorId]=d.getStyleData(b[e],f),h[a][b[e].colorId].prop=
"background-color",h[a][b[e].colorId].type="color",h[a][b[e].colorId].id=b[e].colorId);else if("multiColumns"===q)h[a][m+"_gap"]=h[a][m+"_divider_color"]=h[a][m+"_divider_width"]=h[a][m+"_divider_style"]={type:q,p:f};else if("font_select"===q)h[a][m+"_w"]={type:"font_weight"};else if("filters"===q)for(l="hue saturation brightness contrast invert sepia opacity blur".split(" "),g=l.length-1;-1<g;--g)p=m+"_"+l[g],h[a][p]=d.getStyleData(b[e],f);else"width"===q?(h[a]["min_"+m]={prop:"min-width",selector:b[e].selector,
type:"width",p:f},h[a]["max_"+m]={prop:"max-width",selector:b[e].selector,type:"width",p:f},h[a][m+"_auto_width"]={prop:"width",selector:b[e].selector,type:"width",p:f},h[a][m+"_unit"]={type:"select",p:f}):"height"===q&&(h[a][m+"_auto_height"]={prop:"width",selector:b[e].selector,type:"width",p:f},h[a][m+"_unit"]={type:"select",p:f})}else h[a][m]=d.getStyleData(b[e],f);else"margin_opposity"===q&&(h[a][b[e].topId]={prop:"margin-top",selector:b[e].selector,type:"range",p:f},h[a][b[e].bottomId]={prop:"margin-bottom",
selector:b[e].selector,type:"range",p:f},h[a][b[e].topId+"_unit"]={type:"select",p:f},h[a][b[e].bottomId+"_unit"]={type:"select",p:f},h[a][b[e].topId+"_opp_top"]={type:"checkbox",p:f})}};b[a].styling!==k?b[a].styling.options.length!==k?c(b[a].styling.options):c(b[a].styling):c(b[a].type===k?b[a]:[b[a]])}else return!1}return h[a]},getFieldCss:function(a,b,d){if(A[b]!==k){var c={},e=this.getStyleOptions(b);a=this.getBaseSelector(b,a);var f=!0===this.saving,g;for(g in d)if(e[g]!==k&&e[g].selector!==
k){var h=e[g].type;"margin"===h&&(h="padding");h=this.fields[h].call(this,g,b,e[g],d);if(!1!==h){for(var m=Array.isArray(e[g].selector)?e[g].selector:[e[g].selector],n=!0===e[g].ishover,l=[],m=this.getNestedSelector(m),p=0,v=m.length;p<v;++p){var x=m[p];!0===n&&(x+=":hover");if(!0===t)if(!1===f){if(!0===n||-1!==x.indexOf(":hover"))x+=","+a+x.replace(":hover",".tb_visual_hover")}else if(-1!==x.indexOf(".tb_visual_hover")){for(var x=x.split(","),r=x.length-1;-1<r;--r)-1!==x[r].indexOf(".tb_visual_hover")&&
x.splice(r,1);x=x.join(",")}l.push(a+x)}l=l.join(",").trim().replace(/\s\s+/g," ");c[l]===k&&(c[l]=[]);-1===c[l].indexOf(h)&&c[l].push(h)}else null===h&&delete d[g]}return c}return!1},fields:{frameCache:{},imageGradient:function(a,b,d,c){var e=!1,f=-1!==a.indexOf("-gradient",3),k=!0===f?a.replace("-gradient","-type"):a+"-type",k=this.getStyleVal(k,c);"gradient"===k?!0===f&&(e=this.fields.gradient.call(this,a,b,d,c),e+="background-color:transparent;"):!1===f&&(e=this.fields.image.call(this,a,b,d,c),
!1!==e&&""!==this.getStyleVal(a,c)&&(a=this.fields.select.call(this,d.repeatId,b,{prop:"background-mode",origId:d.origId},c),!1!==a&&(e+=a),a=this.fields.position_box.call(this,d.posId,b,{prop:"background-position",origId:d.origId},c),e=!1!==a?e+a:e+"background-position:50% 50%;"));return e},image:function(a,b,d,c){b=this.getStyleVal(a,c);var e=!1;if(b!==k){if(("background_image"===a||"bg_i_h"===a)&&(a=this.getStyleVal("background_image"===a?"background_type":"b_t_h",c))&&"image"!==a&&"video"!==a)return!1;
""===b?"desktop"!==this.breakpoint&&(e=d.prop+":none;"):e=d.prop+":url("+b+");"}return e},gradient:function(a,b,d,c){b=!1;var e=d.id;a=this.getStyleVal(a,c);if("background_gradient"===e||"b_g_h"===e||"cover_gradient"===e||"cover_gradient_hover"===e){var f=this.getStyleVal("background_gradient"===e?"background_type":"b_g_h"===e?"b_t_h":"cover_gradient"===e?"cover_color-type":"cover_color_hover-type",c);if("gradient"!==f&&"hover_gradient"!==f&&"cover_gradient"!==f)return!1}if(a){a=a.split("|");(b=this.getStyleVal(e+
"-gradient-type",c))||(b="linear");"radial"===b?c=this.getStyleVal(e+"-circle-radial",c)?"circle":"":((c=this.getStyleVal(e+"-gradient-angle",c))||(c="180"),c+="deg");""!==c&&(c+=",");e=[];f=0;for(var k=a.length;f<k;++f){var g=parseInt(a[f])+"%",h=a[f].replace(g,"").trim();e.push(h+" "+g)}e=e.join(",");b=d.prop+":"+b+"-gradient("+c+e+");"}return b},icon_radio:function(a,b,d,c){return(a=this.getStyleVal(a,c))?d.prop+":"+a+";":!1},color:function(a,b,d,c){if("column-rule-color"===d.prop)return!1;var e=
