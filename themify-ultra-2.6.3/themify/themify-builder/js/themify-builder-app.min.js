var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(h,z,v){h instanceof String&&(h=String(h));for(var x=h.length,u=0;u<x;u++){var q=h[u];if(z.call(v,q,u,h))return{i:u,v:q}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(h,z,v){h!=Array.prototype&&h!=Object.prototype&&(h[z]=v.value)};$jscomp.getGlobal=function(h){return"undefined"!=typeof window&&window===h?h:"undefined"!=typeof global&&null!=global?global:h};
...
!0===e&&g.nodeName.toLowerCase()===a?g:null;if(null!==g)return g;f=f.parentElement;if(!f)return null}});String.prototype.endsWith||Object.defineProperty(String.prototype,"endsWith",{value:function(a,b){var c=this.toString(),d=c.length;if(b===r||b>d)b=d;b-=d;c=c.indexOf(a,b);return-1!==c&&c===b}});r===h.fn.themifySerializeObject&&(h.fn.themifySerializeObject=function(){for(var a={},b=this.length-1;-1<b;--b){var c=this[b].type;if(this[b].classList.contains("wp-editor-area")&&tinyMCE!==r){var e=tinyMCE.get(this[b].id);
e&&(this[b].value=e.getContent())}if(""!==this[b].value&&("text"===c||"number"===c||"radio"===c||"checkbox"===c||"textarea"===c||"select-one"===c||"hidden"===c||"email"===c||"select"===c||"select-multiple"===c)&&(this[b].name||this[b].id)){var e=this[b].name?this[b].name:this[b].id,f=this[b].value;"radio"===c||"checkbox"===c?f=this[b].checked&&f:"select-multiple"===c&&(f=h(this[b]).val());a[e]!==r&&"radio"!==c?(!a[e].push&&(a[e]=[a[e]]),f&&a[e].push(f)):f&&(a[e]=f)}}return a});var b=tb_app={activeModel:null,
...
c=a.length>b?a.substr(0,b):a);return c},stripHtml:function(a){var b=q.createElement("div");b.innerHTML=a;return b.textContent||b.innerText||""},setData:function(a){b.Utils.clearElementId([a]);a=b.Views.init_module(a);a.model.trigger("custom:change",a)},backendLivePreview:function(){h(".tb_element_cid_"+this.cid).find(".module_excerpt").text(this.getExcerpt())},getPreviewSettings:function(){return _.extend({cid:this.cid},themifyBuilder.modules[this.get("mod_name")].defaults)},getIDattr:function(){return this.get("element_id")?
...
d,c){c=c||!1;b.Models.Registry.lookup(a).set(d,{silent:c})};b.vent=_.extend({},z.Events);b.Views.register_module=function(a){"default"!==b.mode&&(this.Modules[b.mode]=this.Modules["default"].extend(a))};b.Views.init_module=function(a,d){if(themifyBuilder.modules[a.mod_name]===r)return!1;!0===d&&a.mod_settings===r&&themifyBuilder.modules[a.mod_name].defaults!==r&&(a.mod_settings=_.extend({},themifyBuilder.modules[a.mod_name].defaults));var c=a instanceof b.Models.Module?a:new b.Models.Module(a),e=
...
return d===r||d.cols!==r&&(0<Object.keys(d.cols).length||0<d.cols.length)||d.styling!==r&&0<Object.keys(d.styling).length?(a=a instanceof b.Models.Row?a:new b.Models.Row(a),d=new (this.get_row())({model:a,type:b.mode}),{model:a,view:d}):!1};b.Views.get_row=function(){return this.Rows[b.mode]};b.Views.unregister_row=function(){"default"!==b.mode&&(this.Rows[b.mode]=null,delete this.Rows[b.mode])};b.Views.row_exists=function(){return this.Rows.hasOwnProperty(b.mode)};b.Views.BaseElement=z.View.extend({type:"default",
...
(c.attached_gs=e));b.Utils.clearElementId([c]);"sub-column"===f&&(f="column");n.Clipboard.set(f,c)},paste:function(a,d,c){a=this.$el;var e=this.model,f=e.get("elType"),g=null;"column"===f?f=e.get("component_name"):"module"===f&&(g=e.get("mod_name"));"sub-column"===f&&(f="column");var k="style"===d||null!==d&&d!==r&&d.classList.contains("tb_paste_style");d=n.Clipboard.get(f);!1===k&&!1===d&&"column"===f&&(d=n.Clipboard.get("module"),f="module",g=d.mod_name);if(!1===d||!0===k&&"module"===f&&g!==d.mod_name)!0!==
c&&n.alertWrongPaste();else{b.eventName="row";if(!0===k){var h=ThemifyStyles.getStyleOptions("module"===f?g:f);c="module"===f?"mod_settings":"styling";var m=this.getData(a,"column"===f?e.get("component_name"):f),t=function(a){if(-1!==a.indexOf("breakpoint_")||-1!==a.indexOf("_apply_all"))return!0;var b=-1!==a.indexOf("_color")?"color":-1!==a.indexOf("_style")?"style":!1;if(!1!==b){if(b=a.replace("_"+b,"_width"),h[b]!==r&&"border"===h[b].type)return!0}else if(-1!==a.indexOf("_unit")){if(b=a.replace(/_unit$/ig,
"",""),h[b]!==r)return!0}else if(-1!==a.indexOf("_w")){if(b=a.replace(/_w$/ig,"",""),h[b]!==r&&"font_select"===h[b].type)return!0}else if(h[a]!==r&&"radio"===h[a].type)return!0;return!1};m[c]===r&&(m[c]={});for(var p in d[c])h[p]!==r||t(p)?(m[c][p]=d[c][p],h[p]!==r&&(!0===h[p].isFontColor&&d[c][h[p].g+"-gradient"]!==r?m[c][h[p].g+"-gradient"]=d[c][h[p].g+"-gradient"]:(h[p].posId!==r&&d[c][h[p].posId]!==r&&(m[c][h[p].posId]=d[c][h[p].posId]),h[p].repeatId!==r&&d[c][h[p].repeatId]!==r&&(m[c][h[p].repeatId]=
d[c][h[p].repeatId])))):delete d[c][p];d.used_gs!==r&&(m.used_gs=d.used_gs);h=null;d=m;delete d.element_id}"column"===f&&(d.grid_class=b.Utils.filterClass(a.prop("class")),a.hasClass("first")?d.grid_class+=" first":a.hasClass("last")&&(d.grid_class+=" last"),p=a[0].style.width,d.grid_width=p?p.replace("%",""):null,d.component_name=e.get("component_name"));!1===k&&b.Utils.clearElementId([d]);b.hasChanged=!0;!1===k&&"module"===f&&"column"===e.get("elType")&&(e=b.Views.init_module({mod_name:g},!0),f=
...
e.hide().insertAfter(c);var f=this.getData(e,this.model.get("elType"));b.eventName="duplicate";b.beforeEvent=e;b.hasChanged=!0;this.model.setData(f);c.addClass("tb_element_cid_"+this.model.cid)},edit:function(a,d){var c;if(b.isPreview)return!0;"breadcrumb"!==a?b.ActionBar.breadCrumbsPath.lightbox=null:a=null;var e=c=b.hasChanged=!1,f=n.Lightbox.$lightbox,g=this.model.get("elType"),k=!1,h="module"===g?this.model.get("mod_name"):g;if(null!==a){var m=d.classList;var t=m.contains("tb_dragger")?d.getAttribute("data-id"):
null;if(null!==t&&""===d.getAttribute("data-v"))return;"dblclick"===a.type&&this.model.cid!==b.autoSaveCid&&b.ActionBar.clear();c=null!==t||m.contains("tb_styling");if(!0===c)this.model.set({styleClicked:!0},{silent:!0}),null!==t&&(k=function(a){var c=m.contains("tb_dragger_padding")?"padding":"margin",d="padding"===c?"p":"m",e=ThemifyConstructor.label[d],f=r;if("module"===g&&(f=a.getElementsByClassName("tb_styling_tab_nav")[0],f!==r)){if(b.EdgeDrag.modules[h]!==r&&b.EdgeDrag.modules[h][c]!==r&&(t=
t.replace(/_left|_right|_bottom|_top$/ig,""),b.EdgeDrag.modules[h][c][t]!==r&&(c=b.EdgeDrag.getTabId(ThemifyConstructor.data[h].styling.options.options,t,d),null!==c))){for(var d=f.getElementsByClassName("tb_tab_wrapper")[0].getElementsByTagName("a"),k=d.length-1;-1<k;--k)if(d[k].getAttribute("href")==="#tb_1_"+c){d[k].click();break}d=null}c=f.getElementsByClassName("current")[0].getElementsByTagName("a")[0].getAttribute("href");f=a.querySelector(c)}f===r&&(f=a);for(var l=f.getElementsByClassName("tb_style_toggle"),
...
e=!1,f=0;f<=d;++f)a[f]!==r&&null!==a[f]&&(a[f].component_name="sub-column",c.appendChild(b.Views.init_column(a[f]).view.render().el),!1===e&&a[f].modules!==r&&0<a[f].modules.length&&(e=!0));!1===e&&this.el.classList.add("tb_row_empty")}b.Utils.selectedGridMenu(this.el,"subrow");b.Utils.visibilityLabel(this.el);return this}});b.Views.Rows["default"]=b.Views.BaseElement.extend({tagName:"div",attributes:function(){var a=this.model.get("styling"),b={"class":"themify_builder_row module_row clearfix tb_element_cid_"+
this.model.cid+" tb_"+this.model.get("element_id"),"data-cid":this.model.cid};null!==a&&(a.custom_css_row!==r&&""!==a.custom_css_row&&(b["class"]+=" "+a.custom_css_row),a.custom_css_id!==r&&""!==a.custom_css_id&&(b.id=a.custom_css_id));return b},render:function(){var a=this.model.get("cols"),d=Object.keys(a).length,c=!1;this.el.innerHTML=n.templateCache.get("tmpl-builder_row_item");var e=this.el.getElementsByClassName("row_inner")[0];if(0<d)for(var f=0;f<=d;++f)a[f]!==r&&null!==a[f]&&(a[f].component_name=
"column",e.appendChild(b.Views.init_column(a[f]).view.render().el),!1===c&&a[f].modules!==r&&(0<a[f].modules.length||"object"===typeof a[f].modules&&0<Object.keys(a[f].modules).length)&&(c=!0));else b.Utils._addNewColumn({newclass:"col-full",component:"column"},e);!1===c&&this.el.classList.add("tb_row_empty");b.Utils.selectedGridMenu(this.el,"row");b.Utils.visibilityLabel(this.el);return this}});b.Views.Builder=z.View.extend({type:"default",lastRow:null,events:{"click .tb_import_layout_button":"importLayoutButton"},
...
b.Utils.columnDrag(a.find(".row_inner"),!1);b.Utils.columnDrag(a.find(".subrow_inner"),!1);b.Mixins.Builder.updateModuleSort(a)},dragScroll:function(a,d){function c(a,b){l=!0;if(null===k){k=!0;var d=this!==r?this.id:null;d||(d=b);var e=("tb_toolbar"===d||"wpadminbar"===d?"-":"+")+("="+g*m+"px");f.stop().animate({scrollTop:e},{duration:1,complete:function(){!0===l&&(10>m&&++m,k=null,c(null,d))}})}}var e=h("body",u.document);"visual"===b.mode&&(e=e.add(v.body));this.top===r&&(this.top=b.toolbar.$el,
...
g=h(".tb_element_cid_"+d),this.doScroll(g),this.set(e),g.replaceWith(e),c=e.closest(".module_row")),c.toggleClass("tb_row_empty",0===c.find(".active_module").length),c=null;else{this.doScroll(g);l={};a?(e=n.clone(c.before),l[m]=c.data.bsettings):(e=n.clone(c.after),l[m]=c.data.asettings);if("visual"===b.mode){c=h.extend(!0,{},c.data.styles);for(var t in c){var p=ThemifyStyles.getSheet(t),p=p.cssRules?p.cssRules:p.rules;for(k in c[t])if(p[k])for(var y in c[t][k])p[k].style["backgroundClip"===y||"background-clip"===
y?"WebkitBackgroundClip":y]=a?c[t][k][y].b:c[t][k][y].a}c=b.activeModel;k=l[m][b.GS.key]!==r?l[m][b.GS.key].split(" "):[];b.activeModel=f;b.GS.liveInstance=null;b.GS.generateValues(null,k,!0);b.activeModel=c;b.GS.liveInstance=null}f.set(l,{silent:!0});l=null;this.set(e);g.replaceWith(e)}}else if("predesign"===f)if(g=c.data.rows,a)for(this.doScroll(h(".tb_element_cid_"+g[0].data("cid"))),k=0,f=g.length;k<f;++k)h(".tb_element_cid_"+g[k].data("cid")).remove();else{t=q.createDocumentFragment();e=[];k=
0;for(f=g.length;k<f;++k)y=n.clone(g[k]),t.appendChild(y[0]),e.push(y);!1!==c.data.prev?this.doScroll(h(".tb_element_cid_"+c.data.prev)).after(t):this.doScroll("visual"===b.mode?h("#themify_builder_content-"+c.data.bid):h("#tb_row_wrapper")).prepend(t);k=0;for(f=e.length;k<f;++k)this.set(e[k]),b.Mixins.Builder.update(e[k])}else if("import"===f){g=h('[data-postid="'+c.data.bid+'"]');c=a?c.data.before:c.data.after;var w=this;c=n.clone(c);g.children().remove();g.prepend(c);c.each(function(){w.set(h(this))})}else"grid_sort"===
...
c=d.length-1;-1<c;--c)"tb_float_xsmall"===a?(d[c].classList.add("tb_ui_dropdown_items"),d[c].parentNode.classList.add("tb_compact_tabs")):(d[c].classList.remove("tb_ui_dropdown_items"),d[c].parentNode.classList.remove("tb_compact_tabs"))},resize:function(){for(var a=this.el.getElementsByClassName("tb_modules_panel_wrap")[0],b=this,c,e,f,g,k=a.getElementsByClassName("tb_resizable"),l,m,t=null,p=function(d){var h=c+g-d.clientX,k=null;if("w"===m||"sw"===m||"nw"===m){var p=a.style.width;k=parseInt(a.style.left)+
parseInt(p)-h}if("w"!==m){if("y"===m||"-y"===m||"sw"===m||"se"===m||"nw"===m||"ne"===m)if(p="-y"===m||"ne"===m||"nw"===m?e+f-d.clientY:f+d.clientY-e,50<=p&&p<=t){if("-y"===m||"ne"===m||"nw"===m)a.style.top=parseInt(a.style.top)+parseInt(a.style.height)-p+"px";a.style.height=p+"px"}"sw"!==m&&"nw"!==m&&(h=g+d.clientX-c)}if("y"!==m&&"-y"!==m){if(500<h||120>h)p=h,h=120>h?120:500,null!==k&&(k=k+p-h);null!==k&&(a.style.left=k+"px");a.style.width=h+"px";d=b.getPanelClass(h);l!==d&&(l&&a.classList.remove(l),
...
'"]')),a.show(),t(a),h(this).addClass("current").siblings().removeClass("current"),m.parent().find(".tb_ui_dropdown_label").html(h(this).text()));b.Utils.hideOnClick(m)});m.find(".tb_selected_cat").click();k.find("#tb_layout_search").on("keyup",function(){var a=h.trim(h(this).val()),b=d;""!==a&&(b=m.find("li.all"),b[0].classList.contains("current")||b.click(),d.hide(),b=d.find(".layout_title:contains("+a+")").closest(".layout_preview_list"));b.show();t(b)})[0].focus();new SimpleBar(k[0]);new SimpleBar(m[0]);
...
a();else{k[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(u.innerWidth/2,(u.document.documentElement.clientHeight-k.height())/2,!0);var m=l.find(".tb_ui_dropdown_items"),t=function(a){a.each(function(a){0===a%4?this.classList.add("layout-column-break"):this.classList.remove("layout-column-break")})};if(d.layoutsList)g();else{var p=function(a,b){for(var c={},e=q.createDocumentFragment(),f=q.createDocumentFragment(),p=0,n=a.length;p<n;++p){var y=q.createElement("li"),w=q.createElement("div"),
u=q.createElement("div"),v=q.createElement("img"),x=q.createElement("div"),B=q.createElement("div");y.className="layout_preview_list";y.dataset.category=a[p].category;w.className="layout_preview";w.dataset.id=a[p].id;w.dataset.slug=a[p].slug;u.className="thumbnail";v.src=a[p].thumbnail;v.alt=a[p].title;v.title=a[p].title;x.className="layout_action";B.className="layout_title";B.textContent=a[p].title;x.appendChild(B);if(r!==a[p].url){var B=q.createElement("a"),z=q.createElement("i");B.className="layout-preview-link themify_lightbox";
B.href=a[p].url;B.target="_blank";B.title=themifyBuilder.i18n.preview;z.className="ti-search";B.appendChild(z);x.appendChild(B)}u.appendChild(v);w.appendChild(u);w.appendChild(x);y.appendChild(w);e.appendChild(y);if(a[p].category)for(y=String(a[p].category).split(","),w=0,u=y.length;w<u;++w)""!==y[w]&&1!==c[y[w]]&&(v=q.createElement("li"),v.textContent=y[w],f.appendChild(v),c[y[w]]=1,y[w]===b&&(v.className="tb_selected_cat"))}m[0].appendChild(f);l[0].getElementsByClassName("tb_layout_lists")[0].appendChild(e);
e=f=c=null;k.find(".tb_tab").each(function(){t(h(this).find(".layout_preview_list"))});d.layoutsList=k[0].getElementsByClassName("tb_options_tab_wrapper")[0].cloneNode(!0);g()};h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_load_predesigned_layouts",nonce:themifyBuilder.tb_load_nonce,src:themifyBuilder.paths.layouts_index,id:themifyBuilder.post_ID},beforeSend:function(){setTimeout(function(){n.showLoader("show")},500)},success:function(a){var c=JSON.parse(a.data);
...
n.Lightbox.open(d,null,function(){var d=this.$lightbox,f=d[0].querySelector("#custom_css");f.value=A;f.addEventListener("input",function(){var a=this.value.trim();if("visual"===b.mode){var c=q.getElementById("tb_custom_css_tmp");null===c&&(c=q.createElement("style"),c.type="text/css",c.id="tb_custom_css_tmp",q.head.appendChild(c));c.innerHTML=a}});d.addClass("tb_custom_css_lightbox").find(".builder_save_button").one("click",function(a){a.stopImmediatePropagation();a.preventDefault();A=f.value.trim();
n.Lightbox.close()});this.setStandAlone(a.clientX,a.clientY);v.body.one("themify_builder_lightbox_close",function(){A||(A="",c.classList.add("tb_tooltip_active"));var a=q.getElementById("tb_custom_css_tmp");a&&(a.innerHTML=A);c=null;u.document.body.classList.remove("tb_standalone_lightbox")})})},Revisions:{init:function(){b.toolbar.$el.find(".tb_revision").on("click",this.revision.bind(this))},revision:function(a){a.preventDefault();a.stopPropagation();a.currentTarget.classList.contains("tb_save_revision")?
...
!1!==d?(b.undoManager.reset(),b._backendSwitchFrontend(d)):b.Utils.saveBuilder(function(a,e){"success"!==e?alert(themifyBuilder.i18n.errorSaveBuilder):!1!==d&&("visual"===b.mode?(sessionStorage.setItem("focusBackendEditor",!0),u.location.href=d):(b.undoManager.reset(),b._backendSwitchFrontend(d)))})},libraryItems:{items:[],is_init:null,init:function(){h(q).one("tb_panel_tab_tb_module_panel_library_wrap",this.load.bind(this))},load:function(a,d){var c=this;d=h(d).find(".tb_module_panel_library_wrap");
d.addClass("tb_busy");h.ajax({type:"POST",url:themifyBuilder.ajaxurl,data:{action:"tb_get_library_items",nonce:themifyBuilder.tb_load_nonce,part:"all",pid:themifyBuilder.post_ID},success:function(a){c.setData(a);d.removeClass("tb_busy");c.is_init=!0},error:function(){d.removeClass("tb_busy");n.showLoader("error");c.init();b.toolbar.$el.find(".tb_library_item_list").html("<h3>Failed to load Library Items.</h3>")}})},get:function(a,d,c){if(this.items[a]!==r)c(this.items[a]);else{var e=this;h.ajax({type:"POST",
...
rel:"prefetch"}];a.content="on";a.setAttribute("http-equiv","x-dns-prefetch-control");b.appendChild(a);for(var e in c)a=u.document.createElement("link"),a.setAttribute("crossorigin",!0),a.rel=c[e].rel,a.href=c[e].href,b.appendChild(a)},7E3);h(q).one("tb_panel_tab_tb_module_panel_rows_wrap",this.load.bind(this))},load:function(a,d){var c=this;d=h(d).find(".tb_predesigned_rows_list");d.addClass("tb_busy");h.getJSON(themifyBuilder.paths.rows_index).done(function(a){c.setData(a,d)}).fail(function(a,f,
g){c.setData({},d);c.is_init=null;n.showLoader("error");b.toolbar.$el.find(".tb_predesigned_rows_container").append("<h3>"+ThemifyConstructor.label.rows_fetch_error+"</h3>");h(q).one("tb_panel_tab_tb_module_panel_rows_wrap",c.load.bind(c))})},masonry:function(a){for(var b=a.querySelectorAll('.predesigned_row:not([data-masonry="done"])'),c=b.length,e=0;e<c;e++){var f=b[e],g=parseInt(x.top.getComputedStyle(a).getPropertyValue("grid-row-gap")),h=parseInt(x.top.getComputedStyle(a).getPropertyValue("grid-auto-rows"));
if(!isNaN(g)&&!isNaN(h)){var l=f.getElementsByClassName("tb_predesigned_rows_image")[0].getBoundingClientRect().height+f.getElementsByClassName("tb_predesigned_rows_title")[0].getBoundingClientRect().height,g=Math.ceil((l+g)/(h+g));f.style.gridRowEnd="span "+g;5<g&&(f.dataset.masonry="done")}}},loadItems:function(a){this.loadingItems=!0;var b=this.currentCategory,c=q.createDocumentFragment();if(!0===this.categories.All.isLoaded||!0===this.categories[b].isLoaded)return this.loadingItems=!1,c;for(var e=
0,f=Object.keys(this.items),g=f.length,h=0;h<g&&!(10<=e&&r==a);h++){var l=this.items[f[h]],m=""!==a?new RegExp(a,"i"):!1;if(m&&m.test(l.title)){var t=l.category.split(",");if("All"===b||-1!==t.indexOf(b)){delete this.items[f[h]];for(var m="",p=0,y=t.length;p<y;++p)m+=this.categories[t[p]].hash;var t=q.createElement("div"),p=q.createElement("figure"),y=q.createElement("div"),n=new Image,u=q.createElement("a");t.className="predesigned_row "+m;t.setAttribute("data-slug",l.slug);p.className="tb_predesigned_rows_image";
y.className="tb_predesigned_rows_title";y.textContent=n.alt=n.title=l.title;n.src=l.thumbnail===r||""===l.thumbnail?"https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(l.title)+"&w=181&h=77":l.thumbnail;n.width=500;n.height=300;u.href="#";u.className="add_module_btn tb_disable_sorting";u.dataset.type="predesigned";p.appendChild(n);p.appendChild(u);t.appendChild(p);t.appendChild(y);c.appendChild(t);++e}}}this.categories[b].isLoaded=10>e&&r===a;return c},setData:function(a){this.items=a;
a=null;var d=[];a=q.createDocumentFragment();for(var c=0,e=this.items.length;c<e;++c)for(var f=this.items[c].category.split(","),g=0,k=f.length;g<k;++g){var l=v.hash(f[g]);-1===d.indexOf(f[g])&&(d.push(f[g]),this.categories[f[g]]={hash:"tb"+l})}d.sort();c=0;for(e=d.length;c<e;++c)f=q.createElement("li"),f.setAttribute("data-slug",v.hash(d[c])),f.textContent=d[c],a.appendChild(f);var d=h(".tb_module_panel_container .tb_ui_dropdown .tb_ui_dropdown_items"),e=h(".tb_predesigned_rows_container"),m=this;
...
(e=a.getElementsByClassName("simplebar-content"),this.masonry(e.length?e[0]:a));this.loadingItems=!1},get:function(a,d){n.showLoader("show");if(this.rows[a]!==r)"function"===typeof d&&d(this.rows[a]);else{var c=this;h.getJSON(themifyBuilder.paths.row_template.replace("{SLUG}",a)).done(function(e){b.Utils.clearElementId(e);c.rows[a]=e;-1!==JSON.stringify(e).indexOf(b.GS.key)?h.getJSON(themifyBuilder.paths.row_template.replace("{SLUG}",a+"-gs")).done(function(a){var c={},f;for(f in a)a[f]["class"]!==
...
k.addEventListener("scroll",b.toolbar.preDesignedRows.scrollLoadMore.bind(b.toolbar.preDesignedRows),{passive:!0});"visual"===b.mode&&(e=e.add(h("body",u.document)),"desktop"!==b.activeBreakPoint&&(h("body",u.document).height(q.body.scrollHeight+this.btn.outerHeight(!0)),v.body.css("padding-bottom",180)));e.addClass("tb_panel_dropdown_openend");this.clicked.addClass("clicked");"desktop"===b.activeBreakPoint&&setTimeout(function(){this.btn.find(".tb_module_panel_search_text").focus()}.bind(this),50);
this.hide();b.ActionBar.clear();null!==b.activeModel&&(e=n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0],e!==r&&e.click());var e=k.getElementsByTagName("img"),l=k.getElementsByClassName("simplebar-content");0<e.length?(e=e[e.length-1],h(e).one("load",function(){b.toolbar.preDesignedRows.masonry(l.length?l[0]:k)})):b.toolbar.preDesignedRows.masonry(l.length?l[0]:k)},resize:function(){null!==this.btn&&b.Utils.addViewPortClass(this.btn[0])},hide:function(a){function d(){if(!0===
a||!c.btn.is(":hover")){var e=v.body;null!==c.btn&&(c.btn.hide().css("width",""),c.clicked&&c.clicked[0].classList.remove("clicked"),c.clicked=null);h(q).off("click",d);h(u.document).off("click",d);"visual"===b.mode&&(e=e.add(h("body",u.document)),"desktop"!==b.activeBreakPoint&&(h("body",u.document).height(q.body.scrollHeight),v.body.css("padding-bottom","")));e.removeClass("tb_panel_dropdown_openend")}}var c=this;if(!0===a)d();else{if("visual"===b.mode)h(u.document).on("click",d);h(q).on("click",
...
g="visual"===b.mode&&b.iframe[0].classList.contains("tb_resizing_start"),k=b.activeBreakPoint,l=function(){d.responsive_grids(c,k);var a=function(){b.Utils.setCompactMode(q.getElementsByClassName("module_column"));b.toolbar.el.getElementsByClassName("tb_compact_switcher")[0].getElementsByTagName("i")[0].className=e.getElementsByTagName("i")[0].className;f.removeClass("tb_start_animate").toggleClass("tb_responsive_mode","desktop"!==c).removeClass("builder-breakpoint-"+k).addClass("builder-breakpoint-"+
...
"desktop"===c?"enable":"disable");b.ActionBar.hoverCid=null;b.EdgeDrag.clearEdges();setTimeout(a,g?1:100)}):a()};e.classList.contains("breakpoint-tablet")?c="tablet":e.classList.contains("breakpoint-tablet_landscape")?c="tablet_landscape":e.classList.contains("breakpoint-mobile")&&(c="mobile");if(r!==a.tb_device||!v.body[0].classList.contains("builder-breakpoint-"+c)){var m="desktop"!==c?r!==a.tb_device?"tablet_landscape"===c?a.tb_device[1]:a.tb_device[0]:b.Utils.getBPWidth(c)-1:"";if(k===c&&a.originalEvent!==
r&&(m?m+"px":m)===b.iframe[0].style.width)return!1;b.ActionBar.disable=!0;if("visual"===b.mode){null===b.clearOnModeChange&&b.ActionBar.clear();if(!g&&!b.isPreview){var t=b.Instances.Builder[0].el.children;var p=[];for(var y=x.innerHeight,w=function(a){if(null!==a&&a!==r){var b=a.getBoundingClientRect();if(0>b.bottom&&0>b.top||b.top>y)a.style.display="none",p.push(a)}},E=t.length-1;-1<E;--E)w(t[E]);w(q.getElementById("headerwrap"));w(q.getElementById("footerwrap"));t=y=null}f=f.add(v.body)}b.activeBreakPoint=
c;f.addClass("tb_start_animate");if("visual"===b.mode){b.iframe[0].style.willChange="width";t=u.document.getElementsByClassName("tb_toolbar_zoom_menu")[0];t.classList.remove("tb_toolbar_zoom_active");t.getElementsByClassName("tb_toolbar_zoom_menu_toggle")[0].dataset.zoom=100;"tablet_landscape"===c&&n.Lightbox.dockMode.get()&&(t=h(".tb_workspace_container",u.document).width(),t<m&&(m=t));if(b.isPreview&&(t={tablet_landscape:[1024,768],tablet:[768,1024],mobile:[375,667]},t[c]!==r)){m=r===a.tb_device?
t[c][0]:"tablet_landscape"===c?a.tb_device[1]:a.tb_device[0];var H=r===a.tb_device?t[c][1]:"tablet_landscape"===c?a.tb_device[0]:a.tb_device[1]}b.iframe[0].parentNode.classList.remove("tb_zoom_bg");g?l():(u.document.body.offsetHeight,b.iframe.one(b.Utils.transitionPrefix(),function(){if(!b.isPreview){for(var a=p.length-1;-1<a;--a)p[a].style.display="";p=null}setTimeout(l,10)}),b.iframe[0].style.width=m?m+"px":m,b.iframe[0].style.height=b.isPreview?H?H+"px":H:"")}else l()}},iframeScroll:function(a){var b=
h(u.document);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){x.scrollTo(0,h(this).scrollTop())})},responsive_grids:function(a,b){for(var c=q.querySelectorAll(".row_inner,.subrow_inner"),d="desktop"===a,f=d||"desktop"===b,g=c.length-1;-1<g;--g){var k=c[g].getAttribute("data-basecol");if(null!==k){var l=c[g].children,m=c[g].dataset["col_"+a],t=l[0],p=l[l.length-1];if(!d){if("desktop"!==b){c[g].classList.remove("tb_3col");var n=c[g].getAttribute("data-col_"+
...
h(l[k]).data("w"),n!==r&&(l[k].style.width=d?n+"%":"");"rtl"===c[g].getAttribute("data-"+a+"_dir")?(t.classList.remove("first"),t.classList.add("last"),p.classList.remove("last"),p.classList.add("first"),c[g].classList.add("direction-rtl")):(t.classList.remove("last"),t.classList.add("first"),p.classList.remove("first"),p.classList.add("last"),c[g].classList.remove("direction-rtl"))}}},Panel:{el:null,init:function(){this.el=b.toolbar.$el.find(".tb_toolbar_add_modules_wrap");this.el.on("click",".add_module_btn",
...
("none"!==g.style.display||-1===g.className.indexOf("tb_group_element_"))&&(g=g.parentNode,g.classList.contains("tb_multi_fields")&&g.parentNode.classList.contains("_tb_hide_binding")))return!1}g=d?a.getAttribute("data-input-id"):a.getAttribute("id");if(f.contains("tb_lb_wp_editor"))tinyMCE!==r?(e=a.id,f=tinyMCE.get(e),e=null!==f?!1===f.hidden?f.getContent():switchEditors.wpautop(tinymce.DOM.get(e).value):a.value):e=a.value;else if(f.contains("themify-checkbox")){e=[];var k=a.getElementsByClassName("tb-checkbox");
var l=f.contains("tb_switcher");for(var f=0,m=k.length;f<m;++f)!0!==l&&!0!==k[f].checked||""===k[f].value||e.push(k[f].value);e=0<e.length?e.join("|"):l?"":!1}else if(f.contains("themify-layout-icon"))e=a.getElementsByClassName("selected")[0],e=e!==r?e.id:"";else if(f.contains("tb_search_input"))e=a.getAttribute("data-value"),f.contains("query_category_single")&&(f=a.closest(".tb_input").getElementsByClassName("query_category_multiple")[0],f=f===r?"":f.value.trim(),e=""!==f?f+"|"+(-1!==f.indexOf(",")?
"multiple":"single"):e+"|single");else if(f.contains("tb_radio_input_container")){m=a.getElementsByTagName("input");k=null;for(f=m.length-1;-1<f;--f)if(!0===m[f].checked){k=m[f];break}null===k||"desktop"!==b.activeBreakPoint&&k.classList.contains("responsive_disable")||(e=k.value)}else if(f.contains("tb_search_container"))e=a.previousElementSibling.dataset.value;else if(f.contains("tb_row_js_wrapper")){e=[];var t=a.getElementsByClassName("tb_repeatable_field_content");f=0;for(m=t.length;f<m;++f){k=
t[f].getElementsByClassName("tb_lb_option_child");e[f]={};var p=0;for(c=k.length;p<c;++p)(l=this.parseSettings(k[p],!0))&&(e[f][l.id]=l.v)}}else if(f.contains("module-widget-form-container"))e=h(a).find(":input").themifySerializeObject();else if(f.contains("tb_widget_select"))e=a.getElementsByClassName("selected")[0],e=e!==r?e.dataset.value:"";else if(f.contains("tb_sort_fields_parent")){k=a.children;e=[];f=0;for(m=k.length;f<m;++f)if(l=k[f].getAttribute("data-type")){p=k[f].getElementsByClassName("tb_sort_field_dropdown")[0];
l={type:l,id:k[f].getAttribute("data-id")};if(p!==r)for(l.val={},t=p.getElementsByClassName("tb_lb_sort_child"),p=t.length-1;-1<p;--p)(c=this.parseSettings(t[p],!0))&&(l.val[c.id]=c.v);else c=k[f].getElementsByTagName("input")[0],p=c.value,""!==p&&(l.val=JSON.parse(p));e.push(l)}0===e.length&&(e="")}else if(f.contains("tb_accordion_fields"))for(k=a.children,e={},f=0,m=k.length;f<m;++f){if(t=k[f].getAttribute("data-id"))c=k[f].getElementsByTagName("input")[0],p=k[f].getElementsByClassName("tb_accordion_fields_options")[0],
l={},p!==r?l.val=this.serialize(p,null,!0):(p=c.value,""!==p&&(l.val=JSON.parse(p))),e[t]=l}else if(f.contains("tb_toggleable_fields"))for(k=a.children,e={},f=0,m=k.length;f<m;++f){if(t=k[f].getAttribute("data-id"))c=k[f].getElementsByTagName("input")[0],p=k[f].getElementsByClassName("tb_toggleable_fields_options")[0],l={on:k[f].getElementsByClassName("tb_switcher")[0].getElementsByClassName("toggle_switch")[0].value},p!==r?l.val=this.serialize(p,null,!0):(p=c.value,""!==p&&(l.val=JSON.parse(p))),
e[t]=l}else if(e=a.value,x.tbpDynamic!==r&&g===tbpDynamic.field_name){if(""===e)return!1;"string"===typeof e&&(e=JSON.parse(e))}else{if(g===b.GS.key&&"desktop"!==b.activeBreakPoint)return!1;""!==e&&("builder_content"===g?"string"===typeof e&&(e=JSON.parse(e)):(f=a.getAttribute("data-opacity"),null!==f&&""!==f&&1!=f&&"0.99"!=f&&(e+="_"+f)))}if(e===r||null===e)e="";return{id:g,v:e}},serialize:function(a,b,c){c=c||!1;var d={};a="object"===typeof a?a:u.document.getElementById(a);if(null!==a){a=a.getElementsByClassName(c?
"tb_lb_option_child":"tb_lb_option");for(var f=a.length-1;-1<f;--f){var g=this.parseSettings(a[f],c);!1===g||!0!==b&&""===g.v||(d[g.id]=g.v)}}return d},LayoutPart:{cache:[],undo:null,old_id:null,isReload:null,id:null,init:!1,html:null,el:null,options:null,isSaved:null,scrollTo:function(a,d){b.scrollTo=b.Forms.LayoutPart.el},edit:function(a){function d(a){b.ActionBar.clear();q.getElementById("themify_builder_content-"+themifyBuilder.post_ID).insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>');
...
a.stopPropagation();if(null!==b.activeModel){var c=n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];c!==r&&c.click();c=null}if(b.undoManager.hasUndo()||null!==this.isReload||d){var e=this;this.old_settings=this.html=null;n.showLoader("show");b.Utils.saveBuilder(function(c){c.success&&(e.options=c.data.builder_data,b.hasChanged=null,e.isSaved=!0,d&&e.close(a))},1)}else n.showLoader("show"),setTimeout(function(){n.showLoader("hide")},100)}},reLoad:function(a,d,c){function e(){"visual"===
b.mode&&(b.liveStylingInstance.setCss(b.Mixins.Builder.toJSON(b.Instances.Builder[k].el)),b.Utils.loadContentJs(b.Instances.Builder[k].$el),b.id=!1);b.Instances.Builder[b.builderIndex].$el.triggerHandler("tb_init");n.showLoader("hide");"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(h("body",u.document).height(q.body.scrollHeight),setTimeout(function(){h("body",u.document).height(q.body.scrollHeight)},2E3));c&&c();b.hasChanged=!0;"visual"===b.mode&&setTimeout(function(){b.Utils.checkAllimageSize()},
500)}var f=a.builder_data!==r?a.builder_data:a;a.used_gs!==r&&(b.GS.styles=h.extend(!0,{},a.used_gs,b.GS.styles));var g=null!==b.Forms.LayoutPart.id,k=b.builderIndex,l=null,m="";b.Mixins.Builder.updateModuleSort(null,"destroy");g||(b.Models.Registry.destroy(),b.Instances.Builder={});"visual"===b.mode?(m="#themify_builder_content-"+d,b.id=d,g||(b.liveStylingInstance.reset(),b.editing=!1,v.body.addClass("sidebar-none full_width"),h("#sidebar,.page-title").remove())):m="#tb_row_wrapper";if(g){d=b.Instances.Builder[k].el.querySelectorAll("[data-cid]");
b.Forms.LayoutPart.isReload=!0;for(var t=0,p=d.length;t<p;++t){var y=d[t].dataset.cid,w=b.Models.Registry.lookup(y);w&&(w.destroy(),b.Models.Registry.remove(y))}d=null;b.Instances.Builder[k].$el.empty()}b.Instances.Builder[k]=new b.Views.Builder({el:m,collection:new b.Collections.Rows(f),type:b.mode});b.Instances.Builder[k].render();b.undoManager.reset();if(g){l=[];d=b.Instances.Builder[k].el.querySelectorAll("[data-cid]");t=0;for(p=d.length;t<p;++t)l[d[t].dataset.cid]=1;d=null}"visual"===b.mode?
...
(e=q.createElement("span"),e.className="tb_field_error_msg",e.textContent=d[c].getAttribute("data-error-msg"),f.classList.add("tb_field_error"),f="SELECT"===f.tagName?f.parentNode:f,f.parentNode.insertBefore(e,f.nextSibling)),e=!1}!1===e&&(a=n.Lightbox.$lightbox.find('[href="#'+a.getAttribute("id")+'"]')[0],a.parentNode.classList.contains("current")||a.click());return e}};b.Utils={onResizeEvents:[],gridClass:"col-full col2-1 col3-1 col4-1 col5-1 col6-1 col4-2 col4-3 col3-2".split(" "),_onResize:function(a,
d){var c=h._data(x,"events").resize;h(u).off("tfsmartresize.tb_visual").on("tfsmartresize.tb_visual",function(a){""===tbLocalScript.fullwidth_support&&(h(x).triggerHandler("tfsmartresize.tbfullwidth"),h(x).triggerHandler("tfsmartresize.tfVideo"));v.reLayoutIsoTop()}).off("tfsmartresize.zoom").on("tfsmartresize.zoom",function(){if(b.zoomMeta.isActive){var a="50"==b.zoomMeta.size?2:1.25;h(".tb_workspace_container",u.document).css("height",Math.max(u.innerHeight*a,600))}});if(c!==r)for(var e=0,f=c.length;e<
f;++e)c[e].handler!==r&&this.onResizeEvents.push(c[e].handler);h(x).off("resize");if(a){c=h.Event("resize",{type:"resize",isTrigger:!1});e=0;for(f=this.onResizeEvents.length;e<f;++e)try{this.onResizeEvents[e].apply(x,[c,h])}catch(g){}"function"===typeof d&&d()}},_addNewColumn:function(a,d){var c=b.Views.init_column({grid_class:a.newclass,component_name:a.component});d.appendChild(c.view.render().el)},filterClass:function(a){a=a.split(" ");for(var b=[],c=a.length-1;-1<c;--c)-1!==this.gridClass.indexOf(a[c])&&
b.push(a[c]);return b.join(" ")},_getRowSettings:function(a,d){var c=[];d=d||"row";var e={};var f,g=b.Models.Registry.lookup(a.getAttribute("data-cid"));if(g){var h=a.getElementsByClassName(d+"_inner")[0];e=h.children;for(var l=this,m=function(a){a=a.children;for(var c=0,d=a.length;c<d;++c){a[c].classList.contains("active_module")||m(a[c]);var e=b.Models.Registry.lookup(a[c].getAttribute("data-cid"));e&&(f=e.get("mod_settings"),e=q.push({mod_name:e.get("mod_name"),element_id:e.get("element_id")})-
1,f&&0<Object.keys(f).length&&(delete f.cid,q[e].mod_settings=f),a[c].classList.contains("module_subrow")&&(q[e]=l._getRowSettings(a[c],"subrow")))}},t=0,p=e.length;t<p;++t){var n={};var w=b.Models.Registry.lookup(e[t].getAttribute("data-cid"));if(w){n=e[t].getElementsByClassName("tb_holder")[0];var q=[];n!==r&&m(n);n=c.push({element_id:w.get("element_id"),grid_class:this.filterClass(e[t].className)});--n;q&&0<q.length&&(c[n].modules=q);var u=parseFloat(e[t].style.width);0<u&&!isNaN(u)&&(c[n].grid_width=
u);(f=w.get("styling"))&&0<Object.keys(f).length&&(delete f.cid,c[n].styling=f)}}e={element_id:g.get("element_id"),cols:c,column_alignment:g.get("column_alignment"),gutter:g.get("gutter"),column_h:g.get("column_h")};p={gutter:"gutter-default",column_alignment:F?"col_align_middle":"col_align_top"};c={desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_tablet_landscape:"-auto",col_tablet:"-auto",col_mobile:"-auto"};for(t in e)""!==e[t]&&null!==e[t]&&e[t]!==p[t]||delete e[t];
f=g.get("styling");for(t in c)g=h.getAttribute("data-"+t),null===g||""===g||g===c[t]||"-auto"===c[t]&&-1!==g.indexOf("-auto")||(e[t]=g.trim());f&&0<Object.keys(f).length&&(delete f.cid,e.styling=f)}return e},selectedGridMenu:function(a,d){var c=ThemifyConstructor.breakpointsReverse,e=b.Models.Registry.lookup(a.getAttribute("data-cid")),f=a.getElementsByClassName(d+"_inner")[0],g=e.get("gutter"),h=e.get("column_alignment"),l=e.get("column_h");var m=e.get("desktop_dir");var t="row"===d?e.get("styling"):
null,p=[],n={};var w=f.children;for(var q=0,u=w.length;q<u;++q)w[q].className=w[q].className.replace(/first|last/ig,""),1!==u&&(0===q?w[q].className+="rtl"===m?" last":" first":q===u-1&&(w[q].className+="rtl"===m?" first":" last"));w=w.length;p.push("col-count-"+w);n["data-basecol"]=w;null!==t&&t.row_anchor!==r&&""!==t.row_anchor&&(a.getElementsByClassName("tb_row_anchor")[0].textContent=t.row_anchor);"gutter-default"!==g&&p.push(g);l&&p.push("col_auto_height");h||(h="col_align_top");p.push(h);"ltr"!==
m&&p.push("direction-rtl");for(g=c.length-1;-1<g;--g)m=e.get(c[g]+"_dir"),"ltr"!==m&&""!==m&&(n["data-"+c[g]+"_dir"]=m),"desktop"!==c[g]&&(w=e.get("col_"+c[g]),"-auto"!==w&&""!==w&&w!==r&&(n["data-col_"+c[g]]=w));for(q=p.length-1;-1<q;--q)p[q]&&f.classList.add(p[q]);for(q in n)f.setAttribute(q,n[q])},clear:function(a,d,c){d===r&&(d=Array.isArray(a));var e=!0===d?[]:{},f=x.tbpDynamic!==r?tbpDynamic.field_name:!1;c||(c=1);for(var g in a)if(Array.isArray(a[g])){++c;var k=this.clear(a[g],!0,c);0<k.length&&
(!0===d?e.push(k):e[g]=k)}else if(g===f)if("{}"===a[g]||""===a[g])delete a[g],delete e[g];else{k=a[g];"string"===typeof k&&(k=JSON.parse(k));for(var l in k)k[l].item===r?delete k[l]:(a[l]!==r&&(delete a[l],delete e[l]),k[l].o!==r&&delete k[l].o);a[g]=e[g]=k}else if("object"===typeof a[g])++c,k=this.clear(a[g],!1,c),h.isEmptyObject(k)||(e[g]=k);else if(null!==a[g]&&a[g]!==r&&""!==a[g]&&"def"!==a[g]&&""!==g&&"pixels"!==a[g]&&"default"!==a[g]&&"|"!==a[g]&&!("show"===a[g]&&0===g.indexOf("visibility_")||
"unstick_when_condition"===g&&"hits"===a[g]||("stick_at_pos_val_unit"===g||"unstick_when_pos_val_unit"===g)&&"px"===a[g]))if("custom_parallax_scroll_speed"!==g||a[g]&&"0"!=a[g])if("unstick_when_element"===g&&"builder_end"===a[g]||"stick_at_check"===g&&"stick_at_check"!==a[g])delete e.unstick_when_el_row_id,delete e.unstick_when_el_mod_id,delete e.unstick_when_condition,delete a.unstick_when_el_row_id,delete a.unstick_when_el_mod_id,delete a.unstick_when_condition,delete e.unstick_when_pos,delete e.unstick_when_pos_val,
delete e.unstick_when_element,delete e.unstick_when_pos_val_unit,delete a.unstick_when_pos,delete a.unstick_when_pos_val,delete a.unstick_when_pos_val_unit,delete a.unstick_when_element,"stick_at_check"===g&&(delete a[g],delete e[g],delete a.stick_at_position,delete e.stick_at_position);else if("stick_at_position"===g&&"top"===a[g]||g===b.GS.key&&""===a[g].trim()||"background_gradient-css"===g||"cover_gradient-css"===g||"cover_gradient_hover-css"===g||"background_image-type_image"===g||"custom_parallax_scroll_reverse_reverse"===
g||"|single"===a[g]||"|multiple"===a[g]||("custom_parallax_scroll_reverse"===g||"custom_parallax_scroll_fade"===g||"visibility_all"===g||"sticky_visibility"===g)&&!a[g])delete a[g],delete e[g];else{if("builder_content"===g)"string"===typeof a[g]&&(a[g]=JSON.parse(a[g])),a[g]=this.clear(a[g],!0,1);else if(1===c){var m=[];if("px"===a[g]&&-1!==g.indexOf("_unit",2))k=g.replace("_unit",""),a[k]||m.push(g);else if(0===g.indexOf("checkbox_")&&-1!==g.indexOf("_apply_all",6)){a[g]?e[g]=a[g]:m.push(g);k=g.replace("_apply_all",
"").replace("checkbox_","");for(var t=["top","left","right","bottom"],p=3;-1<p;--p){var n=k+"_"+t[p]+"_unit";"px"===a[n]?m.push(n):a[n]!==r&&null!==a[n]&&""!==a[n]&&(e[n]=a[n])}}else-1!==g.indexOf("gradient",3)?("180"==a[g]||"linear"===a[g]||a[g]===h.ThemifyGradient["default"]||!1===a[g]&&-1!==g.indexOf("-circle-radial",3))&&m.push(g):("background_zoom"===g&&""===a[g]||"none"===a[g]&&-1!==g.indexOf("frame_layout")||"solid"===a[g]||!1===a[g]&&(-1!==g.indexOf("_user_role",3)||-1!==g.indexOf("_appearance",
3)))&&m.push(g);if(0<m.length){for(p=m.length-1;-1<p;--p)delete e[m[p]],delete a[m[p]];m.length=0;continue}}!0===d?e.push(a[g]):e[g]=a[g]}else delete e.custom_parallax_scroll_reverse,delete e.custom_parallax_scroll_fade,delete e[g],delete a.custom_parallax_scroll_reverse,delete a.custom_parallax_scroll_fade,delete a[g];return e},clearElementId:function(a,d){for(var c in a){!0===d?a[c].element_id=b.Utils.generateUniqueID():delete a[c].element_id;var e=a[c].styling!==r?a[c].styling:a[c].mod_settings;
if(e!==r){if(e.custom_css_id!==r&&""!==e.custom_css_id)for(var f=2;;){var g=e.custom_css_id+"-"+f.toString(),h=q.getElementById(g);if(null===h||null===h.closest(".module_row")){e.custom_css_id=g;break}++f}e.builder_content!==r&&(f="string"===typeof e.builder_content?JSON.parse(e.builder_content):e.builder_content,this.clearElementId(f,!0),e.builder_content=f)}a[c].cols!==r?this.clearElementId(a[c].cols,d):a[c].modules!==r&&this.clearElementId(a[c].modules,d)}},clearLastEmptyRow:function(a){for(var d=
a.length-1;-1<d;--d){var c=a[d].attributes!==r?a[d].attributes:a[d];if(c.styling===r||null===c.styling||0===Object.keys(c.styling).length){var c=c.cols,e=!0,f;for(f in c)if(c[f].modules!==r&&(0<c[f].modules.length||0<Object.keys(c[f].modules).length)||c[f].styling!==r&&null!==c[f].styling&&0<Object.keys(c[f].styling).length){e=!1;break}if(!0===e)a[d].cid!==r&&(b.Models.Registry.remove(a[d].cid),a[d].destroy()),a.splice(d,1);else break}else break}},builderPlupload:function(a,d){var c=d?!0:!1,e=c?[d]:
n.Lightbox.$lightbox[0].getElementsByClassName("tb_plupload_upload_uic"),f=e.length;if(0<f){var g=c?!1:"new_elemn"===a?".plupload-clone":!1;this.pconfig===r&&(this.pconfig=JSON.parse(JSON.stringify(themify_builder_plupload_init)),this.pconfig.multipart_params._ajax_nonce=themifyBuilder.tb_load_nonce,this.pconfig.multipart_params.topost=themifyBuilder.post_ID);for(--f;-1<f;--f)if(!e[f].classList.contains("tb_plupload_init")&&(!1===g||e[f].classList.contains(g))){var k=e[f],l=k.getAttribute("id").replace("tb_plupload_upload_ui",
""),m=h.extend(!0,{},this.pconfig),t=k.getAttribute("data-extensions"),p=["browse_button","container","drop_element","file_data_name"];m.multipart_params.imgid=l;for(var q=p.length-1;-1<q;--q)m[p[q]]=l+this.pconfig[p[q]];m.filters[0].extensions=null!==t?t:null!==b.activeModel?m.filters[0].extensions.replace(/\,zip|\,txt/,""):"zip,txt";l=new u.plupload.Uploader(m);k.classList.add("tb_plupload_init");c&&l.bind("init",function(a){h(a.settings.browse_button).click()});l.bind("FilesAdded",function(a,b){a.refresh();
a.start();n.showLoader("show")});l.bind("Error",function(a,b){var c=h(".prompt-box .show-error");h(".prompt-box .show-login").hide();c.show();0<c.length&&c.html('<p class="prompt-error">'+b.message+"</p>");h(".overlay, .prompt-box").fadeIn(500)});l.bind("FileUploaded",function(a,d,e){var f=JSON.parse(e.response);a=h("#tb_alert",u.document);e=200!==e.status||f.error?"error":"done";if(f.error)n.showLoader(e),alert(f.error);else if(c){var g=h("#tb_row_wrapper").children().clone(!0);a.promise().done(function(){b.Forms.reLoad(f,
themifyBuilder.post_ID);var a=h("#tb_row_wrapper").children().clone(!0);n.Lightbox.close();b.undoManager.push("","","","import",{before:g,after:a,bid:themifyBuilder.post_ID})})}else n.showLoader(e),a=this.getOption().container.closest(".tb_input"),e=a.getElementsByClassName("tb_uploader_input")[0],a=a.getElementsByClassName("thumb_preview")[0],e.value=f.large_url?f.large_url:f.url,a!==r&&ThemifyConstructor.file.setImage(a,f.thumb),v.triggerEvent(e,"change")});l.init();k.classList.remove("plupload-clone")}}},
...
"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},l={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},m={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};(a?a.children(".module_column").find(".tb_grid_drag"):h(".tb_grid_drag")).each(function(){var a,c,d,e,g=0,q,r=!1,u=0,x=!1,z,G,A,C=null,I=null,B;h(this).draggable({axis:"x",cursor:"col-resize",distance:0,scroll:!1,
snap:!1,containment:".row_inner",helper:function(b){a=h(b.currentTarget);c=a.closest(".subrow_inner");0===c.length&&(c=a.closest(".row_inner"));q=a[0].classList.contains("tb_drag_right")?"w":"e";z="w"===q?"tb_grid_drag_right_tooltip":"tb_grid_drag_left_tooltip";x=n.clone(c.closest(".module_row"));c.addClass("tb_drag_column_start");return h('<div class="ui-widget-header tb_grid_drag_tooltip '+z+'"></div><div class="ui-widget-header tb_grid_drag_tooltip"></div>')},start:function(b,f){d=c.children(".module_column");
e=a.closest(".module_column");A=c[0].classList.contains("direction-rtl");"w"===q?(r=A?e.prev(".module_column"):e.next(".module_column"),g=a.outerWidth(),B=e.outerWidth()):(r=A?e.next(".module_column"):e.prev(".module_column"),B=g=e.outerWidth());g=parseInt(g);u=parseInt(r.outerWidth())-2;G=c.outerWidth();C=e.addClass("tb_drag_column_current").children("."+z)[0];I=e.children(".tb_grid_drag_tooltip").last()[0]},stop:function(a,n){h(".tb_grid_drag_tooltip").remove();c.removeClass("tb_drag_column_start");
var p=Math.ceil(100*(e.outerWidth()/G));e.removeClass("tb_drag_column_current").css("width",p+"%");var t=k,p=3.2;c[0].classList.contains("gutter-narrow")?(t=l,p=1.6):c[0].classList.contains("gutter-none")&&(t=m,p=0);var y=p*(d.length-1);d.each(function(a){a!==r.index()&&(h(this).prop("style").width?a=parseFloat(h(this).prop("style").width):(a=h.trim(f.filterClass(h(this).attr("class")).replace("first","").replace("last","")),a=t[a]),y+=a)});r.css("width",100-y+"%");r=r.add(e);f.setCompactMode(r);
var p=c.closest(".module_row"),w=!0===b.hasChanged;b.hasChanged=!0;b.undoManager.push(p.data("cid"),x,p,"row");b.hasChanged=w;v.body.triggerHandler("tb_grid_changed",[p]);C=I=g=u=G=B=r=z=e=q=A=c=d=null},drag:function(a,b){if(r&&0<r.length){var c=parseInt(b.position.left),c=g+("e"===q?-c:c),d=parseFloat(100*c/G);if(5<=d&&100>d){var f=u,f=f+("w"===q?-(c-B):B-c),h=parseFloat(100*f/G);5<h&&100>h&&(r.css("width",f+"px"),e.css("width",c+"px"),C.innerHTML=d.toFixed(2)+"%",I.innerHTML=h.toFixed(2)+"%")}}}})})}},
...
e!==r&&e.click();e=null}n.showLoader("show")}var f=Object.keys(b.Instances.Builder).length,g=b.Instances.Builder[d],k=this,e=g.$el.data("postid"),g=b.Mixins.Builder.toJSON(g.el);if(!0===c)return{id:e,data:g};b.GS.setImport(b.GS.styles,null,null,!0);(function(a,c){null===A&&(A=themifyBuilder.custom_css,delete themifyBuilder.custom_css);var d={action:"tb_save_data",tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,custom_css:A,sourceEditor:"visual"===b.mode?"frontend":"backend"};k.saveCss(c,d.custom_css,
...
r?u.wpmejsSettings:{}))}v.body.triggerHandler("builder_load_module_partial",[a,d])},createClearBtn:function(a){a.siblings(".tb_clear_btn").click(function(){h(this).hide();a.val("").trigger("keyup")})},toRGBA:function(a){return ThemifyStyles.toRGBA(a)},getColor:function(a){var b=a.value;""!==b&&(null!==a.getAttribute("data-minicolors-initialized")?b=h(a).minicolors("rgbaString"):(a=a.getAttribute("data-opacity"),""!==a&&null!==a&&"1"!=a&&"0.99"!=a&&(b=this.toRGBA(b+"_"+a))));return b},getIcon:function(a){var b=
a.split("-")[0].trim();return"fa"===b||"ti"===b?b+" "+a:"fas fa"===b||"far fa"===b||"fab fa"===b?a:!1},getBPWidth:function(a){a=Array.isArray(themifyBuilder.breakpoints[a])?themifyBuilder.breakpoints[a]:themifyBuilder.breakpoints[a].toString().split("-");return a[a.length-1]},transitionPrefix:function(){if(this.transitionPrefix.pre===r){var a=q.createElement("fakeelement"),b={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"},
c;for(c in b)if(a.style[c]!==r){this.transitionPrefix.pre=b[c];break}}return this.transitionPrefix.pre},generateUniqueID:function(){return(Math.random().toString(36).substr(2,4)+(new Date).getUTCMilliseconds().toString()).substr(0,7)},getUIDList:function(a){a=a||"row";var d=_.pluck(b.Models.Registry.items,"attributes");return _.where(d,{elType:a})||[]},scrollTo:function(a){("desktop"===b.activeBreakPoint?h("html,body"):h("body",u.document)).scrollTop(a)},scrollToDropped:function(a,d){a||(a=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_cid_"+
d)[0]);if(a)if("visual"===b.mode)this.scrollTo(h(a).offset().top-120);else{var c=q.getElementsByClassName("edit-post-layout__content")[0];if(c!==r){if(a.classList.contains("module_row"))var e=a.offsetTop;else e=a.closest(".module_row"),null!==e?(e=h(e),e=e.offset().top+200-e.offsetParent().offset().top):e=a.offsetTop;h(c).scrollTop(e)}}},addViewPortClass:function(a){a.style.transition="none";this.removeViewPortClass(a);var b=this.isInViewport(a);if(!1!==b)for(var b=b.split(" "),c=b.length-1;-1<c;--c)""!==
b[c]&&a.classList.add(b[c]);a.style.transition=""},removeViewPortClass:function(a){for(var b=["top","left","bottom","right"],c=4;-1<c;--c)a.classList.remove("tb_touch_"+b[c])},isInViewport:function(a){a=a.getBoundingClientRect();var b="";0>a.left?b="tb_touch_left":a.right-1>=q.documentElement.clientWidth&&(b="tb_touch_right");if(0>a.top)b+=" tb_touch_top";else if(a.bottom+1>=q.documentElement.clientHeight||x.innerHeight+x.scrollY>=q.body.offsetHeight&&a.bottom+20>=q.documentElement.clientHeight)b+=
" tb_touch_bottom";return""===b?!1:b},checkImageSize:function(a){var b=a.getElementsByTagName("img")[0],c=function(c){b.width<c?a.classList.add("tb_disable_object_fit"):a.classList.remove("tb_disable_object_fit")};if(b!==r){var e=b.naturalWidth;if(e&&b.complete)c(e);else{var f=new Image;f.onload=function(){c(f.width)};f.src=b.src}}else a.classList.remove("tb_disable_object_fit")},checkAllimageSize:function(){var a=b.Instances.Builder[b.builderIndex].el,d=b.Models.Registry.items,c;for(c in d)if("image"===
d[c].attributes.mod_name){var e=a.getElementsByClassName("tb_element_cid_"+d[c].cid)[0];e!==r&&this.checkImageSize(e)}},hideOnClick:function(a){a[0]!==r&&(a=a[0]);if(a.classList.contains("tb_ui_dropdown_items")||a.classList.contains("tb_down"))a.classList.add("tb_hide_option"),a.previousElementSibling.blur(),setTimeout(function(){a.classList.remove("tb_hide_option")},500)},calculateHeight:function(){"visual"===b.mode&&"desktop"!==b.activeBreakPoint&&(u.document.body.style.height=q.body.scrollHeight+
"px")},changeOptions:function(a,d){var c="INPUT"===a.tagName&&"hide_anchor"!==d?"keyup":"change",e=this;"keyup"===c&&a.setAttribute("data-prev",a.value);e.custom_css_id=function(a,b,c,d){a=q.getElementById(d);return null===a||c[0].getAttribute("id")===d||null===a.closest(".module_row")?(c[0].setAttribute("id",d),!0):!1};e.row_anchor=function(a,c,d,e){"visual"===b.mode&&(d.removeClass(b.liveStylingInstance.getRowAnchorClass(a.getAttribute("data-prev"))),""!==e&&d.addClass(b.liveStylingInstance.getRowAnchorClass(e)),
d.data("anchor",e).attr("data-anchor",e));b.hasChanged=!0;d.find(".tb_row_anchor").first().text(e.replace("#",""));return!0};e.custom_css=function(a,c,d,e){"visual"===b.mode&&d.removeClass(a.getAttribute("data-prev")).addClass(e);return!0};e.layout=function(a,c,d,e){"visual"===b.mode&&b.liveStylingInstance.bindRowWidthHeight(c,e,d);return!0};e.hide_anchor=function(a,c,d,e){"visual"===b.mode&&"1"===e&&d.data("hideAnchor",e).attr("data-hide-anchor",e);return b.hasChanged=!0};a.addEventListener(c,function(a){var f=
null!==b.activeModel&&b.ActionBar.cid===b.activeModel.cid,k=!n.Lightbox.$lightbox[0].contains(this),l="hide_anchor"!==d?this.id:"hide_anchor",m="custom_css_id"===l,t=!0!==m||!1!==k&&!0!==f?r:n.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];var p=!0===k&&!1===f?h(".tb_element_cid_"+b.ActionBar.cid):"visual"===b.mode?b.liveStylingInstance.$liveStyledElmt:h(".tb_element_cid_"+b.activeModel.cid);var y=!1===f&&!0===k?n.clone(p[0]):null;var w=this.value;"keyup"===c&&"custom_css"!==
d?((w=w.trim())&&(w=w.replace(/[^a-zA-Z0-9\-\_]+/gi,"")),this.value=w):"layout"===d?w=a.detail.val:"hide_anchor"===d&&(w=this.checked?"1":"0");if(e[d].call(e,this,l,p,w)){m&&(h(this).next(".tb_field_error_msg").remove(),t!==r&&t.classList.remove("tb_disable_save"));if(!0===k){var u=function(){var a=w;"keyup"===c&&(this.removeEventListener("change",u,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),a=this.value.trim());var d=p.data("cid"),e=b.Models.Registry.lookup(d),f=h.extend(!0,{},e.get("styling"));
f||(f={});var g=h.extend(!0,{},f);f[l]=a;e.set({styling:f},{silent:!0});null!==y&&b.undoManager.push(d,y,p,"save",{bsettings:g,asettings:h.extend(!0,{},f)})};"keyup"===c?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",u,{passive:!0,once:!0})):u()}b.hasChanged=!0}else m&&(a=q.createElement("span"),a.className="tb_field_error_msg",a.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(a,this.nextSibling),t!==r&&t.classList.add("tb_disable_save"));
!0===f&&(f=k?n.Lightbox.$lightbox.find("#"+l):h("#"+b.ActionBar.el.id).find("#"+l),"keyup"===c?f.val(w).attr("data-prev",w):"layout"===d?(f.find(".selected").removeClass("selected"),""!==w?f.find("#"+w).addClass("selected"):f.children().first().addClass("selected")):"hide_anchor"===d&&(f.find("INPUT")[0].checked=this.checked));"keyup"===c&&this.setAttribute("data-prev",w)},{passive:!0})},visibilityLabel:function(a,d){var c=r===d?b.Models.Registry.lookup(a.getAttribute("data-cid")):null;d=r===d?"module"!==
c.get("elType")?c.get("styling"):c.get("mod_settings"):d;if(null!==d){var c="",e={visibility_desktop:themifyBuilder.i18n.de,visibility_mobile:themifyBuilder.i18n.mo,visibility_tablet:themifyBuilder.i18n.ta,visibility_tablet_landscape:themifyBuilder.i18n.ta_l,sticky_visibility:themifyBuilder.i18n.s_v},f=a.getElementsByClassName("tb_visibility_hint")[0];if(f!==r){if("hide_all"===d.visibility_all)c=themifyBuilder.i18n.h_a;else{var g;for(g in e){var h=""===c?"":", ";c+="hide"===d[g]?h+e[g]:""}}f.textContent=
c}}}};b.ActionBar={cid:null,topH:null,type:null,disable:null,prevExpand:null,needClear:!0,el:null,breadCrumbs:null,breadCrumbsPath:{lightbox:null,rightClick:null},disablePosition:null,isInit:null,isHoverMode:!0,hoverCid:null,contextMenu:null,contextMenuAnimate:null,init:function(){if(null===this.isInit&&!0!==b.GS.isGSPage){this.isInit=!0;this.el=q.createElement("div");this.breadCrumbs=q.createElement("ul");this.el.id="tb_component_bar";this.breadCrumbs.className="tb_action_breadcrumb";this.el.addEventListener("mousedown",
this.mouseDown.bind(this));this.topH=b.toolbar.$el.height();"visual"===b.mode?q.body.appendChild(this.el):b.Instances.Builder[b.builderIndex].el.parentNode.appendChild(this.el);q.addEventListener("click",this.click.bind(this));q.addEventListener("dblclick",this.click.bind(this));b.Instances.Builder[0].el.addEventListener("mouseover",this.enter);"visual"===b.mode&&u.document.addEventListener("click",this.click.bind(this));var a="visual"===b.mode?null:q.getElementById("tb_canvas_block");null===a?(q.addEventListener("keydown",
this.actions.bind(this)),u.document.addEventListener("keydown",this.actions.bind(this))):a.addEventListener("keydown",this.actions.bind(this));this.changeMode();this.initRightClick(!0)}},changeMode:function(){this.hoverCid=null;var a=this,b=function(b){a.actions(b)};!0===this.isHoverMode?(q.body.classList.remove("tb_click_mode"),q.body.classList.add("tb_hover_mode"),this.el.removeEventListener("click",b)):(q.body.classList.remove("tb_hover_mode"),q.body.classList.add("tb_click_mode"),this.el.addEventListener("click",
b))},initRightClick:function(a){localStorage.getItem("tb_right_click")?!0===a?b.toolbar.el.getElementsByClassName("tb_right_click_mode")[0].checked=!1:(b.Instances.Builder[0].el.removeEventListener("contextmenu",this.rightClick),this.contextMenu=this.contextMenuAnimate=null):(b.Instances.Builder[0].el.addEventListener("contextmenu",this.rightClick),b.ActionBar.el.removeEventListener("contextmenu",this.rightClick),!0!==this.isHoverMode&&b.ActionBar.el.addEventListener("contextmenu",this.rightClick))},
enter:function(a){var d=b.ActionBar;b.Mixins.Builder.columnHover(a.target);if(!0===d.isHoverMode&&null===d.disablePosition&&null===d.disable){a.preventDefault();a.stopPropagation();var c=a.target,e=null,f=c.classList;if(null!==d.prevExpand&&d.prevExpand!==r)if(d.prevExpand.contains(c)){if(f.contains("tb_inner_action_more")||f.contains("tb_action_more")){var g=c.getElementsByTagName("ul")[0];g!==r&&b.Utils.addViewPortClass(g)}g=d.prevExpand.getElementsByClassName("tb_row_settings")[0];if(g!==r){var k=
q.getElementById(g.getAttribute("data-href"));if(k.contains(c))return;k.classList.remove("selected");g.classList.remove("selected")}if("module"===d.type||"column"===d.type){"column"===d.type&&(d.hoverCid=c.parentNode.getAttribute("data-cid"));return}}else{g="module"!==d.type;if(!1===g)"visual"!==b.mode?(g=c.closest(".active_module"),g=null!==g?g.getAttribute("data-cid")!==d.hoverCid:!0):(k=c.closest(".tb_dragger_top"),null!==k&&k.classList.contains("tb_dragger_padding")&&b.EdgeDrag.setModulePosition(k));
else if(f.contains("tb_clicked"))return;!0===g&&d.clear()}if(null===c.closest(".tb_dragger_lightbox")){if(f.contains("tb_action_wrap"))e=!f.contains("tb_clicked");else{if("LI"===c.nodeName&&f.contains("tb_row_settings")&&!f.contains("selected")){d.actions(a);return}if(!f.contains("tb_grid_drag")){c=h(c).closest("[data-cid]")[0];if(c===r)return;f=c.getAttribute("data-cid");if(d.hoverCid===f)return;d.hoverCid=f;g=b.Models.Registry.lookup(f);f=g.get("elType");if("module"===f)e=!0;else if("visual"===
b.mode){d.clear();b.EdgeDrag.addEdges(f,g,c);return}}}!0===e&&d.click(a)}}},rightClickGS:function(a,d,c){this.disable=!0;null!==b.activeModel&&h(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click();var e=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked"),f=b.GS.key;d=d.split(" ");for(var g=d.length,k=e.length-1;-1<k;--k){var l=b.Models.Registry.lookup(e[k].getAttribute("data-cid")),m=n.clone(e[k]),t="module"===l.get("elType")?"mod_settings":"styling",
p=h.extend(!0,{},l.get(t)),q=h.extend(!0,{},p);b.activeModel=l;if(p[f])if(!0===c)a&&-1!==p[f].indexOf(a)&&(p[f]=p[f].split(" "),p[f].splice(p[f].indexOf(a),1),p[f]=p[f].join(" "));else for(var r=0;r<g;++r)-1===p[f].indexOf(d[r])&&(p[f]+=" "+d[r]);else{if(0===g)continue;p[f]=d.join(" ")}r={};r[t]=p;l.set(r,{silent:!0});b.GS.generateValues(a,p[f].split(" "),c);b.undoManager.push(l.cid,m,h(e[k]),"save",{bsettings:q,asettings:p})}this.disable=null;b.activeModel=null},rightClick:function(a,d){a.stopImmediatePropagation();
var c=b.ActionBar;if(null===c.contextMenuAnimate){c.contextMenuAnimate=!0;if(null===c.contextMenu){var e=function(a){a.stopPropagation();"click"===a.type&&null===a.target.closest(".tb_visibility_wrap")&&a.preventDefault();if("LI"===a.target.nodeName||a.target.classList.contains("toggle_switch")){var d="LI"===a.target.nodeName?a.target.getAttribute("data-action"):"visibility";if(d){c.disable=!0;c.hoverCid=null;if("undo"===d||"redo"===d)if(a="undo"===d?b.undoManager.btnUndo:b.undoManager.btnRedo,"undo"===
d&&b.undoManager.hasUndo()||"redo"===d&&b.undoManager.hasRedo())h(a).triggerHandler("click"),c.disable=null;else{c.disable=null;return}else{var e=this.classList.contains("tb_multiply_selected");var f=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked");var g=r;"gs_in"!==d&&"move"!==d&&(!0!==e||"delete"!==d&&"paste"!==d||(g=!0),h(".builder_save_button",ThemifyBuilderCommon.Lightbox.$lightbox).click());if("reset"===d){var k=b.activeModel;var l=h.extend(!0,{},ThemifyConstructor.values);
var m=ThemifyConstructor.component;var p=ThemifyConstructor.beforeData;var t=!0===b.hasChanged;var q="visual"===b.mode?b.liveStylingInstance.prefix:null;var u="visual"===b.mode?b.liveStylingInstance.$liveStyledElmt:null}else{if("move"===d){c.disable=null;return}if("gs_in"===d){if(!1===e){d=b.Models.Registry.lookup(f[0].dataset.cid);var y=h.extend(!0,{},ThemifyConstructor.values);ThemifyConstructor.values="module"===d.get("elType")?d.get("mod_settings"):d.get("styling")}if(d=b.GS.globalStylesHTML())a=
c.contextMenu.querySelector("#tb_inline_gs"),a.innerHTML="",a.appendChild(d),a.getElementsByClassName("tb_gs_icon")[0].click(),a.querySelector('[data-action="insert"]').click(),a.classList.add("tb_inline_gs_show"),b.Utils.addViewPortClass(c.contextMenu);!1===e&&(ThemifyConstructor.values=y);c.disable=null;return}}for(var v=f.length-1;-1<v;--v){e=f[v].getAttribute("data-cid");var x=b.Models.Registry.lookup(e);var z=x.get("elType");y="module"===z?x.get("mod_settings"):x.get("styling");if("reset"===
d||"gs_r"===d){if("gs_r"!==d||y[b.GS.key]!==r){if(null!==b.activeModel&&b.activeModel.cid===e){var A=ThemifyBuilderCommon.Lightbox.$lightbox.find(".reset-styling")[0];if(A!==r){A.click();continue}}var A=n.clone(f[v]),C;b.activeModel=x;"reset"===d&&(ThemifyConstructor.component=z,ThemifyConstructor.values=y);var F="module"===z?"mod_setting":"styling";"visual"===b.mode&&(b.liveStylingInstance.$liveStyledElmt?b.liveStylingInstance.prefix=ThemifyStyles.getBaseSelector("module"===z?b.activeModel.get("mod_name"):
z,b.activeModel.get("element_id")):b.liveStylingInstance.init(!0),b.liveStylingInstance.$liveStyledElmt=h(f[v]));z=h.extend(!0,{},y);"reset"===d?(y=ThemifyConstructor.resetStyling(a,null!==k&&k.cid!==e),"visual"===b.mode&&(C=h.extend(!0,{},y)),y=h.extend(!0,{},ThemifyConstructor.values)):(delete y[b.GS.key],b.GS.generateValues(null,[],!0));var J={};J[F]=y;x.set(J,{silent:!0});b.hasChanged=!0;b.undoManager.push(e,A,h(f[v]),"save",{bsettings:z,asettings:y,styles:C});C=null}}else("delete"!==d&&"visibility"!==
d||"column"!==z)&&x.trigger(d,a,a.target,g)}"reset"===d?(b.hasChanged=t,b.activeModel=k,ThemifyConstructor.values=l,ThemifyConstructor.component=m,ThemifyConstructor.beforeData=p,"visual"===b.mode&&(b.liveStylingInstance.$liveStyledElmt=u,b.liveStylingInstance.prefix=q)):"edit"!==d&&(b.activeModel=null);c.disable=null}"visibility"!==d&&c.hideContextMenu()}}},f=function(a){a.stopPropagation();a.target.classList.contains("tb_inner_action_more")&&(a=a.target.getElementsByTagName("ul")[0],a!==r&&b.Utils.addViewPortClass(a))};
c.contextMenu=q.getElementById("tb_right_click");null===c.contextMenu&&(c.contextMenu=q.getElementById("tmpl-builder_right_click"),c.contextMenu=n.is_template_support?c.contextMenu.content:c.contextMenu.innerHTML,n.is_template_support?q.body.appendChild(c.contextMenu):q.body.insertAdjacentHTML("beforeend",c.contextMenu),c.contextMenu=q.getElementById("tb_right_click"),c.contextMenu.addEventListener("click",e),c.contextMenu.addEventListener("mouseover",f,{passive:!0}),c.contextMenu.getElementsByClassName("tb_r_name")[0].addEventListener("mousedown",
function(a){1!==a.which||c.contextMenu.classList.contains("tb_multiply_selected")||c.contextMenu.classList.contains("tb_component_column")||(a.preventDefault(),a.stopPropagation(),a=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_clicked")[0],a!==r&&(c.hideContextMenu(),c.cid=a.dataset.cid,c.moveComponent()))}))}var g=!0;!0!==c.isHoverMode&&null!==c.cid?d=b.Instances.Builder[b.builderIndex].el.querySelector('[data-cid="'+c.cid+'"]'):d?g=!1:d=h(a.target).closest("[data-cid]")[0];
if(d===r)c.contextMenuAnimate=null;else{a.preventDefault();c.hideContextMenu(a.target.classList.contains("tb_bread"));c.disablePosition=!0;q.body.classList.add("tb_right_click_open");c.contextMenu.className="tb_show_context";var k=a.pageX,l=a.pageY,m=b.Models.Registry.lookup(d.dataset.cid),t=m.get("elType"),p=function(e){if("transform"===e.propertyName){var f=b.Instances.Builder[b.builderIndex].el;e=this.getElementsByClassName("tb_r_name")[0];var h=this.getElementsByClassName("tb_action_breadcrumb")[0],
n=function(a){a.preventDefault();a.stopPropagation();var d=a.target.getAttribute("data-id");d&&(this.removeEventListener("click",n),c.hideContextMenu(!0),d=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_cid_"+d)[0],d!==r&&c.rightClick(a,d))};this.removeEventListener("transitionend",p,{passive:!0});this.className="tb_component_"+t;"module"===t&&(this.className+=" tb_module_"+m.get("mod_name"));h.innerHTML="";if(!0===a.ctrlKey||!0===a.metaKey)d.classList.add("tb_element_clicked");
else if(!d.classList.contains("tb_element_clicked")){var q=f.getElementsByClassName("tb_element_clicked");for(var u=q.length-1;-1<u;--u)q[u].classList.remove("tb_element_clicked");d.classList.add("tb_element_clicked")}q=f.getElementsByClassName("tb_element_clicked").length;1<q?(this.className+=" tb_multiply_selected",e.textContent=themifyBuilder.i18n.multiSelected):(f=null===c.breadCrumbsPath.rightClick?m.cid:c.breadCrumbsPath.rightClick[c.breadCrumbsPath.rightClick.length-1],c.breadCrumbsPath.rightClick=
c.getBreadCrumbPath(b.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+f)[0],"rightClick"),f=null,h.appendChild(c.getBreadCrumbs(d,"rightClick")),e.textContent="module"===t?themifyBuilder.modules[m.get("mod_name")].name:t);h.addEventListener("click",n);var y=function(a){"transform"===a.propertyName?(this.removeEventListener("transitionend",y,{passive:!0}),b.Utils.addViewPortClass(this),c.contextMenuAnimate=null):(this.style.top=l+"px",!0===g&&(this.style.left=k+"px"))};this.addEventListener("transitionend",
y,{passive:!0});b.undoManager.hasUndo()||(this.className+=" tb_undo_disabled");"column"===t&&(this.className+=" tb_visibility_disabled");b.undoManager.hasRedo()||(this.className+=" tb_redo_disabled");this.className+=" tb_show_context"}};c.contextMenu.addEventListener("transitionend",p,{passive:!0});setTimeout(function(){c.contextMenu.className=""},18)}}},hideContextMenu:function(a){if(null!==this.contextMenu){this.contextMenu.style.top="";var d=this.contextMenu.querySelector("#tb_inline_gs");d.classList.contains("tb_inline_gs_show")&&
d.classList.remove("tb_inline_gs_show");q.body.classList.remove("tb_right_click_open");this.disablePosition=this.hoverCid=null;!0!==a&&(b.ActionBar.breadCrumbsPath.rightClick=null)}},mouseDown:function(a){1!==a.which||"row"!==this.type&&"subrow"!==this.type||!a.target.classList.contains("ti-move")||(a.preventDefault(),a.stopPropagation(),this.moveComponent())},moveComponent:function(){var a=b.Instances.Builder[b.builderIndex].el.getElementsByClassName("tb_element_cid_"+this.cid)[0];if(a!==r){var d=
a.classList.contains("module_row")?a.getElementsByClassName("tb_row_action")[0]:a,a=h(a).offset();this.clear();if("function"===typeof Event)var c=new Event("mousedown",{bubbles:!0,cancelable:!1});else c=q.createEvent("Event"),c.initEvent("mousedown",!0,!1);c.pageX=a.left;c.pageY=a.top;c.which=1;d.dispatchEvent(c)}},click:function(a){if(b.isPreview||!0===this.disable)return!0;var d=a.target,c=d.tagName;var e=null;var f=b.Instances.Builder[b.builderIndex].lastRow;var g="visual"===b.mode&&d.ownerDocument===
u.document?r:h(d).closest("[data-cid]")[0],k=a.type;if("click"===k){this.hideContextMenu();e=!0===a.ctrlKey||!0===a.metaKey;if(u.document.body.classList.contains("tb_standalone_lightbox")&&!u.document.body.classList.contains("modal-open")){b.toolbar.el.contains(d)||n.Lightbox.$lightbox[0].contains(d)||n.Lightbox.$lightbox[0].classList.contains("tb_predesigned_lightbox")||n.Lightbox.close();var l=u.document.getElementsByClassName("tb_current_menu_selected")[0];l!==r&&l.classList.remove("tb_current_menu_selected");
l=null}f&&!f.contains(d)&&f.classList.remove("expanded");if(!n.Lightbox.$lightbox[0].contains(d)&&(!1===e&&this.clearClicked(),g!==r)){if(!0===e&&g.classList.contains("tb_element_clicked")){g.classList.remove("tb_element_clicked");return}g.classList.add("tb_element_clicked")}}else if("dblclick"===k&&null!==b.Forms.LayoutPart.id&&d.classList.contains("tb_overlay")){b.Forms.LayoutPart.save(a,!0);return}l=("click"===k||"dblclick"===k)&&"visual"===b.mode&&n.Lightbox.dockMode.get();if(g===r||!("dblclick"===
k||!0===l&&d.classList.contains("tb_dragger"))&&d.classList.contains("tb_disable_sorting")||g.classList.contains("tb_active_layout_part"))"LI"===c&&d.classList.contains("tb_bread")?(f=b.Models.Registry.lookup(d.getAttribute("data-id")),"setting"!==ThemifyConstructor.clicked&&"module"===ThemifyConstructor.component&&(a=n.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector(".current a").getAttribute("href"),n.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs").on("themify_opened_lightbox.tb_breadCrumbs",
function(){"row"===ThemifyConstructor.component?n.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector('a[href="'+this+'"]').click():null===b.activeModel&&n.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")}.bind(a)),a=null),a=null===this.breadCrumbsPath.lightbox?b.activeModel.cid:this.breadCrumbsPath.lightbox[this.breadCrumbsPath.lightbox.length-1],this.breadCrumbsPath.lightbox=this.getBreadCrumbPath(b.Instances.Builder[0].el.getElementsByClassName("tb_element_cid_"+
a)[0]),a=null,f.trigger("edit","breadcrumb")):this.el.contains(d)||"click"===a.type&&d.classList.contains("tb_dragger")||this.clear();else{"visual"!==b.mode||"A"!==c&&null===d.closest("a")||a.preventDefault();var m=g.getAttribute("data-cid");f=b.Models.Registry.lookup(m);var t=f.get("elType"),p="row"===t&&g.classList.contains("tb-page-break");if(f){if("dblclick"===k){if((!0===l||"INPUT"===c||!0===p||d.classList.contains("tb_dragger_lightbox")||null!==d.closest(".tb_clicked"))&&"tb_row_options"!==
d.id)return;a.preventDefault();a.stopPropagation();!1===l&&!0!==this.isHoverMode?(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===b.mode&&b.EdgeDrag.addEdges("module"===t?f.get("mod_name"):t,f,g)):g.classList.remove("tb_element_clicked");if(!d.classList.contains("tb_row_settings")){this.hoverCid=null;f.trigger("edit",a,d);return}}else if("click"===k&&!1===l&&(d.classList.contains("tb_dragger")||null!==d.closest(".tb_dragger_options")))return;var y=!0===
this.isHoverMode;var w=!0!==y&&null!==this.cid,c="module"!==t?d.classList.contains("tb_action_wrap"):!0===y;this.cid=m;this.type=t;if(!0===p&&"row"===t)this.clear(),d.classList.contains("tb_row_anchor")&&(a.preventDefault(),a.stopPropagation(),f.trigger("delete",a,d));else if((!1===c||"module"===t&&!0===y)&&null!==d.closest(".tb_action_wrap"))"click"===k&&this.actions(a);else if(!0===y&&"click"===k&&!0===this.needClear)!0===l&&!1===e&&f.trigger("edit",a,d);else if(this.clear(),!0===w&&"click"===k&&
!1===e&&!1===l&&!0===this.needClear){v.body[0].classList.add("tb_action_active");var x=this,z=function(){q.removeEventListener("mousemove",z,{passive:!0,once:!0});null===x.cid&&(v.body[0].classList.remove("tb_action_active"),x.clearClicked())};q.removeEventListener("mousemove",z,{passive:!0,once:!0});q.addEventListener("mousemove",z,{passive:!0,once:!0})}else{this.cid=m;this.type=t;e="tmpl-builder_"+t+"_action";k=n.is_template_support?q.getElementById(e).content.cloneNode(!0):n.templateCache.get(e);
if(!0===c){this.prevExpand="module"===t?g.getElementsByClassName("tb_module_action")[0]:d;if(this.prevExpand===r){this.clear();return}n.is_template_support?this.prevExpand.appendChild(k):this.prevExpand.insertAdjacentHTML("beforeend",k);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.style.top="";this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");!0===y&&"module"===t&&(k=!0,e=g.getBoundingClientRect(),70>e.height||200>e.width?(this.prevExpand.classList.add("tb_small_action_bar"),
...
f,g)))}else("row"!==t||"row"===t&&null!==this.breadCrumbsPath.lightbox)&&this.setBreadCrumbs(g),this.el.className="tb_show_toolbar tb_"+t+"_action",e=q.createElement("div"),e.className="tb_action_label_wrap",n.is_template_support?e.appendChild(k):e.insertAdjacentHTML("beforeend",k),"visual"===b.mode&&("module"===t?(k=f.get("mod_name"),this.el.className+=" tb_"+k+"_action",k=themifyBuilder.modules[k].name):(k=t,"row"===t&&(m=f.get("styling").row_anchor,m!==r&&(m=m.trim(),""!==m&&(k+=" #"+m)))),m=q.createElement("div"),
m.className="tb_data_mod_name",m.textContent=k.charAt(0).toUpperCase()+k.slice(1),e.appendChild(m)),this.el.appendChild(e);!0!==y&&(g.classList.add("tb_element_clicked"),v.body[0].classList.add("tb_action_active"),"visual"===b.mode&&b.EdgeDrag.addEdges("module"===t?f.get("mod_name"):t,f,g));if(!0===l&&(f.trigger("edit",a,d),!0===y||null!==this.disablePosition&&!1!==c&&!0===y))return;null===this.disablePosition&&(!1===c&&!0!==y?(f=a.pageX,y=a.pageY,"visual"!==b.mode&&(e=b.Instances.Builder[0].el.getBoundingClientRect(),
...
b?"lightbox":b;var d=null!==this.breadCrumbsPath[b]?this.breadCrumbsPath[b]:[];if(0<d.length)return d;if(r!==a)for((c=a.getAttribute("data-cid"))&&d.push(c);!a.classList.contains("module_row");)a=a.parentNode,(c=a.getAttribute("data-cid"))&&d.push(c);return d},getBreadCrumbs:function(a,d){var c=this.getBreadCrumbPath(a,d),e=q.createDocumentFragment();if(r!==a)for(var f="rightClick"===d?a.dataset.cid:b.activeModel?b.activeModel.cid:b.ActionBar.cid,g=c.length-1;-1<g;--g){var h=q.createElement("li"),
l=b.Models.Registry.lookup(c[g]),m=l.get("elType");h.textContent="column"===m?l.get("component_name"):"module"===m?l.get("mod_name"):m;h.className="tb_bread tb_bread_"+m;f===c[g]&&(h.className+=" tb_active_bc");h.setAttribute("data-id",c[g]);e.appendChild(h)}return e},actions:function(a){var d=a.target;var c=d.tagName;if("keydown"===a.type){if("INPUT"!==c&&"TEXTAREA"!==c&&!themifyBuilder.disableShortcuts&&!n.Lightbox.$lightbox[0].contains(d)){var e=a.keyCode;c=q.getElementsByClassName("tb_element_clicked");
var f=c.length;if(0<f){a.preventDefault();a.stopPropagation();var g=null,k=null,l=r,m=!0===a.ctrlKey||!0===a.metaKey;46===e||8===e?g="delete":!0===m&&(67===e?(g="copy",f=1):68===e?g="duplicate":86===e&&(g="paste",!0===a.shiftKey&&(k="style")));1<f&&("delete"===g||"paste"===g)&&(l=!0,null!==b.activeModel&&n.Lightbox.$lightbox.is(":visible")&&ThemifyConstructor.saveComponent());for(d=f-1;-1<d;--d){var t=c[d];if(null===g){if(!0===m&&1===f&&(38===e||40===e)){var p=38===a.which?"up":"down";var u="up"===
p?t.previousElementSibling:t.nextElementSibling;if(null!==u){if(t.classList.contains("module_row")){if(!u.classList.contains("module_row"))continue;var w=b.Instances.Builder[b.builderIndex].$el}else if(t.classList.contains("active_module")){if(!u.classList.contains("active_module"))continue;w=h(t.parentNode.closest(".tb_holder"))}else continue;u&&(u=h(t),w.sortable("option","beforeStart")(null,null,{item:u}),w.sortable("option","start")(null,{item:u}),"up"===p?u.prev().before(u):u.next().after(u),
w.sortable("option","update")({type:"sortupdate"},{item:u}),w.sortable("option","stop")(null,{item:u,helper:null}),!0!==this.isHoverMode&&t.classList.add("tb_element_clicked"))}}}else"delete"===g&&t.classList.contains("module_column")||(t=b.Models.Registry.lookup(h(t).closest("[data-cid]")[0].getAttribute("data-cid")),t.trigger(g,a,k,l))}"delete"!==g&&!0===this.isHoverMode||this.clear()}}}else if(a.stopPropagation(),"click"===a.type&&null!==d.closest(".switch-wrapper"))d.classList.contains("toggle_switch")&&
b.Models.Registry.lookup(h(d).closest("[data-cid]")[0].getAttribute("data-cid")).trigger("visibility",a,d);else if(a.preventDefault(),null!==this.cid&&("LI"===c||"SPAN"===c||"A"===c)&&(f=(e=d.classList.contains("tb_bread"))?d.getAttribute("data-id"):this.cid,p=null,t=b.Models.Registry.lookup(f),g=d.classList,t))if(v.body[0].classList.remove("tb_component_menu_active"),!0===e)this.needClear=null,this.disablePosition=!0,q.getElementsByClassName("tb_element_cid_"+f)[0].click(),this.disablePosition=null,
"visual"===b.mode&&(d=this.el.getBoundingClientRect(),d.right>=q.body.clientWidth&&this.setPosition(this.el,{left:d.left,top:this.el.offsetTop+55})),this.needClear=!0;else if(p=d.getAttribute("data-href"))for(a=d.parentNode.getElementsByTagName("li"),d=a.length-1;-1<d;--d)c=(t=a[d].getAttribute("data-href"))?q.getElementById(t):null,e=a[d].classList.contains("selected"),a[d].classList.remove("selected"),null!==c&&c.classList.remove("selected"),t!==p||e||("tb_row_options"===t||"tb_rgrids"===t?this.gridMenu(c):
"tb_roptions"===t&&0===c.children.length&&this.setRowOptions(c),c.classList.add("selected"),a[d].classList.add("selected"),b.Utils.addViewPortClass(c),v.body[0].classList.add("tb_component_menu_active"));else{if(g.contains("tb_edit")||g.contains("tb_styling")||g.contains("tb_visibility_component")||g.contains("tb_swap"))p="edit";else if(g.contains("tb_duplicate"))p="duplicate";else if(g.contains("tb_save_component"))p="save";else if(g.contains("tb_delete"))p="delete";else if(g.contains("ti-import")||
g.contains("ti-export"))p="importExport";else if(g.contains("tb_copy_component"))p="copy";else if(g.contains("tb_paste_component")||g.contains("tb_paste_style"))p="paste";else{if("LI"===c||"SPAN"===c||g.contains("tb_action_more")||g.contains("tb_inner_action_more")){a=d.closest("li");if(null===a)return;e=a.parentNode;p=e.classList;t=p.contains("tb_grid_list")||p.contains("tb_column_alignment")||p.contains("tb_column_gutter")||p.contains("tb_column_direction")||p.contains("tb_column_height")||p.contains("grid_tabs");
c=d.classList.contains("selected");e=e.children;if(t&&c)return;for(d=e.length-1;-1<d;--d)if(e[d].classList.remove("selected"),!1===t)for(f=e[d].getElementsByClassName("selected"),g=f.length-1;-1<g;--g)f[g].classList.remove("selected");c||(a.classList.add("selected"),v.body[0].classList.add("tb_component_menu_active"));if(t)p.contains("tb_column_alignment")?this._columnAlignmentClicked(a):p.contains("tb_column_gutter")?this._gutterChange(a):p.contains("tb_column_direction")?this._columnDirectionClicked(a):
p.contains("tb_column_height")?this._columnHeight(a):p.contains("grid_tabs")?this._switchGridTabs(a):p.contains("tb_grid_list")&&this._gridClicked(a);else{e=null!==this.prevExpand?this.prevExpand.children:this.el.getElementsByClassName("tb_action_label_wrap")[0].children;for(d=e.length-1;-1<d;--d)e[d].classList.remove("selected");c||null!==this.prevExpand&&"column"!==this.type||(e=a.getElementsByTagName("ul")[0],e!==r&&b.Utils.addViewPortClass(e))}}return}if(!0!==this.isHoverMode)this.clear();else{var x=
d.closest(".tb_action_more");null!==x&&(x=x.getElementsByTagName("ul")[0],x.style.display="none",setTimeout(function(){null!==x&&(x.style.display="")},100))}t.trigger(p,a,d)}},_switchGridTabs:function(a){b.ActionBar.disable=b.clearOnModeChange=!0;b.ActionBar.hoverCid=null;b.scrollTo=h(q.getElementsByClassName("tb_element_cid_"+this.cid)[0]);ThemifyConstructor.lightboxSwitch(a.getAttribute("data-id"));"visual"!==b.mode&&this.gridMenu(a.closest(".tb_toolbar_tabs"))},_gridClicked:function(a){var d=h(a),
c=d.data("grid"),e=this.type,f=h(".tb_element_cid_"+this.cid).first(),g=!1,k=b.activeBreakPoint,l="desktop"===k;a=n.clone(f.closest(".module_row"));g="subrow"===e;var m=f.find("."+e+"_inner").first();if(l){e=m;var t=d.data("col");e=e.add(h("#tb_rgrids"));t===r&&(t=1,d.data("col",t));for(k=6;0<k;--k)e.removeClass("col-count-"+k);e.addClass("col-count-"+t);m.attr("data-basecol",t);l&&d.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=h(this).find(".selected"),
b=h(this).data("type"),c=a.data("col");c!==r&&(c>t||4===t&&3===c||4<=t&&4<=c&&t!=c)&&(a.removeClass("selected"),m.removeClass("tb_grid_classes col-count-"+m.attr("data-basecol")+" "+m.attr("data-col_"+b)).attr("data-col_"+b,""),h(this).closest(".tb_grid_list").find("."+b+"-auto").addClass("selected"))})}else return"-auto"!==c[0]?(a="column"+c.join("-"),t=d.data("col"),3===t&&m.attr("data-basecol")>t&&(a+=" tb_3col"),m.removeClass(m.attr("data-col_tablet")+" "+m.attr("data-col_tablet_landscape")+" "+
m.attr("data-col_mobile")).addClass(a+" tb_grid_classes col-count-"+m.attr("data-basecol")).attr("data-col_"+k,a)):m.removeClass("tb_grid_classes tb_3col col-count-"+m.attr("data-basecol")+" "+m.attr("data-col_"+k)).attr("data-col_"+k,""),"visual"===b.mode&&(h("body",u.document).height(q.body.scrollHeight),b.Utils.calculateHeight()),b.Utils.setCompactMode(m.children(".module_column")),!1;d=m.children(".module_column");l=c.length;e="module_column"+(g?" sub_column":"")+" col";for(k=0;k<l;++k)f=d.eq(k),
...
c.last().addClass("last"));b.Utils.columnDrag(m,!0);f=m.closest(".module_row");b.hasChanged=!0;b.Mixins.Builder.updateModuleSort(f);b.undoManager.push(f.data("cid"),a,f,"row");v.body.triggerHandler("tb_grid_changed",[f])},_columnHeight:function(a){a=h(a).data("value");if(a!==r){var d=h(".tb_element_cid_"+this.cid).first(),c=b.Models.Registry.lookup(this.cid),e=n.clone(d),d=d.find("."+this.type+"_inner").first();""===a?d.removeClass("col_auto_height"):d.addClass("col_auto_height");c.set({column_h:a},
...
f=e.get(d+"_dir"),g=e.get("column_alignment"),k=e.get("column_h"),e=e.get("gutter"),l=q.getElementsByClassName("tb_element_cid_"+this.cid)[0].getElementsByClassName(this.type+"_inner")[0],m=!0===c?r:l.getAttribute("data-col_"+d),n=l.children,p=n.length,u=[],l=0;l<p;++l)u.push(b.Utils._getColClass(n[l].className.split(" ")));n="tb_rgrids"===a.id?a:h(a).find("#tb_rgrids")[0];for(l=6;-1<l;--l)n.classList.remove("col-count-"+l);n.classList.add("col-count-"+p);u="grid-layout-"+u.join("-");a=a.getElementsByClassName("tb_grid_"+
d)[0];n=a.getElementsByClassName("tb_grid_list")[0].getElementsByTagName("li");m="-auto"!==m&&m?"grid-layout-"+m.replace(/column|tb_3col/ig,"").trim():!1;!1!==c||!1!==m&&1!==p||(m=d+"-auto");for(l=n.length-1;-1<l;--l)!0===c&&n[l].classList.contains(u)||!1===c&&n[l].classList.contains(m)?n[l].classList.add("selected"):n[l].classList.remove("selected");if("ltr"!==f)for(n=a.getElementsByClassName("tb_column_direction")[0].getElementsByTagName("li"),l=n.length-1;-1<l;--l)n[l].getAttribute("data-dir")===
f?n[l].classList.add("selected"):n[l].classList.remove("selected");if(!0===c){if("col_align_top"!==g||!0===F)for(d=a.getElementsByClassName("tb_column_alignment")[0].getElementsByTagName("li"),l=d.length-1;-1<l;--l)d[l].getAttribute("data-alignment")===g?d[l].classList.add("selected"):d[l].classList.remove("selected");if("gutter-default"!==e)for(g=a.getElementsByClassName("tb_column_gutter")[0].getElementsByTagName("li"),l=g.length-1;-1<l;--l)g[l].getAttribute("data-value")===e?g[l].classList.add("selected"):
...
a=a.split(",");for(var c=a.length-1;-1<c;--c)if(!b.test(a[c]))return!1;return!0});b.Forms.register_validator("not_empty",function(a){return!(!a||""===a.trim())});b.GS={styles:{},initContent:!1,loadingPosts:!1,allLoaded:!1,el:null,dropdown:null,isShown:null,field:null,isGSPage:q.body.classList.contains("gs_post"),activeGS:null,xhr:null,key:"global_styles",previousModel:null,liveInstance:null,init:function(){if(!0===this.isGSPage)if(u.document.body.classList.add("gs_post"),"visual"!==b.mode||!0===v.is_builder_loaded)this.openStylingPanel();
else{var a=this;u.Themify.body.one("themify_builder_ready",function(b){a.openStylingPanel();a=null})}else null!==themifyBuilder.globalStyles&&(this.extend(this.styles,themifyBuilder.globalStyles),themifyBuilder.globalStyles=null)},extend:function(a,b){for(var c in b)b[c]!==r&&(a[c]=b[c]);return a},openStylingPanel:function(){var a=function(){var d=themifyBuilder.globalStyleData.type,d=b.Models.Registry.lookup(b.Instances.Builder[b.builderIndex].el.getElementsByClassName(("row"===d||"column"===d||
"subrow"===d?"module_":"module-")+d)[0].dataset.cid);d.set("styleClicked",{silent:!0});b.isPreview=!1;d.trigger("edit",null);b.isPreview=!0;v.body.one("themify_builder_save_data",a)};a();b.toolbar.el.getElementsByClassName("tb_toolbar_builder_preview")[0].click()},setCss:function(a,d,c){"visual"===b.mode&&b.liveStylingInstance.setCss(a,d,c)},createCss:function(a,b,c){ThemifyStyles.GS={};return ThemifyStyles.createCss(a,b,c,this.styles)},findUsedItems:function(a){a=JSON.stringify(a);for(var b=/"global_styles":"(.*?)"/mg,
c,e="";null!==(c=b.exec(a));)e+=" "+c[1].trim();e=e.trim();if(""!==e){e=h.unique(e.split(" "));a=[];for(b=e.length-1;-1<b;--b)this.styles[e[b]]!==r&&a.push(e[b]);return a}return!1},globalStylesHTML:function(){if(!0===this.isGSPage||null!==this.activeGS)return!1;var a=q.createElement("div"),d=q.createElement("div"),c=q.createElement("span");this.isShown=null;this.field=ThemifyConstructor.hidden.render({id:b.GS.key,is_responsive:!1,value:ThemifyConstructor.values[b.GS.key],control:!1},ThemifyConstructor);
a.className="tb_gs_container";if(this.field.value){for(var e=this.field.value.split(" "),f="",g=e.length-1;-1<g;--g)this.styles[e[g]]!==r&&(f+=" "+e[g]);f=f.trim();this.field.value=f}else this.field.value="";d.className="tb_gs_icon ti-brush-alt";d.addEventListener("click",function(a){if(a.target.classList.contains("tb_gs_icon")){var c=this.el;if(c.classList.contains("tb_gs_dropdown_opened"))a.stopPropagation(),c.classList.remove("tb_gs_dropdown_action"),c.classList.remove("tb_gs_dropdown_opened");
else{c.classList.add("tb_gs_dropdown_opened");c.classList.add("tb_gs_dropdown_action");var d=function(a){null===c||c.contains(a.target)||(q.removeEventListener("click",d,{passive:!0}),"visual"===b.mode&&u.document.removeEventListener("click",d,{passive:!0}),c.classList.remove("tb_gs_dropdown_action"),c.classList.remove("tb_gs_dropdown_opened"),c=null)};q.addEventListener("mousedown",d,{passive:!0});"visual"===b.mode&&u.document.addEventListener("mousedown",d,{passive:!0})}}}.bind(this),{passive:!0});
c.className="tb_gs_tooltip";c.textContent=themifyBuilder.i18n.gs;d.appendChild(c);a.appendChild(this.field);a.appendChild(d);this.el=a;""!==this.field.value&&(d=this.stylingOverlay(),null!==d&&a.appendChild(d));a.addEventListener("click",this.initClickEvent.bind(this));this.initContent=!1;a=null;return this.el},initHTML:function(){var a=q.createElement("div");var b=this.field.value.trim();if(""!==b){b=b.split(" ");for(var c=0,e=b.length;c<e;++c)this.styles[b[c]]!==r&&a.appendChild(this.createSelectedItem(b[c]))}a.className=
"tb_gs_selected_styles";this.el.appendChild(a);a=n.is_template_support?q.getElementById("tmpl-global_styles").content.cloneNode(!0):n.templateCache.get("tmpl-global_styles");b=this.el.getElementsByClassName("tb_gs_icon")[0];n.is_template_support?b.parentNode.insertBefore(a,b.nextSibling):b.insertAdjacentHTML("afterend",a);this.initContent=!0},createSelectedItem:function(a){var b=this.styles[a],c=q.createElement("div"),e=q.createElement("span"),f=q.createElement("span"),g=q.createElement("span");c.className=
...
b=a.length-1;-1<b;--b){var e=a[b].getElementsByClassName("global_style_title")[0];e&&(a[b].style.display=-1<e.innerHTML.toUpperCase().indexOf(c)?"":"none")}};null!==a.xhr&&(a.xhr.abort(),a.xhr=null);a.allLoaded||setTimeout(function(){a.loadMore(c,f)},100);f()}.bind(this),{passive:!0})},addItemToDropdown:function(a){if(null!==this.dropdown){for(var b=q.createDocumentFragment(),c=this.field.value.split(" "),e=this.dropdown.getElementsByClassName("tb_no_gs_item")[0],f=0,g=a.length;f<g;++f){var h=this.styles[a[f]],
l=q.createElement("div"),m=q.createElement("span"),n=q.createElement("span");l.className="global_style_item";l.className+=-1!==c.indexOf(a[f])?" selected":"";l.dataset.styleId=a[f];n.className="global_style_title";n.innerText=h.title;m.className="global_style_type";m.innerText=h.type;l.appendChild(n);l.appendChild(m);b.appendChild(l)}e.parentNode.insertBefore(b,e)}},loadMore:function(a,b){var c=this,d=[];this.loadingPosts=!0;for(var f in this.styles)this.styles[f].id!==r&&d.push(this.styles[f].id);
...
e,this.styles),element_id:f};ThemifyStyles.disableNestedSel=!0;null===this.liveInstance&&(this.liveInstance=b.createStyleInstance(),this.liveInstance.init(!0,!0));var e=this.createCss([f],e),g=this.liveInstance,h=[],l=b.activeBreakPoint;var m=g.prefix;var n=new RegExp(m,"g");ThemifyStyles.disableNestedSel=null;if(!0===c){var p=ThemifyConstructor.breakpointsReverse;for(var q=p.length-1;-1<q;--q){b.activeBreakPoint=p[q];g.setMode(p[q],!0);var r=g.currentSheet;var u=r.cssRules?r.cssRules:r.rules;for(r=
u.length-1;-1<r;--r)if(-1!==u[r].selectorText.indexOf(m)){c=u[r].selectorText.replace(/\,\s+/g,",").replace(n,"").split(",");var v=u[r].cssText.split("{")[1].split(";");if(-1!==c[0].indexOf(".tb_text_wrap"))for(var x=c.length-1;0<x;--x)-1!==c[x].indexOf(".tb_text_wrap")&&c.splice(x,1);for(x=v.length-2;-1<x;--x)g.setLiveStyle(v[x].trim().split(": ")[0].trim(),"",c)}}}delete e.gs;for(q in e)if("fonts"===q||"cf_fonts"===q)for(var z in e[q])u=z,0<e[q][z].length&&(u+=":"+e[q][z].join(",")),h.push(u);else for(r in b.activeBreakPoint=
q,g.setMode(q,!0),e[q])for(c=r.replace(/\,\s+/g,",").replace(n,"").split(","),x=0,v=e[q][r].length;x<v;++x){p=e[q][r][x].split(";");for(var A=p.length-2;-1<A;--A)""!==p[A]&&(m=p[A].split(":")[0],u=p[A].replace(m+":","").trim(),"background-image"===m&&-1!==p[A].indexOf("svg")&&-1!==p[A].indexOf("data:")&&(u+=";"+p[A+1]),g.setLiveStyle(m,u,c))}0<h.length&&ThemifyConstructor.font_select.loadGoogleFonts(h.join("|"));b.activeBreakPoint=l;this.updated(a,e,f,d);this.liveInstance=null}},extraStyle:function(a,
...
if(0<m){a=q.createDocumentFragment();for(p in l)if(!0===l[p]&&0===c.children(".tb_row_frame_"+p).length){var u=q.createElement("div");u.className="tb_row_frame tb_row_frame_"+p;a.appendChild(u)}c.children(".tb_action_wrap").after(a)}(p=d.styling!==r?d.styling.background_type:"none")||(p="image");"image"===p&&"builder-parallax-scrolling"===d.styling.background_repeat&&d.styling.background_image?(c[0].classList.add("builder-parallax-scrolling"),ThemifyBuilderModuleJs.backgroundScrolling(c)):(c[0].classList.remove("builder-parallax-scrolling"),
...
b.mode&&b.hasChanged){var l=b.Models.Registry.items,t;for(t in l){var u="module"===l[t].get("elType")?l[t].get("mod_settings"):l[t].get("styling");u[g.key]!==r&&""!==u[g.key]&&-1!==u[g.key].indexOf(e)&&(b.activeModel=l[t],g.generateValues(e,u[g.key].split(" "),!0))}g.liveInstance=null}b.activeModel=q;g.previousModel=k;console.log("ddd");p(!0);b.hasChanged=!1;h.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_update_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,
data:f.data,id:f.id},error:function(){n.showLoader("error")},success:function(){d||c?g.previousModel=null:g.reopenPreviousPanel();g=null;n.showLoader("hide")}});f=null})},reopenPreviousPanel:function(a){r!==a?a.model.trigger("edit",a.e,a.target):null!==this.previousModel&&(a=b.Models.Registry.lookup(this.previousModel),null!==a&&(a.set({styleClicked:!0},{silent:!0}),a.trigger("edit",null)),this.previousModel=null)},stylingOverlay:function(){if(null===this.isShown&&null!==b.activeModel&&(null===this.el.parentNode||
!this.el.parentNode.classList.contains("tb_inline_gs_show"))){this.isShown=!0;var a=q.createElement("div"),d=q.createElement("p"),c=function(a){a.preventDefault();a.stopPropagation();this.removeEventListener("click",c,{once:!0});this.parentNode.removeChild(this)};a.className="tb_gs_options_overlay";d.textContent=themifyBuilder.i18n.has_gs;a.addEventListener("click",c,{once:!0});a.appendChild(d);return a}return null}}})(jQuery,Backbone,Themify,window,window.top,document,ThemifyBuilderCommon,void 0);
