(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('input[name="setting-search-result_post_layout"]').change(function () {
        ...
        $('input[name="setting-exclude_search_form"]').change(function () {
            var search_form = $(this).closest('.subtab').find('input[name="setting_search_form"]').closest('p');
