			...
			if( is_singular('portfolio') ){
				...
				if( '' == $post_date ){
					$post_date = themify_check('setting-default_portfolio_single_post_date')?
							themify_get('setting-default_portfolio_index_hide_post_date'):
							'yes';
				}
				if( '' == $title ){
				...
				// Reverse logic
				if( '' == $post_date ){
					$post_date = themify_check('setting-default_portfolio_index_hide_post_date')?
							'no' == themify_get('setting-default_portfolio_index_hide_post_date')?
								'yes' : 'no':
							'no';
				}
				if( '' == $post_meta ){
