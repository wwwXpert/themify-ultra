...
var e="mod_settings";f.get("is_new")!==h&&(this.is_new=!0,c=c.closest(".module_row"))}else e="styling";this.values=p.extend(!0,{},f.get(e));c!==h&&(m.beforeEvent=z.clone(c));d=f.get("visibileClicked")!==h;c=!1===d&&("column"===this.component||"subrow"===this.component||f.get("styleClicked")!==h);var g=this.data[a]}else this.values={},this.component=null,g=a;var k=l.createDocumentFragment(),n=l.createDocumentFragment(),r=this,u=function(a,b){var c=l.createElement("div"),d=l.createDocumentFragment();
c.className="tb_options_tab_content";if("visibility"===a||"animation"===a)b=r["static"][a];else if("styling"===a){var e=l.createElement("div"),g=m.GS.globalStylesHTML();e.className="tb_styling_tab_header";e.appendChild(r.getSwitcher());g&&e.appendChild(g);d.appendChild(e);e=null}c.appendChild(r.create(b));d.appendChild(c);"styling"===a&&(c=l.createElement("a"),e=l.createElement("i"),c.href="#",c.className="reset-styling",e.className="ti-close",c.appendChild(e),c.appendChild(l.createTextNode(r.label.reset_style)),
c.addEventListener("click",r.resetStyling.bind(r)),d.appendChild(c),"visual"===m.mode&&f&&setTimeout(function(){m.liveStylingInstance.module_rules=r.styles},600));"animation"===a&&(c=l.createElement("a"),c.href="#",c.className="tb_motion_reset_link",c.appendChild(l.createTextNode(r.label.reset_effect)),c.addEventListener("click",r.resetEffect.bind(r)),d.appendChild(c));return d};this.clicked=null;for(var w in g){e=l.createElement("li");var A=l.createElement("a"),v=l.createElement("span"),y=l.createElement("div"),
q=g[w].name!==h?g[w].name:this.label[w],x="tb_options_"+w;A.href="#"+x;A.textContent=q;"setting"!==w&&(A.className="tb_tooltip",v.textContent=q,A.appendChild(v));y.id=x;y.className="tb_tab tb_options_tab_wrapper";if(!0===c&&"styling"===w||!0===d&&"visibility"===w||!1===c&&!1===d&&"setting"===w||null===this.component)e.className="current",r.clicked=w,g[w].html!==h?y.appendChild(g[w].html):y.appendChild(u(w,g[w].options)),y.style.display="block",new SimpleBar(y),y.dataset.done=!0;y.addEventListener("themify_builder_tabsactive",
function(a){a=a.detail.id.replace("#tb_options_","");r.clicked=a;this.dataset.done===h&&(this.dataset.done=!0,this.appendChild(u(a,g[a].options)),r.callbacks(),new SimpleBar(this),"setting"===a&&r.setUpEditors())},{passive:!0});A.addEventListener("click",this.switchTabs);n.appendChild(y);e.appendChild(A);k.appendChild(e)}w=z.Lightbox.$lightbox[0].getElementsByClassName("tb_options_tab")[0];for(A=z.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_actions_wrap")[0];null!==w.firstChild;)w.removeChild(w.firstChild);
for(;null!==A.firstChild;)A.removeChild(A.firstChild);w.appendChild(k);if(b!==h||f){var B=l.createElement("button");B.className="builder_button builder_save_button";B.title=b!==h&&b.ctr_save!==h?this.label[b.ctr_save]:this.label.ctr_save;B.textContent=b!==h&&b.done!==h?this.label[b.done]:this.label.done;if(f){m.autoSaveCid=f.cid;if("visual"===m.mode){null!==m.GS.activeGS?(m.liveStylingInstance=m.createStyleInstance(),m.liveStylingInstance.init(null,!0)):(null===m.liveStylingInstance&&(m.liveStylingInstance=
m.createStyleInstance()),m.liveStylingInstance.init());var E=m.liveStylingInstance.$liveStyledElmt[0].outerHTML}var D=function(a){a.preventDefault();a.stopImmediatePropagation();r.saveComponent(!1)&&(B.removeEventListener("click",D,{once:!1}),F.removeEventListener("click",D,{once:!0}))};var F=l.createElement("a");e=l.createElement("li");k=l.createElement("span");e.className="tb_top_save_btn";F.className="ti-check tb_tooltip";k.textContent=this.label.done;F.appendChild(k);e.appendChild(F);w.appendChild(e);
...
"tb_editing_module")},5);!0===c?f.unset("styleClicked",{silent:!0}):!0===d&&f.unset("visibileClicked",{silent:!0});return n},getStyleVal:function(a,b,c){if(null!==m.activeModel){c===h&&(c=this.values);b===h&&(b=m.activeBreakPoint);if("desktop"===b||"styling"!==this.clicked)return""!==c[a]?c[a]:h;var d=this.breakpointsReverse;b=d.indexOf(b);for(var f=d.length;b<f;++b)if("desktop"!==d[b]){if(c["breakpoint_"+d[b]]!==h&&c["breakpoint_"+d[b]][a]!==h&&""!==c["breakpoint_"+d[b]][a])return c["breakpoint_"+
d[b]][a]}else if(""!==c[a]){d=h!=this.stylesData[a]?this.stylesData[a].binding:h;if(h!==d&&h!==d[c[a]]&&h!==d[c[a]].responsive&&h!==d[c[a]].responsive.disabled&&-1!==d[c[a]].responsive.disabled.indexOf(a))break;return c[a]}}return h},updateStyles:function(a,b,c){this.setStylingValues(b);a=this.clicked;this.clicked="styling";for(var d in this.stylesData){var f=this.stylesData[d].type;if("video"!==f&&"gallery"!==f&&"autocomplete"!==f&&"custom_css"!==f&&"builder"!==f&&!1!==this.stylesData[d].is_responsive&&
("icon_radio"===f?f="radio":"icon_checkbox"===f?f="checkbox":"textarea"===f||"icon"===f||"hidden"===f||"number"===f?f="text":"image"===f?f="file":"padding"===f||"border_radius"===f?f="margin":"frame"===f&&(f="layout"),b=this.getStyleVal(d),this[f].update(d,b,this),this.stylesData[d].binding!==h))for(var e=q.document.getElementById(d),f="layout"===f?e.getElementsByClassName("tfl-icon"):"radio"===f||"checkbox"===f?e.getElementsByTagName("input"):[e],e=this.stylesData[d],g=0,k=f.length;g<k;++g)this.binding(f[g],
...
this.component;if(c&&!b.isValidate(q.document.getElementById("tb_options_setting"))||z.Lightbox.$lightbox[0].getElementsByClassName("tb_disable_save")[0]!==h)return m.beforeEvent=null,m.saving=!1;t.body.triggerHandler("themify_builder_save_component",a);"visual"===m.mode&&q.jQuery("body").triggerHandler("themify_builder_save_component",a);delete this.values.cid;var d=!1,f=p.extend(!0,{},this.beforeData?this.beforeData:this.values),e="styling",g=l.getElementsByClassName("tb_element_cid_"+m.activeModel.cid)[0];
...
k=a.isRadio!==h,n=null,r=null;g.className="tb_tabs";f.className="clearfix tb_tab_wrapper";++this.click;!0===k&&(b.values[a.id]!==h&&""!==b.values[a.id]&&(r=!0,n=b.values[a.id]),f.className+=" tb_radio_input_container",!0===b.is_repeat?(f.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",f.dataset.inputId=a.id):(f.className+=" tb_lb_option",f.id=a.id));for(var u in c){var w=l.createElement("li"),m=!0===k?l.createElement("label"):l.createElement("a"),p=l.createElement("div"),y="tb_"+
...
a.options[f],b);d.appendChild(g)};if(f!==h)for(var g in f)a.options[g]!==h&&e(g,f[g]);for(g in a.options)f!==h&&f[g]!==h||e(g,a.options[g]);return d}},toggleable_fields:{sort:function(a,b){var c=p(a);c.sortable({items:">li",axis:"y",placeholder:"tb_state_highlight",forcePlaceholderSize:!0,forceHelperSize:!0,cursor:"move",tolerance:"pointer",zIndex:9999,cancel:".tb_toggleable_fields_title,.switch-wrapper,.tb_toggleable_fields_options",stop:_.debounce(function(a,f){c.find(".tb_state_highlight").remove();
...
l.createElement("div");c.className="tb_multi_fields tb_fields_count_"+a.options.length;c.appendChild(b.create(a.options));return c}},color:{is_typing:null,controlChange:function(a,b,c){var d=this,f=p(a),e=c.id,g=l.createElement("div");g.className="tb_clear_btn";g.addEventListener("click",function(){g.style.display="none";a.value="";f.trigger("keyup")},{passive:!0});f.minicolors({opacity:1,swatches:themifyColorManager.toColorsArray(),changeDelay:10,beforeShow:function(){var a=z.Lightbox.$lightbox,
...
(b.value=c);a&&0>=parseFloat(p(this).minicolors("opacity"))&&p(this).minicolors("opacity",0);"visual"===m.mode&&t.triggerEvent(this,"themify_builder_color_picker_change",{id:e,val:a?p(this).minicolors("rgbaString"):""})}}).minicolors("show");c=function(b){var c=parseFloat(this.value.trim().replace(",","."));if(1<c||isNaN(c)||""===c||0>c)c=a.value?1:"";"blur"===b.type&&(this.value=c);d.is_typing="keyup"===b.type;f.minicolors("opacity",c)};b.addEventListener("blur",c,{passive:!0});b.addEventListener("keyup",
...
b,c){a=q.document.getElementById(a);null!==a&&(a.value=b!==h?b:"")},render:function(a,b){var c=l.createDocumentFragment(),d=l.createElement("input"),f=b.getStyleVal(a.id);d.type=a.input_type!==h?a.input_type:"text";!0===b.is_repeat?(d.className=!0===b.is_sort?"tb_lb_sort_child":"tb_lb_option_child",d.dataset.inputId=a.id):(d.className="tb_lb_option",d.id=a.id);a.placeholder!==h&&(d.placeholder=a.placeholder);if(a.custom_args!==h)for(var e in a.custom_args)d.setAttribute(e,a.custom_args[e]);f!==h&&
...
a));a.after!==h&&c.appendChild(b.after(a));a.description!==h&&c.appendChild(b.description(a.description));return c}},wp_editor:{render:function(a,b){var c=l.createElement("div"),d=l.createElement("div"),f=l.createElement("div"),e=l.createElement("button"),g=l.createElement("span"),k=l.createElement("div"),n=l.createElement("button"),r=l.createElement("button"),m=l.createElement("div"),p=l.createElement("div"),q=l.createElement("textarea");c.className="wp-core-ui wp-editor-wrap tmce-active";q.className=
"tb_lb_wp_editor fullwidth";if(!0===b.is_repeat){var v=Math.random().toString(36).substr(2,7);q.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child";q.dataset.inputId=a.id;!1!==a.control&&(a.control===h&&(a.control={}),a.control.repeat=!0)}else q.className+=" tb_lb_option",v=a.id;q.id=v;c.id="wp-"+v+"-wrap";d.id="wp-"+v+"-editor-tools";d.className="wp-editor-tools";f.id="wp-"+v+"-media-buttons";f.className="wp-media-buttons";e.type="button";e.className="button insert-media add_media";
...
h&&(q.value=b.values[a.id]);q.rows=12;q.cols=40;m.appendChild(q);m.appendChild(p);k.appendChild(n);k.appendChild(r);e.appendChild(g);e.appendChild(l.createTextNode(b.label.add_media));f.appendChild(e);d.appendChild(f);d.appendChild(k);c.appendChild(d);c.appendChild(m);b.editors.push({el:q,data:a});return c}},select:{dataset_cache:{},update:function(a,b,c){a=q.document.getElementById(a);null!==a&&(b!==h?a.value=b:a[0]!==h&&(a[0].selected=!0))},make_options:function(a,b,c){var d=l.createDocumentFragment();
c=c.getOptions(a);for(var f in c){var e=l.createElement("option");e.value=f;e.text=c[f];h!==a.binding&&h!==a.binding[f]&&h!==a.binding[f].responsive&&h!==a.binding[f].responsive.disabled&&-1!==a.binding[f].responsive.disabled.indexOf(a.id)&&(e.className="responsive_disable");if(b===f||b===h&&f===a["default"])e.selected=!0;d.appendChild(e)}return d},render:function(a,b){var c=this,d=l.createElement("div"),f=l.createElement("select"),e=l.createDocumentFragment(),g=b.getStyleVal(a.id);d.className="selectwrapper";
!0===b.is_repeat?(f.className=!0===b.is_sort?"tb_lb_sort_child":"tb_lb_option_child",f.dataset.inputId=a.id):(f.className="tb_lb_option",f.id=a.id);a["class"]!==h&&(f.className+=" "+a["class"]);var k=function(a){if(a.optgroup){a=b.getOptions(a);for(var d in a)if(a[d].label!==h){var e=l.createElement("optgroup");e.setAttribute("label",a[d].label);e.appendChild(c.make_options(a[d],g,b));f.appendChild(e)}else f.appendChild(c.make_options(a[d],g,b))}else f.appendChild(c.make_options(a,g,b))};a.dataset!==
h?c.dataset_cache[a.dataset]!==h?k(c.dataset_cache[a.dataset]):p.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_select_dataset",dataset:a.dataset,nonce:themifyBuilder.tb_load_nonce,pid:themifyBuilder.post_ID},beforeSend:function(a){z.showLoader("show")},success:function(b){b.success&&(z.showLoader("hide"),c.dataset_cache[a.dataset]=b.data,k(b.data))},error:function(){z.showLoader("error")}}):k(a);d.appendChild(b.initControl(f,a));e.appendChild(d);a.after!==h&&e.appendChild(b.after(a));
a.description!==h&&e.appendChild(b.description(a.description));a.tooltip!==h&&e.appendChild(b.tooltip(a.tooltip));return e}},font_select:{loaded_fonts:[],fonts:[],safe:[],google:[],cf:[],updateFontVariant:function(a,b,c,d){if(b)if(d=""===d||d===h?h!==this.google[a]?"google":"cf":d,d="webfont"===d?"fonts":d,this[d][a]===h||this[d][a].v===h)b.closest(".tb_field").classList.add("_tb_hide_binding");else{var f=this[d][a].v;c=c.getStyleVal(b.id);c=h===c?"google"===d?"regular":"normal":c;for(b.dataset.selected=
a;null!==b.firstChild;)b.removeChild(b.firstChild);b.closest(".tb_field").classList.remove("_tb_hide_binding");a=0;for(d=f.length;a<d;++a){var e=l.createElement("option");e.value=e.textContent=f[a];f[a]===c&&(e.selected=!0);b.appendChild(e)}}},loadGoogleFonts:function(a,b){a=p.unique(a.split("|"));for(var c={google:[],cf:[]},d=[],f=this,e=a.length-1;-1<e;--e)if(a[e]&&-1===this.loaded_fonts.indexOf(a[e])&&(-1===c.google.indexOf(a[e])||-1===c.cf.indexOf(a[e]))){var g=a[e].split(":"),k="regular"===g[1]||
"normal"===g[1]||"italic"===g[1]||parseInt(g[1])?g[1]:"400,700",k=g[0].split(" ").join("+")+":"+k;-1===this.loaded_fonts.indexOf(k)&&(g=f.cf[g[0]]!==h?"cf":"google",k+="google"===g?":latin,latin-ext":"",c[g].push(k),d.push(k))}if("undefined"!==typeof WebFont){a=null;var l=function(){for(var a=d.length-1;-1<a;--a)-1===f.loaded_fonts.indexOf(d[a])&&f.loaded_fonts.push(d[a])},e={fontloading:function(a,b){l()},fontinactive:function(a,b){l()}};0<c.google.length&&(e.google={families:c.google},WebFont.load(e),
